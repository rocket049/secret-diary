...
const (
	...
	QLowEnergyController__AuthorizationError           QLowEnergyController__Error = QLowEnergyController__Error(8)
)
...
func QLowEnergyController_CreateCentral2(remoteDevice QBluetoothAddress_ITF, localDevice QBluetoothAddress_ITF, parent core.QObject_ITF) *QLowEnergyController {
	tmpValue := NewQLowEnergyControllerFromPointer(C.QLowEnergyController_QLowEnergyController_CreateCentral2(PointerFromQBluetoothAddress(remoteDevice), PointerFromQBluetoothAddress(localDevice), core.PointerFromQObject(parent)))
	if !qt.ExistsSignal(tmpValue.Pointer(), "destroyed") {
		tmpValue.ConnectDestroyed(func(*core.QObject) { tmpValue.SetPointer(nil) })
	}
	return tmpValue
...
func (ptr *QLowEnergyController) CreateCentral2(remoteDevice QBluetoothAddress_ITF, localDevice QBluetoothAddress_ITF, parent core.QObject_ITF) *QLowEnergyController {
	tmpValue := NewQLowEnergyControllerFromPointer(C.QLowEnergyController_QLowEnergyController_CreateCentral2(PointerFromQBluetoothAddress(remoteDevice), PointerFromQBluetoothAddress(localDevice), core.PointerFromQObject(parent)))
	if !qt.ExistsSignal(tmpValue.Pointer(), "destroyed") {
		tmpValue.ConnectDestroyed(func(*core.QObject) { tmpValue.SetPointer(nil) })
	}
...
func init() {
	...
	qt.FuncMap["bluetooth.QLowEnergyController_CreateCentral2"] = QLowEnergyController_CreateCentral2
	...
	qt.EnumMap["bluetooth.QLowEnergyController__AuthorizationError"] = int64(QLowEnergyController__AuthorizationError)
