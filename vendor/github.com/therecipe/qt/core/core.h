...
void* QBasicTimer_NewQBasicTimer2();
void* QBasicTimer_NewQBasicTimer3(void* other);
...
void QBasicTimer_Swap(void* ptr, void* other);
...
void* QByteArray_QByteArray_FromBase64(void* base64, long long options);
void* QByteArray_QByteArray_FromBase642(void* base64);
...
struct QtCore_PackedString QCalendar_QCalendar_AvailableCalendars();
void* QCalendar_DateFromParts(void* ptr, int year, int month, int day);
struct QtCore_PackedString QCalendar_DateTimeToString(void* ptr, void* format, void* datetime, void* dateOnly, void* timeOnly, void* locale);
int QCalendar_DayOfWeek(void* ptr, void* date);
int QCalendar_DaysInMonth(void* ptr, int month, int year);
int QCalendar_DaysInYear(void* ptr, int year);
char QCalendar_HasYearZero(void* ptr);
char QCalendar_IsDateValid(void* ptr, int year, int month, int day);
char QCalendar_IsGregorian(void* ptr);
char QCalendar_IsLeapYear(void* ptr, int year);
char QCalendar_IsLunar(void* ptr);
char QCalendar_IsLuniSolar(void* ptr);
char QCalendar_IsProleptic(void* ptr);
char QCalendar_IsSolar(void* ptr);
char QCalendar_IsValid(void* ptr);
int QCalendar_MaximumDaysInMonth(void* ptr);
int QCalendar_MaximumMonthsInYear(void* ptr);
int QCalendar_MinimumDaysInMonth(void* ptr);
struct QtCore_PackedString QCalendar_MonthName(void* ptr, void* locale, int month, int year, long long format);
int QCalendar_MonthsInYear(void* ptr, int year);
struct QtCore_PackedString QCalendar_Name(void* ptr);
struct QtCore_PackedString QCalendar_StandaloneMonthName(void* ptr, void* locale, int month, int year, long long format);
struct QtCore_PackedString QCalendar_StandaloneWeekDayName(void* ptr, void* locale, int day, long long format);
struct QtCore_PackedString QCalendar_WeekDayName(void* ptr, void* locale, int day, long long format);
...
void* QCollator_NewQCollator();
void* QCollator_NewQCollator2(void* locale);
void* QCollator_NewQCollator3(void* other);
void* QCollator_NewQCollator4(void* other);
long long QCollator_CaseSensitivity(void* ptr);
int QCollator_Compare(void* ptr, void* s1, void* s2);
int QCollator_Compare2(void* ptr, struct QtCore_PackedString s1, struct QtCore_PackedString s2);
int QCollator_Compare3(void* ptr, void* s1, void* s2);
int QCollator_Compare4(void* ptr, void* s1, int len1, void* s2, int len2);
...
struct QtCore_PackedList QConcatenateTablesProxyModel_SourceModels(void* ptr);
...
void* QConcatenateTablesProxyModel___sourceModels_atList(void* ptr, int i);
void QConcatenateTablesProxyModel___sourceModels_setList(void* ptr, void* i);
void* QConcatenateTablesProxyModel___sourceModels_newList(void* ptr);
...
void* QDate_AddMonths(void* ptr, int nmonths, void* cal);
void* QDate_AddMonths2(void* ptr, int nmonths);
void* QDate_AddYears(void* ptr, int nyears, void* cal);
void* QDate_AddYears2(void* ptr, int nyears);
void* QDate_QDate_CurrentDate();
int QDate_Day(void* ptr, void* cal);
int QDate_Day2(void* ptr);
int QDate_DayOfWeek(void* ptr, void* cal);
int QDate_DayOfWeek2(void* ptr);
int QDate_DayOfYear(void* ptr, void* cal);
int QDate_DayOfYear2(void* ptr);
int QDate_DaysInMonth(void* ptr, void* cal);
int QDate_DaysInMonth2(void* ptr);
int QDate_DaysInYear(void* ptr, void* cal);
int QDate_DaysInYear2(void* ptr);
long long QDate_DaysTo(void* ptr, void* d);
void* QDate_EndOfDay(void* ptr, long long spec, int offsetSeconds);
void* QDate_EndOfDay2(void* ptr, void* zone);
...
char QDate_SetDate2(void* ptr, int year, int month, int day, void* cal);
void* QDate_StartOfDay(void* ptr, long long spec, int offsetSeconds);
void* QDate_StartOfDay2(void* ptr, void* zone);
long long QDate_ToJulianDay(void* ptr);
struct QtCore_PackedString QDate_ToString2(void* ptr, long long format);
struct QtCore_PackedString QDate_ToString3(void* ptr, struct QtCore_PackedString format);
struct QtCore_PackedString QDate_ToString4(void* ptr, struct QtCore_PackedString format, void* cal);
struct QtCore_PackedString QDate_ToString5(void* ptr, void* format);
struct QtCore_PackedString QDate_ToString6(void* ptr, void* format, void* cal);
...
struct QtCore_PackedString QDateTime_ToString3(void* ptr, struct QtCore_PackedString format, void* cal);
struct QtCore_PackedString QDateTime_ToString4(void* ptr, void* format);
struct QtCore_PackedString QDateTime_ToString5(void* ptr, void* format, void* cal);
...
char QFile_MoveToTrash(void* ptr);
char QFile_QFile_MoveToTrash2(struct QtCore_PackedString fileName, struct QtCore_PackedString pathInTrash);
...
char QFileInfo_IsJunction(void* ptr);
...
char QFileInfo_IsShortcut(void* ptr);
char QFileInfo_IsSymLink(void* ptr);
char QFileInfo_IsSymbolicLink(void* ptr);
...
char QJsonObject_Contains3(void* ptr, void* key);
...
int QLatin1String_Compare(void* ptr, void* str, long long cs);
int QLatin1String_Compare2(void* ptr, void* l1, long long cs);
int QLatin1String_Compare3(void* ptr, void* ch);
int QLatin1String_Compare4(void* ptr, void* ch, long long cs);
char QLatin1String_Contains(void* ptr, void* str, long long cs);
char QLatin1String_Contains2(void* ptr, void* l1, long long cs);
char QLatin1String_Contains3(void* ptr, void* c, long long cs);
...
int QLatin1String_LastIndexOf(void* ptr, void* str, int from, long long cs);
int QLatin1String_LastIndexOf2(void* ptr, void* l1, int from, long long cs);
int QLatin1String_LastIndexOf3(void* ptr, void* c, int from, long long cs);
...
void* QLocale_Collation(void* ptr);
...
void* QLocale_ToDate3(void* ptr, struct QtCore_PackedString stri, long long format, void* cal);
void* QLocale_ToDate4(void* ptr, struct QtCore_PackedString stri, struct QtCore_PackedString format, void* cal);
...
void* QLocale_ToDateTime3(void* ptr, struct QtCore_PackedString stri, long long format, void* cal);
void* QLocale_ToDateTime4(void* ptr, struct QtCore_PackedString stri, struct QtCore_PackedString format, void* cal);
...
struct QtCore_PackedString QLocale_ToString20(void* ptr, void* date, void* format, void* cal);
struct QtCore_PackedString QLocale_ToString21(void* ptr, void* date, long long format, void* cal);
struct QtCore_PackedString QLocale_ToString22(void* ptr, void* dateTime, long long format, void* cal);
struct QtCore_PackedString QLocale_ToString23(void* ptr, void* dateTime, void* format, void* cal);
...
char QMetaProperty_IsRequired(void* ptr);
...
int QMetaProperty_RelativePropertyIndex(void* ptr);
...
void* QMutex_NewQMutex();
void* QMutex_NewQMutex2(long long mode);
...
void* QMutexLocker_NewQMutexLocker2(void* mutex);
...
void* QOperatingSystemVersion_QOperatingSystemVersion_MacOSBigSur();
void* QOperatingSystemVersion_QOperatingSystemVersion_MacOSCatalina();
...
void* QPoint_Transposed(void* ptr);
...
void* QPointF_Transposed(void* ptr);
...
struct QtCore_PackedString QProcess_QProcess_SplitCommand(void* command);
...
unsigned int QRandomGenerator_Bounded3(void* ptr, unsigned int lowest, unsigned int highest);
int QRandomGenerator_Bounded4(void* ptr, int highest);
...
void* QRecursiveMutex_NewQRecursiveMutex();
void QRecursiveMutex_DestroyQRecursiveMutex(void* ptr);
...
struct QtCore_PackedString QRegularExpression_QRegularExpression_AnchoredPattern(void* expression);
struct QtCore_PackedString QRegularExpression_QRegularExpression_AnchoredPattern2(struct QtCore_PackedString expression);
int QRegularExpression_CaptureCount(void* ptr);
struct QtCore_PackedString QRegularExpression_ErrorString(void* ptr);
struct QtCore_PackedString QRegularExpression_QRegularExpression_Escape(void* str);
struct QtCore_PackedString QRegularExpression_QRegularExpression_Escape2(struct QtCore_PackedString str);
...
struct QtCore_PackedString QRegularExpression_QRegularExpression_WildcardToRegularExpression(void* pattern);
struct QtCore_PackedString QRegularExpression_QRegularExpression_WildcardToRegularExpression2(struct QtCore_PackedString pattern);
...
void* QResource_UncompressedData(void* ptr);
long long QResource_UncompressedSize(void* ptr);
...
void* QSize_GrownBy(void* ptr, void* margins);
...
void* QSize_ShrunkBy(void* ptr, void* margins);
...
void* QSizeF_GrownBy(void* ptr, void* margins);
...
void* QSizeF_ShrunkBy(void* ptr, void* margins);
...
void QSortFilterProxyModel_ConnectFilterCaseSensitivityChanged(void* ptr, long long t);
void QSortFilterProxyModel_DisconnectFilterCaseSensitivityChanged(void* ptr);
void QSortFilterProxyModel_FilterCaseSensitivityChanged(void* ptr, long long filterCaseSensitivity);
...
void QSortFilterProxyModel_ConnectFilterRoleChanged(void* ptr, long long t);
void QSortFilterProxyModel_DisconnectFilterRoleChanged(void* ptr);
void QSortFilterProxyModel_FilterRoleChanged(void* ptr, int filterRole);
...
void QSortFilterProxyModel_ConnectRecursiveFilteringEnabledChanged(void* ptr, long long t);
void QSortFilterProxyModel_DisconnectRecursiveFilteringEnabledChanged(void* ptr);
void QSortFilterProxyModel_RecursiveFilteringEnabledChanged(void* ptr, char recursiveFilteringEnabled);
...
void QSortFilterProxyModel_ConnectSortCaseSensitivityChanged(void* ptr, long long t);
void QSortFilterProxyModel_DisconnectSortCaseSensitivityChanged(void* ptr);
void QSortFilterProxyModel_SortCaseSensitivityChanged(void* ptr, long long sortCaseSensitivity);
int QSortFilterProxyModel_SortColumn(void* ptr);
void QSortFilterProxyModel_ConnectSortLocaleAwareChanged(void* ptr, long long t);
void QSortFilterProxyModel_DisconnectSortLocaleAwareChanged(void* ptr);
void QSortFilterProxyModel_SortLocaleAwareChanged(void* ptr, char sortLocaleAware);
long long QSortFilterProxyModel_SortOrder(void* ptr);
int QSortFilterProxyModel_SortRole(void* ptr);
void QSortFilterProxyModel_ConnectSortRoleChanged(void* ptr, long long t);
void QSortFilterProxyModel_DisconnectSortRoleChanged(void* ptr);
void QSortFilterProxyModel_SortRoleChanged(void* ptr, int sortRole);
...
void* QStringMatcher_NewQStringMatcher4(void* pattern, long long cs);
void* QStringMatcher_NewQStringMatcher5(void* other);
...
int QStringRef_Compare4(void* ptr, void* ch, long long cs);
int QStringRef_Compare5(void* ptr, void* other, long long cs);
int QStringRef_Compare6(void* ptr, void* other, long long cs);
int QStringRef_QStringRef_Compare7(void* s1, void* s2, long long cs);
int QStringRef_QStringRef_Compare8(void* s1, void* s2, long long cs);
void* QStringRef_ConstData(void* ptr);
char QStringRef_Contains(void* ptr, struct QtCore_PackedString str, long long cs);
char QStringRef_Contains2(void* ptr, void* str, long long cs);
char QStringRef_Contains3(void* ptr, void* ch, long long cs);
char QStringRef_Contains4(void* ptr, void* str, long long cs);
char QStringRef_Contains5(void* ptr, void* str, long long cs);
...
int QStringRef_LastIndexOf2(void* ptr, void* str, int from, long long cs);
int QStringRef_LastIndexOf3(void* ptr, void* ch, int from, long long cs);
int QStringRef_LastIndexOf4(void* ptr, void* str, int from, long long cs);
int QStringRef_LastIndexOf5(void* ptr, void* str, int from, long long cs);
...
int QStringRef_QStringRef_LocaleAwareCompare4(void* s1, struct QtCore_PackedString s2);
int QStringRef_QStringRef_LocaleAwareCompare5(void* s1, void* s2);
...
int QStringView_Compare(void* ptr, void* str, long long cs);
int QStringView_Compare2(void* ptr, void* l1, long long cs);
int QStringView_Compare3(void* ptr, void* ch);
int QStringView_Compare4(void* ptr, void* ch, long long cs);
char QStringView_Contains(void* ptr, void* c, long long cs);
char QStringView_Contains2(void* ptr, void* str, long long cs);
char QStringView_Contains3(void* ptr, void* l1, long long cs);
...
char QStringView_IsValidUtf16(void* ptr);
...
char QThread_Wait(void* ptr, void* deadline);
char QThread_Wait2(void* ptr, unsigned long ti);
...
struct QtCore_PackedString QTranslator_FilePath(void* ptr);
char QTranslator_IsEmpty(void* ptr);
char QTranslator_IsEmptyDefault(void* ptr);
struct QtCore_PackedString QTranslator_Language(void* ptr);
...
char QWaitCondition_Wait(void* ptr, void* lockedMutex, void* deadline);
char QWaitCondition_Wait2(void* ptr, void* lockedMutex, unsigned long ti);
char QWaitCondition_Wait3(void* ptr, void* lockedReadWriteLock, void* deadline);
char QWaitCondition_Wait4(void* ptr, void* lockedReadWriteLock, unsigned long ti);
...
void* QXmlStreamNamespaceDeclaration_NewQXmlStreamNamespaceDeclaration2(struct QtCore_PackedString prefix, struct QtCore_PackedString namespaceUri);
...
int QXmlStreamReader_EntityExpansionLimit(void* ptr);
...
void QXmlStreamReader_SetEntityExpansionLimit(void* ptr, int limit);
