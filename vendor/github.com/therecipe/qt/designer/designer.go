...
func NewQAbstractFormBuilder2() *QAbstractFormBuilder {
	return NewQAbstractFormBuilderFromPointer(C.QAbstractFormBuilder_NewQAbstractFormBuilder2())
}
...
func init() {
	...
	qt.FuncMap["designer.NewQAbstractFormBuilder2"] = NewQAbstractFormBuilder2
