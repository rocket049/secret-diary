...
char QCompressedHelpInfo_IsNull(void* ptr)
{
	return static_cast<QCompressedHelpInfo*>(ptr)->isNull();
}
...
void QHelpEngineCore___documentsForIdentifier_setList(void* ptr, void* i)
{
	static_cast<QList<QHelpLink>*>(ptr)->append(*static_cast<QHelpLink*>(i));
}

void* QHelpEngineCore___documentsForIdentifier_newList(void* ptr)
{
	Q_UNUSED(ptr);
	return new QList<QHelpLink>();
}

void QHelpEngineCore___documentsForIdentifier_setList2(void* ptr, void* i)
{
	static_cast<QList<QHelpLink>*>(ptr)->append(*static_cast<QHelpLink*>(i));
}

void* QHelpEngineCore___documentsForIdentifier_newList2(void* ptr)
{
	Q_UNUSED(ptr);
	return new QList<QHelpLink>();
}

void QHelpEngineCore___documentsForKeyword_setList(void* ptr, void* i)
{
	static_cast<QList<QHelpLink>*>(ptr)->append(*static_cast<QHelpLink*>(i));
}

void* QHelpEngineCore___documentsForKeyword_newList(void* ptr)
{
	Q_UNUSED(ptr);
	return new QList<QHelpLink>();
}

void QHelpEngineCore___documentsForKeyword_setList2(void* ptr, void* i)
{
	static_cast<QList<QHelpLink>*>(ptr)->append(*static_cast<QHelpLink*>(i));
}

void* QHelpEngineCore___documentsForKeyword_newList2(void* ptr)
{
	Q_UNUSED(ptr);
	return new QList<QHelpLink>();
}
...
void QHelpFilterData_Swap(void* ptr, void* other)
{
	static_cast<QHelpFilterData*>(ptr)->swap(*static_cast<QHelpFilterData*>(other));
}
...
struct QtHelp_PackedList QHelpFilterEngine_AvailableVersions(void* ptr)
{
	return ({ QList<QVersionNumber>* tmpValue66d964 = new QList<QVersionNumber>(static_cast<QHelpFilterEngine*>(ptr)->availableVersions()); QtHelp_PackedList { tmpValue66d964, tmpValue66d964->size() }; });
}
...
struct QtHelp_PackedString QHelpFilterEngine_Indices(void* ptr)
{
	return ({ QByteArray* taeaf96 = new QByteArray(static_cast<QHelpFilterEngine*>(ptr)->indices().join("¡¦!").toUtf8()); QtHelp_PackedString { const_cast<char*>(taeaf96->prepend("WHITESPACE").constData()+10), taeaf96->size()-10, taeaf96 }; });
}

struct QtHelp_PackedString QHelpFilterEngine_Indices2(void* ptr, struct QtHelp_PackedString filterName)
{
	return ({ QByteArray* t57295a = new QByteArray(static_cast<QHelpFilterEngine*>(ptr)->indices(QString::fromUtf8(filterName.data, filterName.len)).join("¡¦!").toUtf8()); QtHelp_PackedString { const_cast<char*>(t57295a->prepend("WHITESPACE").constData()+10), t57295a->size()-10, t57295a }; });
}
...
void* QHelpFilterEngine___availableVersions_atList(void* ptr, int i)
{
	return new QVersionNumber(({QVersionNumber tmp = static_cast<QList<QVersionNumber>*>(ptr)->at(i); if (i == static_cast<QList<QVersionNumber>*>(ptr)->size()-1) { static_cast<QList<QVersionNumber>*>(ptr)->~QList(); free(ptr); }; tmp; }));
}

void QHelpFilterEngine___availableVersions_setList(void* ptr, void* i)
{
	static_cast<QList<QVersionNumber>*>(ptr)->append(*static_cast<QVersionNumber*>(i));
}

void* QHelpFilterEngine___availableVersions_newList(void* ptr)
{
	Q_UNUSED(ptr);
	return new QList<QVersionNumber>();
}
...
class MyQHelpFilterSettingsWidget: public QHelpFilterSettingsWidget
{
public:
	MyQHelpFilterSettingsWidget(QWidget *parent = Q_NULLPTR) : QHelpFilterSettingsWidget(parent) {QHelpFilterSettingsWidget_QHelpFilterSettingsWidget_QRegisterMetaType();};
	 ~MyQHelpFilterSettingsWidget() { callbackQHelpFilterSettingsWidget_DestroyQHelpFilterSettingsWidget(this); };
	void actionEvent(QActionEvent * event) { callbackQHelpFilterSettingsWidget_ActionEvent(this, event); };
	void changeEvent(QEvent * event) { callbackQHelpFilterSettingsWidget_ChangeEvent(this, event); };
	bool close() { return callbackQHelpFilterSettingsWidget_Close(this) != 0; };
	void closeEvent(QCloseEvent * event) { callbackQHelpFilterSettingsWidget_CloseEvent(this, event); };
	void contextMenuEvent(QContextMenuEvent * event) { callbackQHelpFilterSettingsWidget_ContextMenuEvent(this, event); };
	void Signal_CustomContextMenuRequested(const QPoint & pos) { callbackQHelpFilterSettingsWidget_CustomContextMenuRequested(this, const_cast<QPoint*>(&pos)); };
	void dragEnterEvent(QDragEnterEvent * event) { callbackQHelpFilterSettingsWidget_DragEnterEvent(this, event); };
	void dragLeaveEvent(QDragLeaveEvent * event) { callbackQHelpFilterSettingsWidget_DragLeaveEvent(this, event); };
	void dragMoveEvent(QDragMoveEvent * event) { callbackQHelpFilterSettingsWidget_DragMoveEvent(this, event); };
	void dropEvent(QDropEvent * event) { callbackQHelpFilterSettingsWidget_DropEvent(this, event); };
	void enterEvent(QEvent * event) { callbackQHelpFilterSettingsWidget_EnterEvent(this, event); };
	bool event(QEvent * event) { return callbackQHelpFilterSettingsWidget_Event(this, event) != 0; };
	void focusInEvent(QFocusEvent * event) { callbackQHelpFilterSettingsWidget_FocusInEvent(this, event); };
	bool focusNextPrevChild(bool next) { return callbackQHelpFilterSettingsWidget_FocusNextPrevChild(this, next) != 0; };
	void focusOutEvent(QFocusEvent * event) { callbackQHelpFilterSettingsWidget_FocusOutEvent(this, event); };
	bool hasHeightForWidth() const { return callbackQHelpFilterSettingsWidget_HasHeightForWidth(const_cast<void*>(static_cast<const void*>(this))) != 0; };
	int heightForWidth(int w) const { return callbackQHelpFilterSettingsWidget_HeightForWidth(const_cast<void*>(static_cast<const void*>(this)), w); };
	void hide() { callbackQHelpFilterSettingsWidget_Hide(this); };
	void hideEvent(QHideEvent * event) { callbackQHelpFilterSettingsWidget_HideEvent(this, event); };
	void initPainter(QPainter * painter) const { callbackQHelpFilterSettingsWidget_InitPainter(const_cast<void*>(static_cast<const void*>(this)), painter); };
	void inputMethodEvent(QInputMethodEvent * event) { callbackQHelpFilterSettingsWidget_InputMethodEvent(this, event); };
	QVariant inputMethodQuery(Qt::InputMethodQuery query) const { return *static_cast<QVariant*>(callbackQHelpFilterSettingsWidget_InputMethodQuery(const_cast<void*>(static_cast<const void*>(this)), query)); };
	void keyPressEvent(QKeyEvent * event) { callbackQHelpFilterSettingsWidget_KeyPressEvent(this, event); };
	void keyReleaseEvent(QKeyEvent * event) { callbackQHelpFilterSettingsWidget_KeyReleaseEvent(this, event); };
	void leaveEvent(QEvent * event) { callbackQHelpFilterSettingsWidget_LeaveEvent(this, event); };
	void lower() { callbackQHelpFilterSettingsWidget_Lower(this); };
	int metric(QPaintDevice::PaintDeviceMetric m) const { return callbackQHelpFilterSettingsWidget_Metric(const_cast<void*>(static_cast<const void*>(this)), m); };
	QSize minimumSizeHint() const { return *static_cast<QSize*>(callbackQHelpFilterSettingsWidget_MinimumSizeHint(const_cast<void*>(static_cast<const void*>(this)))); };
	void mouseDoubleClickEvent(QMouseEvent * event) { callbackQHelpFilterSettingsWidget_MouseDoubleClickEvent(this, event); };
	void mouseMoveEvent(QMouseEvent * event) { callbackQHelpFilterSettingsWidget_MouseMoveEvent(this, event); };
	void mousePressEvent(QMouseEvent * event) { callbackQHelpFilterSettingsWidget_MousePressEvent(this, event); };
	void mouseReleaseEvent(QMouseEvent * event) { callbackQHelpFilterSettingsWidget_MouseReleaseEvent(this, event); };
	void moveEvent(QMoveEvent * event) { callbackQHelpFilterSettingsWidget_MoveEvent(this, event); };
	bool nativeEvent(const QByteArray & eventType, void * message, long * result) { return callbackQHelpFilterSettingsWidget_NativeEvent(this, const_cast<QByteArray*>(&eventType), message, result) != 0; };
	QPaintEngine * paintEngine() const { return static_cast<QPaintEngine*>(callbackQHelpFilterSettingsWidget_PaintEngine(const_cast<void*>(static_cast<const void*>(this)))); };
	void paintEvent(QPaintEvent * event) { callbackQHelpFilterSettingsWidget_PaintEvent(this, event); };
	void raise() { callbackQHelpFilterSettingsWidget_Raise(this); };
	void repaint() { callbackQHelpFilterSettingsWidget_Repaint(this); };
	void resizeEvent(QResizeEvent * event) { callbackQHelpFilterSettingsWidget_ResizeEvent(this, event); };
	void setDisabled(bool disable) { callbackQHelpFilterSettingsWidget_SetDisabled(this, disable); };
	void setEnabled(bool vbo) { callbackQHelpFilterSettingsWidget_SetEnabled(this, vbo); };
	void setFocus() { callbackQHelpFilterSettingsWidget_SetFocus2(this); };
	void setHidden(bool hidden) { callbackQHelpFilterSettingsWidget_SetHidden(this, hidden); };
	void setStyleSheet(const QString & styleSheet) { QByteArray* t728ae7 = new QByteArray(styleSheet.toUtf8()); QtHelp_PackedString styleSheetPacked = { const_cast<char*>(t728ae7->prepend("WHITESPACE").constData()+10), t728ae7->size()-10, t728ae7 };callbackQHelpFilterSettingsWidget_SetStyleSheet(this, styleSheetPacked); };
	void setVisible(bool visible) { callbackQHelpFilterSettingsWidget_SetVisible(this, visible); };
	void setWindowModified(bool vbo) { callbackQHelpFilterSettingsWidget_SetWindowModified(this, vbo); };
	void setWindowTitle(const QString & vqs) { QByteArray* tda39a3 = new QByteArray(vqs.toUtf8()); QtHelp_PackedString vqsPacked = { const_cast<char*>(tda39a3->prepend("WHITESPACE").constData()+10), tda39a3->size()-10, tda39a3 };callbackQHelpFilterSettingsWidget_SetWindowTitle(this, vqsPacked); };
	void show() { callbackQHelpFilterSettingsWidget_Show(this); };
	void showEvent(QShowEvent * event) { callbackQHelpFilterSettingsWidget_ShowEvent(this, event); };
	void showFullScreen() { callbackQHelpFilterSettingsWidget_ShowFullScreen(this); };
	void showMaximized() { callbackQHelpFilterSettingsWidget_ShowMaximized(this); };
	void showMinimized() { callbackQHelpFilterSettingsWidget_ShowMinimized(this); };
	void showNormal() { callbackQHelpFilterSettingsWidget_ShowNormal(this); };
	QSize sizeHint() const { return *static_cast<QSize*>(callbackQHelpFilterSettingsWidget_SizeHint(const_cast<void*>(static_cast<const void*>(this)))); };
	void tabletEvent(QTabletEvent * event) { callbackQHelpFilterSettingsWidget_TabletEvent(this, event); };
	void update() { callbackQHelpFilterSettingsWidget_Update(this); };
	void updateMicroFocus() { callbackQHelpFilterSettingsWidget_UpdateMicroFocus(this); };
	void wheelEvent(QWheelEvent * event) { callbackQHelpFilterSettingsWidget_WheelEvent(this, event); };
	void Signal_WindowIconChanged(const QIcon & icon) { callbackQHelpFilterSettingsWidget_WindowIconChanged(this, const_cast<QIcon*>(&icon)); };
	void Signal_WindowTitleChanged(const QString & title) { QByteArray* t3c6de1 = new QByteArray(title.toUtf8()); QtHelp_PackedString titlePacked = { const_cast<char*>(t3c6de1->prepend("WHITESPACE").constData()+10), t3c6de1->size()-10, t3c6de1 };callbackQHelpFilterSettingsWidget_WindowTitleChanged(this, titlePacked); };
	void childEvent(QChildEvent * event) { callbackQHelpFilterSettingsWidget_ChildEvent(this, event); };
	void connectNotify(const QMetaMethod & sign) { callbackQHelpFilterSettingsWidget_ConnectNotify(this, const_cast<QMetaMethod*>(&sign)); };
	void customEvent(QEvent * event) { callbackQHelpFilterSettingsWidget_CustomEvent(this, event); };
	void deleteLater() { callbackQHelpFilterSettingsWidget_DeleteLater(this); };
	void Signal_Destroyed(QObject * obj) { callbackQHelpFilterSettingsWidget_Destroyed(this, obj); };
	void disconnectNotify(const QMetaMethod & sign) { callbackQHelpFilterSettingsWidget_DisconnectNotify(this, const_cast<QMetaMethod*>(&sign)); };
	bool eventFilter(QObject * watched, QEvent * event) { return callbackQHelpFilterSettingsWidget_EventFilter(this, watched, event) != 0; };
	const QMetaObject * metaObject() const { return static_cast<QMetaObject*>(callbackQHelpFilterSettingsWidget_MetaObject(const_cast<void*>(static_cast<const void*>(this)))); };
	void Signal_ObjectNameChanged(const QString & objectName) { QByteArray* taa2c4f = new QByteArray(objectName.toUtf8()); QtHelp_PackedString objectNamePacked = { const_cast<char*>(taa2c4f->prepend("WHITESPACE").constData()+10), taa2c4f->size()-10, taa2c4f };callbackQHelpFilterSettingsWidget_ObjectNameChanged(this, objectNamePacked); };
	void timerEvent(QTimerEvent * event) { callbackQHelpFilterSettingsWidget_TimerEvent(this, event); };
};

Q_DECLARE_METATYPE(QHelpFilterSettingsWidget*)
Q_DECLARE_METATYPE(MyQHelpFilterSettingsWidget*)

int QHelpFilterSettingsWidget_QHelpFilterSettingsWidget_QRegisterMetaType(){qRegisterMetaType<QHelpFilterSettingsWidget*>(); return qRegisterMetaType<MyQHelpFilterSettingsWidget*>();}

void* QHelpFilterSettingsWidget_NewQHelpFilterSettingsWidget(void* parent)
{
		return new MyQHelpFilterSettingsWidget(static_cast<QWidget*>(parent));
}

char QHelpFilterSettingsWidget_ApplySettings(void* ptr, void* filterEngine)
{
	return static_cast<QHelpFilterSettingsWidget*>(ptr)->applySettings(static_cast<QHelpFilterEngine*>(filterEngine));
}

void QHelpFilterSettingsWidget_ReadSettings(void* ptr, void* filterEngine)
{
	static_cast<QHelpFilterSettingsWidget*>(ptr)->readSettings(static_cast<QHelpFilterEngine*>(filterEngine));
}

void QHelpFilterSettingsWidget_SetAvailableComponents(void* ptr, struct QtHelp_PackedString components)
{
	static_cast<QHelpFilterSettingsWidget*>(ptr)->setAvailableComponents(QString::fromUtf8(components.data, components.len).split("¡¦!", QString::SkipEmptyParts));
}

void QHelpFilterSettingsWidget_SetAvailableVersions(void* ptr, void* versions)
{
	static_cast<QHelpFilterSettingsWidget*>(ptr)->setAvailableVersions(*static_cast<QList<QVersionNumber>*>(versions));
}

void QHelpFilterSettingsWidget_DestroyQHelpFilterSettingsWidget(void* ptr)
{
	static_cast<QHelpFilterSettingsWidget*>(ptr)->~QHelpFilterSettingsWidget();
}

void QHelpFilterSettingsWidget_DestroyQHelpFilterSettingsWidgetDefault(void* ptr)
{
	Q_UNUSED(ptr);

}

void* QHelpFilterSettingsWidget___setAvailableVersions_versions_atList(void* ptr, int i)
{
	return new QVersionNumber(({QVersionNumber tmp = static_cast<QList<QVersionNumber>*>(ptr)->at(i); if (i == static_cast<QList<QVersionNumber>*>(ptr)->size()-1) { static_cast<QList<QVersionNumber>*>(ptr)->~QList(); free(ptr); }; tmp; }));
}

void QHelpFilterSettingsWidget___setAvailableVersions_versions_setList(void* ptr, void* i)
{
	static_cast<QList<QVersionNumber>*>(ptr)->append(*static_cast<QVersionNumber*>(i));
}

void* QHelpFilterSettingsWidget___setAvailableVersions_versions_newList(void* ptr)
{
	Q_UNUSED(ptr);
	return new QList<QVersionNumber>();
}

void* QHelpFilterSettingsWidget___actions_atList(void* ptr, int i)
{
	return ({QAction * tmp = static_cast<QList<QAction *>*>(ptr)->at(i); if (i == static_cast<QList<QAction *>*>(ptr)->size()-1) { static_cast<QList<QAction *>*>(ptr)->~QList(); free(ptr); }; tmp; });
}

void QHelpFilterSettingsWidget___actions_setList(void* ptr, void* i)
{
	static_cast<QList<QAction *>*>(ptr)->append(static_cast<QAction*>(i));
}

void* QHelpFilterSettingsWidget___actions_newList(void* ptr)
{
	Q_UNUSED(ptr);
	return new QList<QAction *>();
}

void* QHelpFilterSettingsWidget___addActions_actions_atList(void* ptr, int i)
{
	return ({QAction * tmp = static_cast<QList<QAction *>*>(ptr)->at(i); if (i == static_cast<QList<QAction *>*>(ptr)->size()-1) { static_cast<QList<QAction *>*>(ptr)->~QList(); free(ptr); }; tmp; });
}

void QHelpFilterSettingsWidget___addActions_actions_setList(void* ptr, void* i)
{
	static_cast<QList<QAction *>*>(ptr)->append(static_cast<QAction*>(i));
}

void* QHelpFilterSettingsWidget___addActions_actions_newList(void* ptr)
{
	Q_UNUSED(ptr);
	return new QList<QAction *>();
}

void* QHelpFilterSettingsWidget___insertActions_actions_atList(void* ptr, int i)
{
	return ({QAction * tmp = static_cast<QList<QAction *>*>(ptr)->at(i); if (i == static_cast<QList<QAction *>*>(ptr)->size()-1) { static_cast<QList<QAction *>*>(ptr)->~QList(); free(ptr); }; tmp; });
}

void QHelpFilterSettingsWidget___insertActions_actions_setList(void* ptr, void* i)
{
	static_cast<QList<QAction *>*>(ptr)->append(static_cast<QAction*>(i));
}

void* QHelpFilterSettingsWidget___insertActions_actions_newList(void* ptr)
{
	Q_UNUSED(ptr);
	return new QList<QAction *>();
}

void* QHelpFilterSettingsWidget___children_atList(void* ptr, int i)
{
	return ({QObject * tmp = static_cast<QList<QObject *>*>(ptr)->at(i); if (i == static_cast<QList<QObject *>*>(ptr)->size()-1) { static_cast<QList<QObject *>*>(ptr)->~QList(); free(ptr); }; tmp; });
}

void QHelpFilterSettingsWidget___children_setList(void* ptr, void* i)
{
	static_cast<QList<QObject *>*>(ptr)->append(static_cast<QObject*>(i));
}

void* QHelpFilterSettingsWidget___children_newList(void* ptr)
{
	Q_UNUSED(ptr);
	return new QList<QObject *>();
}

void* QHelpFilterSettingsWidget___dynamicPropertyNames_atList(void* ptr, int i)
{
	return new QByteArray(({QByteArray tmp = static_cast<QList<QByteArray>*>(ptr)->at(i); if (i == static_cast<QList<QByteArray>*>(ptr)->size()-1) { static_cast<QList<QByteArray>*>(ptr)->~QList(); free(ptr); }; tmp; }));
}

void QHelpFilterSettingsWidget___dynamicPropertyNames_setList(void* ptr, void* i)
{
	static_cast<QList<QByteArray>*>(ptr)->append(*static_cast<QByteArray*>(i));
}

void* QHelpFilterSettingsWidget___dynamicPropertyNames_newList(void* ptr)
{
	Q_UNUSED(ptr);
	return new QList<QByteArray>();
}

void* QHelpFilterSettingsWidget___findChildren_atList(void* ptr, int i)
{
	return ({QObject* tmp = static_cast<QList<QObject*>*>(ptr)->at(i); if (i == static_cast<QList<QObject*>*>(ptr)->size()-1) { static_cast<QList<QObject*>*>(ptr)->~QList(); free(ptr); }; tmp; });
}

void QHelpFilterSettingsWidget___findChildren_setList(void* ptr, void* i)
{
	static_cast<QList<QObject*>*>(ptr)->append(static_cast<QObject*>(i));
}

void* QHelpFilterSettingsWidget___findChildren_newList(void* ptr)
{
	Q_UNUSED(ptr);
	return new QList<QObject*>();
}

void* QHelpFilterSettingsWidget___findChildren_atList3(void* ptr, int i)
{
	return ({QObject* tmp = static_cast<QList<QObject*>*>(ptr)->at(i); if (i == static_cast<QList<QObject*>*>(ptr)->size()-1) { static_cast<QList<QObject*>*>(ptr)->~QList(); free(ptr); }; tmp; });
}

void QHelpFilterSettingsWidget___findChildren_setList3(void* ptr, void* i)
{
	static_cast<QList<QObject*>*>(ptr)->append(static_cast<QObject*>(i));
}

void* QHelpFilterSettingsWidget___findChildren_newList3(void* ptr)
{
	Q_UNUSED(ptr);
	return new QList<QObject*>();
}

void QHelpFilterSettingsWidget_ActionEventDefault(void* ptr, void* event)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::actionEvent(static_cast<QActionEvent*>(event));
}

void QHelpFilterSettingsWidget_ChangeEventDefault(void* ptr, void* event)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::changeEvent(static_cast<QEvent*>(event));
}

char QHelpFilterSettingsWidget_CloseDefault(void* ptr)
{
		return static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::close();
}

void QHelpFilterSettingsWidget_CloseEventDefault(void* ptr, void* event)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::closeEvent(static_cast<QCloseEvent*>(event));
}

void QHelpFilterSettingsWidget_ContextMenuEventDefault(void* ptr, void* event)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::contextMenuEvent(static_cast<QContextMenuEvent*>(event));
}

void QHelpFilterSettingsWidget_DragEnterEventDefault(void* ptr, void* event)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::dragEnterEvent(static_cast<QDragEnterEvent*>(event));
}

void QHelpFilterSettingsWidget_DragLeaveEventDefault(void* ptr, void* event)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::dragLeaveEvent(static_cast<QDragLeaveEvent*>(event));
}

void QHelpFilterSettingsWidget_DragMoveEventDefault(void* ptr, void* event)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::dragMoveEvent(static_cast<QDragMoveEvent*>(event));
}

void QHelpFilterSettingsWidget_DropEventDefault(void* ptr, void* event)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::dropEvent(static_cast<QDropEvent*>(event));
}

void QHelpFilterSettingsWidget_EnterEventDefault(void* ptr, void* event)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::enterEvent(static_cast<QEvent*>(event));
}

char QHelpFilterSettingsWidget_EventDefault(void* ptr, void* event)
{
		return static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::event(static_cast<QEvent*>(event));
}

void QHelpFilterSettingsWidget_FocusInEventDefault(void* ptr, void* event)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::focusInEvent(static_cast<QFocusEvent*>(event));
}

char QHelpFilterSettingsWidget_FocusNextPrevChildDefault(void* ptr, char next)
{
		return static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::focusNextPrevChild(next != 0);
}

void QHelpFilterSettingsWidget_FocusOutEventDefault(void* ptr, void* event)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::focusOutEvent(static_cast<QFocusEvent*>(event));
}

char QHelpFilterSettingsWidget_HasHeightForWidthDefault(void* ptr)
{
		return static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::hasHeightForWidth();
}

int QHelpFilterSettingsWidget_HeightForWidthDefault(void* ptr, int w)
{
		return static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::heightForWidth(w);
}

void QHelpFilterSettingsWidget_HideDefault(void* ptr)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::hide();
}

void QHelpFilterSettingsWidget_HideEventDefault(void* ptr, void* event)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::hideEvent(static_cast<QHideEvent*>(event));
}

void QHelpFilterSettingsWidget_InitPainterDefault(void* ptr, void* painter)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::initPainter(static_cast<QPainter*>(painter));
}

void QHelpFilterSettingsWidget_InputMethodEventDefault(void* ptr, void* event)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::inputMethodEvent(static_cast<QInputMethodEvent*>(event));
}

void* QHelpFilterSettingsWidget_InputMethodQueryDefault(void* ptr, long long query)
{
		return new QVariant(static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::inputMethodQuery(static_cast<Qt::InputMethodQuery>(query)));
}

void QHelpFilterSettingsWidget_KeyPressEventDefault(void* ptr, void* event)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::keyPressEvent(static_cast<QKeyEvent*>(event));
}

void QHelpFilterSettingsWidget_KeyReleaseEventDefault(void* ptr, void* event)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::keyReleaseEvent(static_cast<QKeyEvent*>(event));
}

void QHelpFilterSettingsWidget_LeaveEventDefault(void* ptr, void* event)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::leaveEvent(static_cast<QEvent*>(event));
}

void QHelpFilterSettingsWidget_LowerDefault(void* ptr)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::lower();
}

int QHelpFilterSettingsWidget_MetricDefault(void* ptr, long long m)
{
		return static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::metric(static_cast<QPaintDevice::PaintDeviceMetric>(m));
}

void* QHelpFilterSettingsWidget_MinimumSizeHintDefault(void* ptr)
{
		return ({ QSize tmpValue = static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::minimumSizeHint(); new QSize(tmpValue.width(), tmpValue.height()); });
}

void QHelpFilterSettingsWidget_MouseDoubleClickEventDefault(void* ptr, void* event)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::mouseDoubleClickEvent(static_cast<QMouseEvent*>(event));
}

void QHelpFilterSettingsWidget_MouseMoveEventDefault(void* ptr, void* event)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::mouseMoveEvent(static_cast<QMouseEvent*>(event));
}

void QHelpFilterSettingsWidget_MousePressEventDefault(void* ptr, void* event)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::mousePressEvent(static_cast<QMouseEvent*>(event));
}

void QHelpFilterSettingsWidget_MouseReleaseEventDefault(void* ptr, void* event)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::mouseReleaseEvent(static_cast<QMouseEvent*>(event));
}

void QHelpFilterSettingsWidget_MoveEventDefault(void* ptr, void* event)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::moveEvent(static_cast<QMoveEvent*>(event));
}

char QHelpFilterSettingsWidget_NativeEventDefault(void* ptr, void* eventType, void* message, long* result)
{
		return static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::nativeEvent(*static_cast<QByteArray*>(eventType), message, result);
}

void* QHelpFilterSettingsWidget_PaintEngineDefault(void* ptr)
{
		return static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::paintEngine();
}

void QHelpFilterSettingsWidget_PaintEventDefault(void* ptr, void* event)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::paintEvent(static_cast<QPaintEvent*>(event));
}

void QHelpFilterSettingsWidget_RaiseDefault(void* ptr)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::raise();
}

void QHelpFilterSettingsWidget_RepaintDefault(void* ptr)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::repaint();
}

void QHelpFilterSettingsWidget_ResizeEventDefault(void* ptr, void* event)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::resizeEvent(static_cast<QResizeEvent*>(event));
}

void QHelpFilterSettingsWidget_SetDisabledDefault(void* ptr, char disable)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::setDisabled(disable != 0);
}

void QHelpFilterSettingsWidget_SetEnabledDefault(void* ptr, char vbo)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::setEnabled(vbo != 0);
}

void QHelpFilterSettingsWidget_SetFocus2Default(void* ptr)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::setFocus();
}

void QHelpFilterSettingsWidget_SetHiddenDefault(void* ptr, char hidden)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::setHidden(hidden != 0);
}

void QHelpFilterSettingsWidget_SetStyleSheetDefault(void* ptr, struct QtHelp_PackedString styleSheet)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::setStyleSheet(QString::fromUtf8(styleSheet.data, styleSheet.len));
}

void QHelpFilterSettingsWidget_SetVisibleDefault(void* ptr, char visible)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::setVisible(visible != 0);
}

void QHelpFilterSettingsWidget_SetWindowModifiedDefault(void* ptr, char vbo)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::setWindowModified(vbo != 0);
}

void QHelpFilterSettingsWidget_SetWindowTitleDefault(void* ptr, struct QtHelp_PackedString vqs)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::setWindowTitle(QString::fromUtf8(vqs.data, vqs.len));
}

void QHelpFilterSettingsWidget_ShowDefault(void* ptr)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::show();
}

void QHelpFilterSettingsWidget_ShowEventDefault(void* ptr, void* event)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::showEvent(static_cast<QShowEvent*>(event));
}

void QHelpFilterSettingsWidget_ShowFullScreenDefault(void* ptr)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::showFullScreen();
}

void QHelpFilterSettingsWidget_ShowMaximizedDefault(void* ptr)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::showMaximized();
}

void QHelpFilterSettingsWidget_ShowMinimizedDefault(void* ptr)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::showMinimized();
}

void QHelpFilterSettingsWidget_ShowNormalDefault(void* ptr)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::showNormal();
}

void* QHelpFilterSettingsWidget_SizeHintDefault(void* ptr)
{
		return ({ QSize tmpValue = static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::sizeHint(); new QSize(tmpValue.width(), tmpValue.height()); });
}

void QHelpFilterSettingsWidget_TabletEventDefault(void* ptr, void* event)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::tabletEvent(static_cast<QTabletEvent*>(event));
}

void QHelpFilterSettingsWidget_UpdateDefault(void* ptr)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::update();
}

void QHelpFilterSettingsWidget_UpdateMicroFocusDefault(void* ptr)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::updateMicroFocus();
}

void QHelpFilterSettingsWidget_WheelEventDefault(void* ptr, void* event)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::wheelEvent(static_cast<QWheelEvent*>(event));
}

void QHelpFilterSettingsWidget_ChildEventDefault(void* ptr, void* event)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::childEvent(static_cast<QChildEvent*>(event));
}

void QHelpFilterSettingsWidget_ConnectNotifyDefault(void* ptr, void* sign)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::connectNotify(*static_cast<QMetaMethod*>(sign));
}

void QHelpFilterSettingsWidget_CustomEventDefault(void* ptr, void* event)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::customEvent(static_cast<QEvent*>(event));
}

void QHelpFilterSettingsWidget_DeleteLaterDefault(void* ptr)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::deleteLater();
}

void QHelpFilterSettingsWidget_DisconnectNotifyDefault(void* ptr, void* sign)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::disconnectNotify(*static_cast<QMetaMethod*>(sign));
}

char QHelpFilterSettingsWidget_EventFilterDefault(void* ptr, void* watched, void* event)
{
		return static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::eventFilter(static_cast<QObject*>(watched), static_cast<QEvent*>(event));
}

void* QHelpFilterSettingsWidget_MetaObjectDefault(void* ptr)
{
		return const_cast<QMetaObject*>(static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::metaObject());
}

void QHelpFilterSettingsWidget_TimerEventDefault(void* ptr, void* event)
{
		static_cast<QHelpFilterSettingsWidget*>(ptr)->QHelpFilterSettingsWidget::timerEvent(static_cast<QTimerEvent*>(event));
}
...
void* QHelpIndexModel_HelpEngine(void* ptr)
{
	return static_cast<QHelpIndexModel*>(ptr)->helpEngine();
}
...
public:
	...
	void Signal_DocumentActivated(const QHelpLink & document, const QString & keyword) { QByteArray* ta43aa2 = new QByteArray(keyword.toUtf8()); QtHelp_PackedString keywordPacked = { const_cast<char*>(ta43aa2->prepend("WHITESPACE").constData()+10), ta43aa2->size()-10, ta43aa2 };callbackQHelpIndexWidget_DocumentActivated(this, const_cast<QHelpLink*>(&document), keywordPacked); };
	...
	void dropEvent(QDropEvent * event) { callbackQHelpIndexWidget_DropEvent(this, event); };
...
void QHelpIndexWidget_ConnectDocumentActivated(void* ptr, long long t)
{
	QObject::connect(static_cast<QHelpIndexWidget*>(ptr), static_cast<void (QHelpIndexWidget::*)(const QHelpLink &, const QString &)>(&QHelpIndexWidget::documentActivated), static_cast<MyQHelpIndexWidget*>(ptr), static_cast<void (MyQHelpIndexWidget::*)(const QHelpLink &, const QString &)>(&MyQHelpIndexWidget::Signal_DocumentActivated), static_cast<Qt::ConnectionType>(t));
}

void QHelpIndexWidget_DisconnectDocumentActivated(void* ptr)
{
	QObject::disconnect(static_cast<QHelpIndexWidget*>(ptr), static_cast<void (QHelpIndexWidget::*)(const QHelpLink &, const QString &)>(&QHelpIndexWidget::documentActivated), static_cast<MyQHelpIndexWidget*>(ptr), static_cast<void (MyQHelpIndexWidget::*)(const QHelpLink &, const QString &)>(&MyQHelpIndexWidget::Signal_DocumentActivated));
}

void QHelpIndexWidget_DocumentActivated(void* ptr, void* document, struct QtHelp_PackedString keyword)
{
	static_cast<QHelpIndexWidget*>(ptr)->documentActivated(*static_cast<QHelpLink*>(document), QString::fromUtf8(keyword.data, keyword.len));
}
...
void QHelpIndexWidget___documentsActivated_documents_setList(void* ptr, void* i)
{
	static_cast<QList<QHelpLink>*>(ptr)->append(*static_cast<QHelpLink*>(i));
}

void* QHelpIndexWidget___documentsActivated_documents_newList(void* ptr)
{
	Q_UNUSED(ptr);
	return new QList<QHelpLink>();
}
...
void QHelpIndexWidget_DropEventDefault(void* ptr, void* event)
{
		static_cast<QHelpIndexWidget*>(ptr)->QHelpIndexWidget::dropEvent(static_cast<QDropEvent*>(event));
}
...
struct QtHelp_PackedString QHelpLink_Title(void* ptr)
{
	return ({ QByteArray* tb7a7df = new QByteArray(static_cast<QHelpLink*>(ptr)->title.toUtf8()); QtHelp_PackedString { const_cast<char*>(tb7a7df->prepend("WHITESPACE").constData()+10), tb7a7df->size()-10, tb7a7df }; });
}

void QHelpLink_SetTitle(void* ptr, struct QtHelp_PackedString vqs)
{
	static_cast<QHelpLink*>(ptr)->title = QString::fromUtf8(vqs.data, vqs.len);
}

void* QHelpLink_Url(void* ptr)
{
	return new QUrl(static_cast<QHelpLink*>(ptr)->url);
}

void QHelpLink_SetUrl(void* ptr, void* vqu)
{
	static_cast<QHelpLink*>(ptr)->url = *static_cast<QUrl*>(vqu);
}
