...
func (ptr *QCompressedHelpInfo) IsNull() bool {
	if ptr.Pointer() != nil {
		return int8(C.QCompressedHelpInfo_IsNull(ptr.Pointer())) != 0
	}
	return false
}
...
func (ptr *QHelpEngineCore) __documentsForIdentifier_setList(i QHelpLink_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpEngineCore___documentsForIdentifier_setList(ptr.Pointer(), PointerFromQHelpLink(i))
	}
}

func (ptr *QHelpEngineCore) __documentsForIdentifier_newList() unsafe.Pointer {
	return C.QHelpEngineCore___documentsForIdentifier_newList(ptr.Pointer())
}

func (ptr *QHelpEngineCore) __documentsForIdentifier_setList2(i QHelpLink_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpEngineCore___documentsForIdentifier_setList2(ptr.Pointer(), PointerFromQHelpLink(i))
	}
}

func (ptr *QHelpEngineCore) __documentsForIdentifier_newList2() unsafe.Pointer {
	return C.QHelpEngineCore___documentsForIdentifier_newList2(ptr.Pointer())
}

func (ptr *QHelpEngineCore) __documentsForKeyword_setList(i QHelpLink_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpEngineCore___documentsForKeyword_setList(ptr.Pointer(), PointerFromQHelpLink(i))
	}
}

func (ptr *QHelpEngineCore) __documentsForKeyword_newList() unsafe.Pointer {
	return C.QHelpEngineCore___documentsForKeyword_newList(ptr.Pointer())
}

func (ptr *QHelpEngineCore) __documentsForKeyword_setList2(i QHelpLink_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpEngineCore___documentsForKeyword_setList2(ptr.Pointer(), PointerFromQHelpLink(i))
	}
}

func (ptr *QHelpEngineCore) __documentsForKeyword_newList2() unsafe.Pointer {
	return C.QHelpEngineCore___documentsForKeyword_newList2(ptr.Pointer())
}
...
func (ptr *QHelpFilterData) Swap(other QHelpFilterData_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterData_Swap(ptr.Pointer(), PointerFromQHelpFilterData(other))
	}
}
...
func (ptr *QHelpFilterEngine) AvailableVersions() []*core.QVersionNumber {
	if ptr.Pointer() != nil {
		return func(l C.struct_QtHelp_PackedList) []*core.QVersionNumber {
			out := make([]*core.QVersionNumber, int(l.len))
			tmpList := NewQHelpFilterEngineFromPointer(l.data)
			for i := 0; i < len(out); i++ {
				out[i] = tmpList.__availableVersions_atList(i)
			}
			return out
		}(C.QHelpFilterEngine_AvailableVersions(ptr.Pointer()))
	}
	return make([]*core.QVersionNumber, 0)
}
...
func (ptr *QHelpFilterEngine) Indices() []string {
	if ptr.Pointer() != nil {
		return unpackStringList(cGoUnpackString(C.QHelpFilterEngine_Indices(ptr.Pointer())))
	}
	return make([]string, 0)
}

func (ptr *QHelpFilterEngine) Indices2(filterName string) []string {
	if ptr.Pointer() != nil {
		var filterNameC *C.char
		if filterName != "" {
			filterNameC = C.CString(filterName)
		...
		return unpackStringList(cGoUnpackString(C.QHelpFilterEngine_Indices2(ptr.Pointer(), C.struct_QtHelp_PackedString{data: filterNameC, len: C.longlong(len(filterName))})))
	}
	return make([]string, 0)
}
...
func (ptr *QHelpFilterEngine) __availableVersions_atList(i int) *core.QVersionNumber {
	if ptr.Pointer() != nil {
		tmpValue := core.NewQVersionNumberFromPointer(C.QHelpFilterEngine___availableVersions_atList(ptr.Pointer(), C.int(int32(i))))
		qt.SetFinalizer(tmpValue, (*core.QVersionNumber).DestroyQVersionNumber)
		return tmpValue
	}
	return nil
...
func (ptr *QHelpFilterEngine) __availableVersions_setList(i core.QVersionNumber_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterEngine___availableVersions_setList(ptr.Pointer(), core.PointerFromQVersionNumber(i))
	}
}

func (ptr *QHelpFilterEngine) __availableVersions_newList() unsafe.Pointer {
	return C.QHelpFilterEngine___availableVersions_newList(ptr.Pointer())
}
...
type QHelpFilterSettingsWidget struct {
	widgets.QWidget
}

type QHelpFilterSettingsWidget_ITF interface {
	widgets.QWidget_ITF
	QHelpFilterSettingsWidget_PTR() *QHelpFilterSettingsWidget
}

func (ptr *QHelpFilterSettingsWidget) QHelpFilterSettingsWidget_PTR() *QHelpFilterSettingsWidget {
	return ptr
}

func (ptr *QHelpFilterSettingsWidget) Pointer() unsafe.Pointer {
	if ptr != nil {
...
func (ptr *QHelpFilterSettingsWidget) SetPointer(p unsafe.Pointer) {
	if ptr != nil {
		ptr.QWidget_PTR().SetPointer(p)
	}
}

func PointerFromQHelpFilterSettingsWidget(ptr QHelpFilterSettingsWidget_ITF) unsafe.Pointer {
	if ptr != nil {
		return ptr.QHelpFilterSettingsWidget_PTR().Pointer()
	}
	return nil
}

func NewQHelpFilterSettingsWidgetFromPointer(ptr unsafe.Pointer) (n *QHelpFilterSettingsWidget) {
	n = new(QHelpFilterSettingsWidget)
	n.SetPointer(ptr)
	return
}
func NewQHelpFilterSettingsWidget(parent widgets.QWidget_ITF) *QHelpFilterSettingsWidget {
	tmpValue := NewQHelpFilterSettingsWidgetFromPointer(C.QHelpFilterSettingsWidget_NewQHelpFilterSettingsWidget(widgets.PointerFromQWidget(parent)))
	if !qt.ExistsSignal(tmpValue.Pointer(), "destroyed") {
		tmpValue.ConnectDestroyed(func(*core.QObject) { tmpValue.SetPointer(nil) })
	}
	return tmpValue
...
func (ptr *QHelpFilterSettingsWidget) ApplySettings(filterEngine QHelpFilterEngine_ITF) bool {
	if ptr.Pointer() != nil {
		return int8(C.QHelpFilterSettingsWidget_ApplySettings(ptr.Pointer(), PointerFromQHelpFilterEngine(filterEngine))) != 0
	}
	return false
}

func (ptr *QHelpFilterSettingsWidget) ReadSettings(filterEngine QHelpFilterEngine_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_ReadSettings(ptr.Pointer(), PointerFromQHelpFilterEngine(filterEngine))
	}
}

func (ptr *QHelpFilterSettingsWidget) SetAvailableComponents(components []string) {
	if ptr.Pointer() != nil {
		componentsC := C.CString(strings.Join(components, "¡¦!"))
		defer C.free(unsafe.Pointer(componentsC))
		C.QHelpFilterSettingsWidget_SetAvailableComponents(ptr.Pointer(), C.struct_QtHelp_PackedString{data: componentsC, len: C.longlong(len(strings.Join(components, "¡¦!")))})
	}
}

func (ptr *QHelpFilterSettingsWidget) SetAvailableVersions(versions []*core.QVersionNumber) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_SetAvailableVersions(ptr.Pointer(), func() unsafe.Pointer {
			tmpList := NewQHelpFilterSettingsWidgetFromPointer(NewQHelpFilterSettingsWidgetFromPointer(nil).__setAvailableVersions_versions_newList())
			for _, v := range versions {
				tmpList.__setAvailableVersions_versions_setList(v)
			}
			return tmpList.Pointer()
		}())
	}
...
//export callbackQHelpFilterSettingsWidget_DestroyQHelpFilterSettingsWidget
func callbackQHelpFilterSettingsWidget_DestroyQHelpFilterSettingsWidget(ptr unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "~QHelpFilterSettingsWidget"); signal != nil {
		(*(*func())(signal))()
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).DestroyQHelpFilterSettingsWidgetDefault()
	}
}

func (ptr *QHelpFilterSettingsWidget) ConnectDestroyQHelpFilterSettingsWidget(f func()) {
	if ptr.Pointer() != nil {

		if signal := qt.LendSignal(ptr.Pointer(), "~QHelpFilterSettingsWidget"); signal != nil {
			f := func() {
				(*(*func())(signal))()
				f()
			}
			qt.ConnectSignal(ptr.Pointer(), "~QHelpFilterSettingsWidget", unsafe.Pointer(&f))
		} else {
			qt.ConnectSignal(ptr.Pointer(), "~QHelpFilterSettingsWidget", unsafe.Pointer(&f))
		}
	}
...
func (ptr *QHelpFilterSettingsWidget) DisconnectDestroyQHelpFilterSettingsWidget() {
	if ptr.Pointer() != nil {

		qt.DisconnectSignal(ptr.Pointer(), "~QHelpFilterSettingsWidget")
	}
}

func (ptr *QHelpFilterSettingsWidget) DestroyQHelpFilterSettingsWidget() {
	if ptr.Pointer() != nil {

		qt.SetFinalizer(ptr, nil)
		C.QHelpFilterSettingsWidget_DestroyQHelpFilterSettingsWidget(ptr.Pointer())
		ptr.SetPointer(nil)
	}
}

func (ptr *QHelpFilterSettingsWidget) DestroyQHelpFilterSettingsWidgetDefault() {
	if ptr.Pointer() != nil {

		qt.SetFinalizer(ptr, nil)
		C.QHelpFilterSettingsWidget_DestroyQHelpFilterSettingsWidgetDefault(ptr.Pointer())
		ptr.SetPointer(nil)
	}
}

func (ptr *QHelpFilterSettingsWidget) __setAvailableVersions_versions_atList(i int) *core.QVersionNumber {
	if ptr.Pointer() != nil {
		tmpValue := core.NewQVersionNumberFromPointer(C.QHelpFilterSettingsWidget___setAvailableVersions_versions_atList(ptr.Pointer(), C.int(int32(i))))
		qt.SetFinalizer(tmpValue, (*core.QVersionNumber).DestroyQVersionNumber)
		return tmpValue
	}
	return nil
...
func (ptr *QHelpFilterSettingsWidget) __setAvailableVersions_versions_setList(i core.QVersionNumber_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget___setAvailableVersions_versions_setList(ptr.Pointer(), core.PointerFromQVersionNumber(i))
	}
}

func (ptr *QHelpFilterSettingsWidget) __setAvailableVersions_versions_newList() unsafe.Pointer {
	return C.QHelpFilterSettingsWidget___setAvailableVersions_versions_newList(ptr.Pointer())
}

func (ptr *QHelpFilterSettingsWidget) __actions_atList(i int) *widgets.QAction {
	if ptr.Pointer() != nil {
		tmpValue := widgets.NewQActionFromPointer(C.QHelpFilterSettingsWidget___actions_atList(ptr.Pointer(), C.int(int32(i))))
		if !qt.ExistsSignal(tmpValue.Pointer(), "destroyed") {
			tmpValue.ConnectDestroyed(func(*core.QObject) { tmpValue.SetPointer(nil) })
		}
		return tmpValue
...
func (ptr *QHelpFilterSettingsWidget) __actions_setList(i widgets.QAction_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget___actions_setList(ptr.Pointer(), widgets.PointerFromQAction(i))
	}
}

func (ptr *QHelpFilterSettingsWidget) __actions_newList() unsafe.Pointer {
	return C.QHelpFilterSettingsWidget___actions_newList(ptr.Pointer())
}

func (ptr *QHelpFilterSettingsWidget) __addActions_actions_atList(i int) *widgets.QAction {
	if ptr.Pointer() != nil {
		tmpValue := widgets.NewQActionFromPointer(C.QHelpFilterSettingsWidget___addActions_actions_atList(ptr.Pointer(), C.int(int32(i))))
		if !qt.ExistsSignal(tmpValue.Pointer(), "destroyed") {
			tmpValue.ConnectDestroyed(func(*core.QObject) { tmpValue.SetPointer(nil) })
		}
		return tmpValue
...
func (ptr *QHelpFilterSettingsWidget) __addActions_actions_setList(i widgets.QAction_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget___addActions_actions_setList(ptr.Pointer(), widgets.PointerFromQAction(i))
	}
}

func (ptr *QHelpFilterSettingsWidget) __addActions_actions_newList() unsafe.Pointer {
	return C.QHelpFilterSettingsWidget___addActions_actions_newList(ptr.Pointer())
}

func (ptr *QHelpFilterSettingsWidget) __insertActions_actions_atList(i int) *widgets.QAction {
	if ptr.Pointer() != nil {
		tmpValue := widgets.NewQActionFromPointer(C.QHelpFilterSettingsWidget___insertActions_actions_atList(ptr.Pointer(), C.int(int32(i))))
		if !qt.ExistsSignal(tmpValue.Pointer(), "destroyed") {
			tmpValue.ConnectDestroyed(func(*core.QObject) { tmpValue.SetPointer(nil) })
		}
		return tmpValue
...
func (ptr *QHelpFilterSettingsWidget) __insertActions_actions_setList(i widgets.QAction_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget___insertActions_actions_setList(ptr.Pointer(), widgets.PointerFromQAction(i))
	}
}

func (ptr *QHelpFilterSettingsWidget) __insertActions_actions_newList() unsafe.Pointer {
	return C.QHelpFilterSettingsWidget___insertActions_actions_newList(ptr.Pointer())
}

func (ptr *QHelpFilterSettingsWidget) __children_atList(i int) *core.QObject {
	if ptr.Pointer() != nil {
		tmpValue := core.NewQObjectFromPointer(C.QHelpFilterSettingsWidget___children_atList(ptr.Pointer(), C.int(int32(i))))
		if !qt.ExistsSignal(tmpValue.Pointer(), "destroyed") {
			tmpValue.ConnectDestroyed(func(*core.QObject) { tmpValue.SetPointer(nil) })
		}
		return tmpValue
...
func (ptr *QHelpFilterSettingsWidget) __children_setList(i core.QObject_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget___children_setList(ptr.Pointer(), core.PointerFromQObject(i))
	}
}

func (ptr *QHelpFilterSettingsWidget) __children_newList() unsafe.Pointer {
	return C.QHelpFilterSettingsWidget___children_newList(ptr.Pointer())
}

func (ptr *QHelpFilterSettingsWidget) __dynamicPropertyNames_atList(i int) *core.QByteArray {
	if ptr.Pointer() != nil {
		tmpValue := core.NewQByteArrayFromPointer(C.QHelpFilterSettingsWidget___dynamicPropertyNames_atList(ptr.Pointer(), C.int(int32(i))))
		qt.SetFinalizer(tmpValue, (*core.QByteArray).DestroyQByteArray)
		return tmpValue
	}
	return nil
...
func (ptr *QHelpFilterSettingsWidget) __dynamicPropertyNames_setList(i core.QByteArray_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget___dynamicPropertyNames_setList(ptr.Pointer(), core.PointerFromQByteArray(i))
	}
}

func (ptr *QHelpFilterSettingsWidget) __dynamicPropertyNames_newList() unsafe.Pointer {
	return C.QHelpFilterSettingsWidget___dynamicPropertyNames_newList(ptr.Pointer())
}

func (ptr *QHelpFilterSettingsWidget) __findChildren_atList(i int) *core.QObject {
	if ptr.Pointer() != nil {
		tmpValue := core.NewQObjectFromPointer(C.QHelpFilterSettingsWidget___findChildren_atList(ptr.Pointer(), C.int(int32(i))))
		if !qt.ExistsSignal(tmpValue.Pointer(), "destroyed") {
			tmpValue.ConnectDestroyed(func(*core.QObject) { tmpValue.SetPointer(nil) })
		}
		return tmpValue
...
func (ptr *QHelpFilterSettingsWidget) __findChildren_setList(i core.QObject_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget___findChildren_setList(ptr.Pointer(), core.PointerFromQObject(i))
	}
}

func (ptr *QHelpFilterSettingsWidget) __findChildren_newList() unsafe.Pointer {
	return C.QHelpFilterSettingsWidget___findChildren_newList(ptr.Pointer())
}

func (ptr *QHelpFilterSettingsWidget) __findChildren_atList3(i int) *core.QObject {
	if ptr.Pointer() != nil {
		tmpValue := core.NewQObjectFromPointer(C.QHelpFilterSettingsWidget___findChildren_atList3(ptr.Pointer(), C.int(int32(i))))
		if !qt.ExistsSignal(tmpValue.Pointer(), "destroyed") {
			tmpValue.ConnectDestroyed(func(*core.QObject) { tmpValue.SetPointer(nil) })
		}
		return tmpValue
...
func (ptr *QHelpFilterSettingsWidget) __findChildren_setList3(i core.QObject_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget___findChildren_setList3(ptr.Pointer(), core.PointerFromQObject(i))
	}
}

func (ptr *QHelpFilterSettingsWidget) __findChildren_newList3() unsafe.Pointer {
	return C.QHelpFilterSettingsWidget___findChildren_newList3(ptr.Pointer())
}

//export callbackQHelpFilterSettingsWidget_ActionEvent
func callbackQHelpFilterSettingsWidget_ActionEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "actionEvent"); signal != nil {
		(*(*func(*gui.QActionEvent))(signal))(gui.NewQActionEventFromPointer(event))
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).ActionEventDefault(gui.NewQActionEventFromPointer(event))
	}
}

func (ptr *QHelpFilterSettingsWidget) ActionEventDefault(event gui.QActionEvent_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_ActionEventDefault(ptr.Pointer(), gui.PointerFromQActionEvent(event))
	}
}

//export callbackQHelpFilterSettingsWidget_ChangeEvent
func callbackQHelpFilterSettingsWidget_ChangeEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "changeEvent"); signal != nil {
		(*(*func(*core.QEvent))(signal))(core.NewQEventFromPointer(event))
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).ChangeEventDefault(core.NewQEventFromPointer(event))
	}
}

func (ptr *QHelpFilterSettingsWidget) ChangeEventDefault(event core.QEvent_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_ChangeEventDefault(ptr.Pointer(), core.PointerFromQEvent(event))
	}
}

//export callbackQHelpFilterSettingsWidget_Close
func callbackQHelpFilterSettingsWidget_Close(ptr unsafe.Pointer) C.char {
	if signal := qt.GetSignal(ptr, "close"); signal != nil {
		return C.char(int8(qt.GoBoolToInt((*(*func() bool)(signal))())))
	}

	return C.char(int8(qt.GoBoolToInt(NewQHelpFilterSettingsWidgetFromPointer(ptr).CloseDefault())))
}

func (ptr *QHelpFilterSettingsWidget) CloseDefault() bool {
	if ptr.Pointer() != nil {
		return int8(C.QHelpFilterSettingsWidget_CloseDefault(ptr.Pointer())) != 0
	}
	return false
}

//export callbackQHelpFilterSettingsWidget_CloseEvent
func callbackQHelpFilterSettingsWidget_CloseEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "closeEvent"); signal != nil {
		(*(*func(*gui.QCloseEvent))(signal))(gui.NewQCloseEventFromPointer(event))
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).CloseEventDefault(gui.NewQCloseEventFromPointer(event))
	}
}

func (ptr *QHelpFilterSettingsWidget) CloseEventDefault(event gui.QCloseEvent_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_CloseEventDefault(ptr.Pointer(), gui.PointerFromQCloseEvent(event))
	}
}

//export callbackQHelpFilterSettingsWidget_ContextMenuEvent
func callbackQHelpFilterSettingsWidget_ContextMenuEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "contextMenuEvent"); signal != nil {
		(*(*func(*gui.QContextMenuEvent))(signal))(gui.NewQContextMenuEventFromPointer(event))
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).ContextMenuEventDefault(gui.NewQContextMenuEventFromPointer(event))
	}
}

func (ptr *QHelpFilterSettingsWidget) ContextMenuEventDefault(event gui.QContextMenuEvent_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_ContextMenuEventDefault(ptr.Pointer(), gui.PointerFromQContextMenuEvent(event))
	}
}

//export callbackQHelpFilterSettingsWidget_CustomContextMenuRequested
func callbackQHelpFilterSettingsWidget_CustomContextMenuRequested(ptr unsafe.Pointer, pos unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "customContextMenuRequested"); signal != nil {
		(*(*func(*core.QPoint))(signal))(core.NewQPointFromPointer(pos))
	}
...
//export callbackQHelpFilterSettingsWidget_DragEnterEvent
func callbackQHelpFilterSettingsWidget_DragEnterEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "dragEnterEvent"); signal != nil {
		(*(*func(*gui.QDragEnterEvent))(signal))(gui.NewQDragEnterEventFromPointer(event))
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).DragEnterEventDefault(gui.NewQDragEnterEventFromPointer(event))
	}
}

func (ptr *QHelpFilterSettingsWidget) DragEnterEventDefault(event gui.QDragEnterEvent_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_DragEnterEventDefault(ptr.Pointer(), gui.PointerFromQDragEnterEvent(event))
	}
}

//export callbackQHelpFilterSettingsWidget_DragLeaveEvent
func callbackQHelpFilterSettingsWidget_DragLeaveEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "dragLeaveEvent"); signal != nil {
		(*(*func(*gui.QDragLeaveEvent))(signal))(gui.NewQDragLeaveEventFromPointer(event))
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).DragLeaveEventDefault(gui.NewQDragLeaveEventFromPointer(event))
	}
}

func (ptr *QHelpFilterSettingsWidget) DragLeaveEventDefault(event gui.QDragLeaveEvent_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_DragLeaveEventDefault(ptr.Pointer(), gui.PointerFromQDragLeaveEvent(event))
	}
}

//export callbackQHelpFilterSettingsWidget_DragMoveEvent
func callbackQHelpFilterSettingsWidget_DragMoveEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "dragMoveEvent"); signal != nil {
		(*(*func(*gui.QDragMoveEvent))(signal))(gui.NewQDragMoveEventFromPointer(event))
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).DragMoveEventDefault(gui.NewQDragMoveEventFromPointer(event))
	}
}

func (ptr *QHelpFilterSettingsWidget) DragMoveEventDefault(event gui.QDragMoveEvent_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_DragMoveEventDefault(ptr.Pointer(), gui.PointerFromQDragMoveEvent(event))
	}
}

//export callbackQHelpFilterSettingsWidget_DropEvent
func callbackQHelpFilterSettingsWidget_DropEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "dropEvent"); signal != nil {
		(*(*func(*gui.QDropEvent))(signal))(gui.NewQDropEventFromPointer(event))
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).DropEventDefault(gui.NewQDropEventFromPointer(event))
	}
}

func (ptr *QHelpFilterSettingsWidget) DropEventDefault(event gui.QDropEvent_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_DropEventDefault(ptr.Pointer(), gui.PointerFromQDropEvent(event))
	}
}

//export callbackQHelpFilterSettingsWidget_EnterEvent
func callbackQHelpFilterSettingsWidget_EnterEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "enterEvent"); signal != nil {
		(*(*func(*core.QEvent))(signal))(core.NewQEventFromPointer(event))
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).EnterEventDefault(core.NewQEventFromPointer(event))
	}
}

func (ptr *QHelpFilterSettingsWidget) EnterEventDefault(event core.QEvent_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_EnterEventDefault(ptr.Pointer(), core.PointerFromQEvent(event))
	}
}

//export callbackQHelpFilterSettingsWidget_Event
func callbackQHelpFilterSettingsWidget_Event(ptr unsafe.Pointer, event unsafe.Pointer) C.char {
	if signal := qt.GetSignal(ptr, "event"); signal != nil {
		return C.char(int8(qt.GoBoolToInt((*(*func(*core.QEvent) bool)(signal))(core.NewQEventFromPointer(event)))))
	}

	return C.char(int8(qt.GoBoolToInt(NewQHelpFilterSettingsWidgetFromPointer(ptr).EventDefault(core.NewQEventFromPointer(event)))))
}

func (ptr *QHelpFilterSettingsWidget) EventDefault(event core.QEvent_ITF) bool {
	if ptr.Pointer() != nil {
		return int8(C.QHelpFilterSettingsWidget_EventDefault(ptr.Pointer(), core.PointerFromQEvent(event))) != 0
	}
	return false
}

//export callbackQHelpFilterSettingsWidget_FocusInEvent
func callbackQHelpFilterSettingsWidget_FocusInEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "focusInEvent"); signal != nil {
		(*(*func(*gui.QFocusEvent))(signal))(gui.NewQFocusEventFromPointer(event))
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).FocusInEventDefault(gui.NewQFocusEventFromPointer(event))
	}
}

func (ptr *QHelpFilterSettingsWidget) FocusInEventDefault(event gui.QFocusEvent_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_FocusInEventDefault(ptr.Pointer(), gui.PointerFromQFocusEvent(event))
	}
}

//export callbackQHelpFilterSettingsWidget_FocusNextPrevChild
func callbackQHelpFilterSettingsWidget_FocusNextPrevChild(ptr unsafe.Pointer, next C.char) C.char {
	if signal := qt.GetSignal(ptr, "focusNextPrevChild"); signal != nil {
		return C.char(int8(qt.GoBoolToInt((*(*func(bool) bool)(signal))(int8(next) != 0))))
	}

	return C.char(int8(qt.GoBoolToInt(NewQHelpFilterSettingsWidgetFromPointer(ptr).FocusNextPrevChildDefault(int8(next) != 0))))
}

func (ptr *QHelpFilterSettingsWidget) FocusNextPrevChildDefault(next bool) bool {
	if ptr.Pointer() != nil {
		return int8(C.QHelpFilterSettingsWidget_FocusNextPrevChildDefault(ptr.Pointer(), C.char(int8(qt.GoBoolToInt(next))))) != 0
	}
	return false
}

//export callbackQHelpFilterSettingsWidget_FocusOutEvent
func callbackQHelpFilterSettingsWidget_FocusOutEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "focusOutEvent"); signal != nil {
		(*(*func(*gui.QFocusEvent))(signal))(gui.NewQFocusEventFromPointer(event))
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).FocusOutEventDefault(gui.NewQFocusEventFromPointer(event))
	}
}

func (ptr *QHelpFilterSettingsWidget) FocusOutEventDefault(event gui.QFocusEvent_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_FocusOutEventDefault(ptr.Pointer(), gui.PointerFromQFocusEvent(event))
	}
}

//export callbackQHelpFilterSettingsWidget_HasHeightForWidth
func callbackQHelpFilterSettingsWidget_HasHeightForWidth(ptr unsafe.Pointer) C.char {
	if signal := qt.GetSignal(ptr, "hasHeightForWidth"); signal != nil {
		return C.char(int8(qt.GoBoolToInt((*(*func() bool)(signal))())))
	}

	return C.char(int8(qt.GoBoolToInt(NewQHelpFilterSettingsWidgetFromPointer(ptr).HasHeightForWidthDefault())))
}

func (ptr *QHelpFilterSettingsWidget) HasHeightForWidthDefault() bool {
	if ptr.Pointer() != nil {
		return int8(C.QHelpFilterSettingsWidget_HasHeightForWidthDefault(ptr.Pointer())) != 0
	}
	return false
}

//export callbackQHelpFilterSettingsWidget_HeightForWidth
func callbackQHelpFilterSettingsWidget_HeightForWidth(ptr unsafe.Pointer, w C.int) C.int {
	if signal := qt.GetSignal(ptr, "heightForWidth"); signal != nil {
		return C.int(int32((*(*func(int) int)(signal))(int(int32(w)))))
	}

	return C.int(int32(NewQHelpFilterSettingsWidgetFromPointer(ptr).HeightForWidthDefault(int(int32(w)))))
}

func (ptr *QHelpFilterSettingsWidget) HeightForWidthDefault(w int) int {
	if ptr.Pointer() != nil {
		return int(int32(C.QHelpFilterSettingsWidget_HeightForWidthDefault(ptr.Pointer(), C.int(int32(w)))))
	}
	return 0
}

//export callbackQHelpFilterSettingsWidget_Hide
func callbackQHelpFilterSettingsWidget_Hide(ptr unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "hide"); signal != nil {
		(*(*func())(signal))()
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).HideDefault()
	}
}

func (ptr *QHelpFilterSettingsWidget) HideDefault() {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_HideDefault(ptr.Pointer())
	}
}

//export callbackQHelpFilterSettingsWidget_HideEvent
func callbackQHelpFilterSettingsWidget_HideEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "hideEvent"); signal != nil {
		(*(*func(*gui.QHideEvent))(signal))(gui.NewQHideEventFromPointer(event))
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).HideEventDefault(gui.NewQHideEventFromPointer(event))
	}
}

func (ptr *QHelpFilterSettingsWidget) HideEventDefault(event gui.QHideEvent_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_HideEventDefault(ptr.Pointer(), gui.PointerFromQHideEvent(event))
	}
}

//export callbackQHelpFilterSettingsWidget_InitPainter
func callbackQHelpFilterSettingsWidget_InitPainter(ptr unsafe.Pointer, painter unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "initPainter"); signal != nil {
		(*(*func(*gui.QPainter))(signal))(gui.NewQPainterFromPointer(painter))
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).InitPainterDefault(gui.NewQPainterFromPointer(painter))
	}
}

func (ptr *QHelpFilterSettingsWidget) InitPainterDefault(painter gui.QPainter_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_InitPainterDefault(ptr.Pointer(), gui.PointerFromQPainter(painter))
	}
}

//export callbackQHelpFilterSettingsWidget_InputMethodEvent
func callbackQHelpFilterSettingsWidget_InputMethodEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "inputMethodEvent"); signal != nil {
		(*(*func(*gui.QInputMethodEvent))(signal))(gui.NewQInputMethodEventFromPointer(event))
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).InputMethodEventDefault(gui.NewQInputMethodEventFromPointer(event))
	}
}

func (ptr *QHelpFilterSettingsWidget) InputMethodEventDefault(event gui.QInputMethodEvent_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_InputMethodEventDefault(ptr.Pointer(), gui.PointerFromQInputMethodEvent(event))
	}
}

//export callbackQHelpFilterSettingsWidget_InputMethodQuery
func callbackQHelpFilterSettingsWidget_InputMethodQuery(ptr unsafe.Pointer, query C.longlong) unsafe.Pointer {
	if signal := qt.GetSignal(ptr, "inputMethodQuery"); signal != nil {
		return core.PointerFromQVariant((*(*func(core.Qt__InputMethodQuery) *core.QVariant)(signal))(core.Qt__InputMethodQuery(query)))
	}

	return core.PointerFromQVariant(NewQHelpFilterSettingsWidgetFromPointer(ptr).InputMethodQueryDefault(core.Qt__InputMethodQuery(query)))
}

func (ptr *QHelpFilterSettingsWidget) InputMethodQueryDefault(query core.Qt__InputMethodQuery) *core.QVariant {
	if ptr.Pointer() != nil {
		tmpValue := core.NewQVariantFromPointer(C.QHelpFilterSettingsWidget_InputMethodQueryDefault(ptr.Pointer(), C.longlong(query)))
		qt.SetFinalizer(tmpValue, (*core.QVariant).DestroyQVariant)
		return tmpValue
	}
	return nil
...
//export callbackQHelpFilterSettingsWidget_KeyPressEvent
func callbackQHelpFilterSettingsWidget_KeyPressEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "keyPressEvent"); signal != nil {
		(*(*func(*gui.QKeyEvent))(signal))(gui.NewQKeyEventFromPointer(event))
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).KeyPressEventDefault(gui.NewQKeyEventFromPointer(event))
	}
}

func (ptr *QHelpFilterSettingsWidget) KeyPressEventDefault(event gui.QKeyEvent_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_KeyPressEventDefault(ptr.Pointer(), gui.PointerFromQKeyEvent(event))
	}
}

//export callbackQHelpFilterSettingsWidget_KeyReleaseEvent
func callbackQHelpFilterSettingsWidget_KeyReleaseEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "keyReleaseEvent"); signal != nil {
		(*(*func(*gui.QKeyEvent))(signal))(gui.NewQKeyEventFromPointer(event))
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).KeyReleaseEventDefault(gui.NewQKeyEventFromPointer(event))
	}
}

func (ptr *QHelpFilterSettingsWidget) KeyReleaseEventDefault(event gui.QKeyEvent_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_KeyReleaseEventDefault(ptr.Pointer(), gui.PointerFromQKeyEvent(event))
	}
}

//export callbackQHelpFilterSettingsWidget_LeaveEvent
func callbackQHelpFilterSettingsWidget_LeaveEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "leaveEvent"); signal != nil {
		(*(*func(*core.QEvent))(signal))(core.NewQEventFromPointer(event))
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).LeaveEventDefault(core.NewQEventFromPointer(event))
	}
}

func (ptr *QHelpFilterSettingsWidget) LeaveEventDefault(event core.QEvent_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_LeaveEventDefault(ptr.Pointer(), core.PointerFromQEvent(event))
	}
}

//export callbackQHelpFilterSettingsWidget_Lower
func callbackQHelpFilterSettingsWidget_Lower(ptr unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "lower"); signal != nil {
		(*(*func())(signal))()
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).LowerDefault()
	}
}

func (ptr *QHelpFilterSettingsWidget) LowerDefault() {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_LowerDefault(ptr.Pointer())
	}
}

//export callbackQHelpFilterSettingsWidget_Metric
func callbackQHelpFilterSettingsWidget_Metric(ptr unsafe.Pointer, m C.longlong) C.int {
	if signal := qt.GetSignal(ptr, "metric"); signal != nil {
		return C.int(int32((*(*func(gui.QPaintDevice__PaintDeviceMetric) int)(signal))(gui.QPaintDevice__PaintDeviceMetric(m))))
	}

	return C.int(int32(NewQHelpFilterSettingsWidgetFromPointer(ptr).MetricDefault(gui.QPaintDevice__PaintDeviceMetric(m))))
}

func (ptr *QHelpFilterSettingsWidget) MetricDefault(m gui.QPaintDevice__PaintDeviceMetric) int {
	if ptr.Pointer() != nil {
		return int(int32(C.QHelpFilterSettingsWidget_MetricDefault(ptr.Pointer(), C.longlong(m))))
	}
	return 0
}

//export callbackQHelpFilterSettingsWidget_MinimumSizeHint
func callbackQHelpFilterSettingsWidget_MinimumSizeHint(ptr unsafe.Pointer) unsafe.Pointer {
	if signal := qt.GetSignal(ptr, "minimumSizeHint"); signal != nil {
		return core.PointerFromQSize((*(*func() *core.QSize)(signal))())
	}

	return core.PointerFromQSize(NewQHelpFilterSettingsWidgetFromPointer(ptr).MinimumSizeHintDefault())
}

func (ptr *QHelpFilterSettingsWidget) MinimumSizeHintDefault() *core.QSize {
	if ptr.Pointer() != nil {
		tmpValue := core.NewQSizeFromPointer(C.QHelpFilterSettingsWidget_MinimumSizeHintDefault(ptr.Pointer()))
		qt.SetFinalizer(tmpValue, (*core.QSize).DestroyQSize)
		return tmpValue
	}
	return nil
...
//export callbackQHelpFilterSettingsWidget_MouseDoubleClickEvent
func callbackQHelpFilterSettingsWidget_MouseDoubleClickEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "mouseDoubleClickEvent"); signal != nil {
		(*(*func(*gui.QMouseEvent))(signal))(gui.NewQMouseEventFromPointer(event))
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).MouseDoubleClickEventDefault(gui.NewQMouseEventFromPointer(event))
	}
}

func (ptr *QHelpFilterSettingsWidget) MouseDoubleClickEventDefault(event gui.QMouseEvent_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_MouseDoubleClickEventDefault(ptr.Pointer(), gui.PointerFromQMouseEvent(event))
	}
}

//export callbackQHelpFilterSettingsWidget_MouseMoveEvent
func callbackQHelpFilterSettingsWidget_MouseMoveEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "mouseMoveEvent"); signal != nil {
		(*(*func(*gui.QMouseEvent))(signal))(gui.NewQMouseEventFromPointer(event))
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).MouseMoveEventDefault(gui.NewQMouseEventFromPointer(event))
	}
}

func (ptr *QHelpFilterSettingsWidget) MouseMoveEventDefault(event gui.QMouseEvent_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_MouseMoveEventDefault(ptr.Pointer(), gui.PointerFromQMouseEvent(event))
	}
}

//export callbackQHelpFilterSettingsWidget_MousePressEvent
func callbackQHelpFilterSettingsWidget_MousePressEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "mousePressEvent"); signal != nil {
		(*(*func(*gui.QMouseEvent))(signal))(gui.NewQMouseEventFromPointer(event))
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).MousePressEventDefault(gui.NewQMouseEventFromPointer(event))
	}
}

func (ptr *QHelpFilterSettingsWidget) MousePressEventDefault(event gui.QMouseEvent_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_MousePressEventDefault(ptr.Pointer(), gui.PointerFromQMouseEvent(event))
	}
}

//export callbackQHelpFilterSettingsWidget_MouseReleaseEvent
func callbackQHelpFilterSettingsWidget_MouseReleaseEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "mouseReleaseEvent"); signal != nil {
		(*(*func(*gui.QMouseEvent))(signal))(gui.NewQMouseEventFromPointer(event))
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).MouseReleaseEventDefault(gui.NewQMouseEventFromPointer(event))
	}
}

func (ptr *QHelpFilterSettingsWidget) MouseReleaseEventDefault(event gui.QMouseEvent_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_MouseReleaseEventDefault(ptr.Pointer(), gui.PointerFromQMouseEvent(event))
	}
}

//export callbackQHelpFilterSettingsWidget_MoveEvent
func callbackQHelpFilterSettingsWidget_MoveEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "moveEvent"); signal != nil {
		(*(*func(*gui.QMoveEvent))(signal))(gui.NewQMoveEventFromPointer(event))
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).MoveEventDefault(gui.NewQMoveEventFromPointer(event))
	}
}

func (ptr *QHelpFilterSettingsWidget) MoveEventDefault(event gui.QMoveEvent_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_MoveEventDefault(ptr.Pointer(), gui.PointerFromQMoveEvent(event))
	}
}

//export callbackQHelpFilterSettingsWidget_NativeEvent
func callbackQHelpFilterSettingsWidget_NativeEvent(ptr unsafe.Pointer, eventType unsafe.Pointer, message unsafe.Pointer, result *C.long) C.char {
	var resultR int
	if result != nil {
		resultR = int(int32(*result))
		defer func() { *result = C.long(int32(resultR)) }()
	...
	return C.char(int8(qt.GoBoolToInt(NewQHelpFilterSettingsWidgetFromPointer(ptr).NativeEventDefault(core.NewQByteArrayFromPointer(eventType), message, &resultR))))
}

func (ptr *QHelpFilterSettingsWidget) NativeEventDefault(eventType core.QByteArray_ITF, message unsafe.Pointer, result *int) bool {
	if ptr.Pointer() != nil {
		var resultC C.long
		if result != nil {
			resultC = C.long(int32(*result))
		...
		return int8(C.QHelpFilterSettingsWidget_NativeEventDefault(ptr.Pointer(), core.PointerFromQByteArray(eventType), message, &resultC)) != 0
	}
	return false
}

//export callbackQHelpFilterSettingsWidget_PaintEngine
func callbackQHelpFilterSettingsWidget_PaintEngine(ptr unsafe.Pointer) unsafe.Pointer {
	if signal := qt.GetSignal(ptr, "paintEngine"); signal != nil {
		return gui.PointerFromQPaintEngine((*(*func() *gui.QPaintEngine)(signal))())
	}

	return gui.PointerFromQPaintEngine(NewQHelpFilterSettingsWidgetFromPointer(ptr).PaintEngineDefault())
}

func (ptr *QHelpFilterSettingsWidget) PaintEngineDefault() *gui.QPaintEngine {
	if ptr.Pointer() != nil {
		return gui.NewQPaintEngineFromPointer(C.QHelpFilterSettingsWidget_PaintEngineDefault(ptr.Pointer()))
	}
	return nil
}

//export callbackQHelpFilterSettingsWidget_PaintEvent
func callbackQHelpFilterSettingsWidget_PaintEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "paintEvent"); signal != nil {
		(*(*func(*gui.QPaintEvent))(signal))(gui.NewQPaintEventFromPointer(event))
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).PaintEventDefault(gui.NewQPaintEventFromPointer(event))
	}
}

func (ptr *QHelpFilterSettingsWidget) PaintEventDefault(event gui.QPaintEvent_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_PaintEventDefault(ptr.Pointer(), gui.PointerFromQPaintEvent(event))
	}
}

//export callbackQHelpFilterSettingsWidget_Raise
func callbackQHelpFilterSettingsWidget_Raise(ptr unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "raise"); signal != nil {
		(*(*func())(signal))()
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).RaiseDefault()
	}
}

func (ptr *QHelpFilterSettingsWidget) RaiseDefault() {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_RaiseDefault(ptr.Pointer())
	}
}

//export callbackQHelpFilterSettingsWidget_Repaint
func callbackQHelpFilterSettingsWidget_Repaint(ptr unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "repaint"); signal != nil {
		(*(*func())(signal))()
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).RepaintDefault()
	}
}

func (ptr *QHelpFilterSettingsWidget) RepaintDefault() {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_RepaintDefault(ptr.Pointer())
	}
}

//export callbackQHelpFilterSettingsWidget_ResizeEvent
func callbackQHelpFilterSettingsWidget_ResizeEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "resizeEvent"); signal != nil {
		(*(*func(*gui.QResizeEvent))(signal))(gui.NewQResizeEventFromPointer(event))
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).ResizeEventDefault(gui.NewQResizeEventFromPointer(event))
	}
}

func (ptr *QHelpFilterSettingsWidget) ResizeEventDefault(event gui.QResizeEvent_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_ResizeEventDefault(ptr.Pointer(), gui.PointerFromQResizeEvent(event))
	}
}

//export callbackQHelpFilterSettingsWidget_SetDisabled
func callbackQHelpFilterSettingsWidget_SetDisabled(ptr unsafe.Pointer, disable C.char) {
	if signal := qt.GetSignal(ptr, "setDisabled"); signal != nil {
		(*(*func(bool))(signal))(int8(disable) != 0)
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).SetDisabledDefault(int8(disable) != 0)
	}
}

func (ptr *QHelpFilterSettingsWidget) SetDisabledDefault(disable bool) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_SetDisabledDefault(ptr.Pointer(), C.char(int8(qt.GoBoolToInt(disable))))
	}
}

//export callbackQHelpFilterSettingsWidget_SetEnabled
func callbackQHelpFilterSettingsWidget_SetEnabled(ptr unsafe.Pointer, vbo C.char) {
	if signal := qt.GetSignal(ptr, "setEnabled"); signal != nil {
		(*(*func(bool))(signal))(int8(vbo) != 0)
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).SetEnabledDefault(int8(vbo) != 0)
	}
}

func (ptr *QHelpFilterSettingsWidget) SetEnabledDefault(vbo bool) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_SetEnabledDefault(ptr.Pointer(), C.char(int8(qt.GoBoolToInt(vbo))))
	}
}

//export callbackQHelpFilterSettingsWidget_SetFocus2
func callbackQHelpFilterSettingsWidget_SetFocus2(ptr unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "setFocus2"); signal != nil {
		(*(*func())(signal))()
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).SetFocus2Default()
	}
}

func (ptr *QHelpFilterSettingsWidget) SetFocus2Default() {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_SetFocus2Default(ptr.Pointer())
	}
}

//export callbackQHelpFilterSettingsWidget_SetHidden
func callbackQHelpFilterSettingsWidget_SetHidden(ptr unsafe.Pointer, hidden C.char) {
	if signal := qt.GetSignal(ptr, "setHidden"); signal != nil {
		(*(*func(bool))(signal))(int8(hidden) != 0)
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).SetHiddenDefault(int8(hidden) != 0)
	}
}

func (ptr *QHelpFilterSettingsWidget) SetHiddenDefault(hidden bool) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_SetHiddenDefault(ptr.Pointer(), C.char(int8(qt.GoBoolToInt(hidden))))
	}
}

//export callbackQHelpFilterSettingsWidget_SetStyleSheet
func callbackQHelpFilterSettingsWidget_SetStyleSheet(ptr unsafe.Pointer, styleSheet C.struct_QtHelp_PackedString) {
	if signal := qt.GetSignal(ptr, "setStyleSheet"); signal != nil {
		(*(*func(string))(signal))(cGoUnpackString(styleSheet))
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).SetStyleSheetDefault(cGoUnpackString(styleSheet))
	}
}

func (ptr *QHelpFilterSettingsWidget) SetStyleSheetDefault(styleSheet string) {
	if ptr.Pointer() != nil {
		var styleSheetC *C.char
		if styleSheet != "" {
			styleSheetC = C.CString(styleSheet)
		...
		C.QHelpFilterSettingsWidget_SetStyleSheetDefault(ptr.Pointer(), C.struct_QtHelp_PackedString{data: styleSheetC, len: C.longlong(len(styleSheet))})
	}
}

//export callbackQHelpFilterSettingsWidget_SetVisible
func callbackQHelpFilterSettingsWidget_SetVisible(ptr unsafe.Pointer, visible C.char) {
	if signal := qt.GetSignal(ptr, "setVisible"); signal != nil {
		(*(*func(bool))(signal))(int8(visible) != 0)
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).SetVisibleDefault(int8(visible) != 0)
	}
}

func (ptr *QHelpFilterSettingsWidget) SetVisibleDefault(visible bool) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_SetVisibleDefault(ptr.Pointer(), C.char(int8(qt.GoBoolToInt(visible))))
	}
}

//export callbackQHelpFilterSettingsWidget_SetWindowModified
func callbackQHelpFilterSettingsWidget_SetWindowModified(ptr unsafe.Pointer, vbo C.char) {
	if signal := qt.GetSignal(ptr, "setWindowModified"); signal != nil {
		(*(*func(bool))(signal))(int8(vbo) != 0)
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).SetWindowModifiedDefault(int8(vbo) != 0)
	}
}

func (ptr *QHelpFilterSettingsWidget) SetWindowModifiedDefault(vbo bool) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_SetWindowModifiedDefault(ptr.Pointer(), C.char(int8(qt.GoBoolToInt(vbo))))
	}
}

//export callbackQHelpFilterSettingsWidget_SetWindowTitle
func callbackQHelpFilterSettingsWidget_SetWindowTitle(ptr unsafe.Pointer, vqs C.struct_QtHelp_PackedString) {
	if signal := qt.GetSignal(ptr, "setWindowTitle"); signal != nil {
		(*(*func(string))(signal))(cGoUnpackString(vqs))
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).SetWindowTitleDefault(cGoUnpackString(vqs))
	}
}

func (ptr *QHelpFilterSettingsWidget) SetWindowTitleDefault(vqs string) {
	if ptr.Pointer() != nil {
		var vqsC *C.char
		if vqs != "" {
			vqsC = C.CString(vqs)
		...
		C.QHelpFilterSettingsWidget_SetWindowTitleDefault(ptr.Pointer(), C.struct_QtHelp_PackedString{data: vqsC, len: C.longlong(len(vqs))})
	}
}

//export callbackQHelpFilterSettingsWidget_Show
func callbackQHelpFilterSettingsWidget_Show(ptr unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "show"); signal != nil {
		(*(*func())(signal))()
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).ShowDefault()
	}
}

func (ptr *QHelpFilterSettingsWidget) ShowDefault() {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_ShowDefault(ptr.Pointer())
	}
}

//export callbackQHelpFilterSettingsWidget_ShowEvent
func callbackQHelpFilterSettingsWidget_ShowEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "showEvent"); signal != nil {
		(*(*func(*gui.QShowEvent))(signal))(gui.NewQShowEventFromPointer(event))
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).ShowEventDefault(gui.NewQShowEventFromPointer(event))
	}
}

func (ptr *QHelpFilterSettingsWidget) ShowEventDefault(event gui.QShowEvent_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_ShowEventDefault(ptr.Pointer(), gui.PointerFromQShowEvent(event))
	}
}

//export callbackQHelpFilterSettingsWidget_ShowFullScreen
func callbackQHelpFilterSettingsWidget_ShowFullScreen(ptr unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "showFullScreen"); signal != nil {
		(*(*func())(signal))()
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).ShowFullScreenDefault()
	}
}

func (ptr *QHelpFilterSettingsWidget) ShowFullScreenDefault() {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_ShowFullScreenDefault(ptr.Pointer())
	}
}

//export callbackQHelpFilterSettingsWidget_ShowMaximized
func callbackQHelpFilterSettingsWidget_ShowMaximized(ptr unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "showMaximized"); signal != nil {
		(*(*func())(signal))()
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).ShowMaximizedDefault()
	}
}

func (ptr *QHelpFilterSettingsWidget) ShowMaximizedDefault() {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_ShowMaximizedDefault(ptr.Pointer())
	}
}

//export callbackQHelpFilterSettingsWidget_ShowMinimized
func callbackQHelpFilterSettingsWidget_ShowMinimized(ptr unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "showMinimized"); signal != nil {
		(*(*func())(signal))()
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).ShowMinimizedDefault()
	}
}

func (ptr *QHelpFilterSettingsWidget) ShowMinimizedDefault() {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_ShowMinimizedDefault(ptr.Pointer())
	}
}

//export callbackQHelpFilterSettingsWidget_ShowNormal
func callbackQHelpFilterSettingsWidget_ShowNormal(ptr unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "showNormal"); signal != nil {
		(*(*func())(signal))()
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).ShowNormalDefault()
	}
}

func (ptr *QHelpFilterSettingsWidget) ShowNormalDefault() {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_ShowNormalDefault(ptr.Pointer())
	}
}

//export callbackQHelpFilterSettingsWidget_SizeHint
func callbackQHelpFilterSettingsWidget_SizeHint(ptr unsafe.Pointer) unsafe.Pointer {
	if signal := qt.GetSignal(ptr, "sizeHint"); signal != nil {
		return core.PointerFromQSize((*(*func() *core.QSize)(signal))())
	}

	return core.PointerFromQSize(NewQHelpFilterSettingsWidgetFromPointer(ptr).SizeHintDefault())
}

func (ptr *QHelpFilterSettingsWidget) SizeHintDefault() *core.QSize {
	if ptr.Pointer() != nil {
		tmpValue := core.NewQSizeFromPointer(C.QHelpFilterSettingsWidget_SizeHintDefault(ptr.Pointer()))
		qt.SetFinalizer(tmpValue, (*core.QSize).DestroyQSize)
		return tmpValue
	}
	return nil
...
//export callbackQHelpFilterSettingsWidget_TabletEvent
func callbackQHelpFilterSettingsWidget_TabletEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "tabletEvent"); signal != nil {
		(*(*func(*gui.QTabletEvent))(signal))(gui.NewQTabletEventFromPointer(event))
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).TabletEventDefault(gui.NewQTabletEventFromPointer(event))
	}
}

func (ptr *QHelpFilterSettingsWidget) TabletEventDefault(event gui.QTabletEvent_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_TabletEventDefault(ptr.Pointer(), gui.PointerFromQTabletEvent(event))
	}
}

//export callbackQHelpFilterSettingsWidget_Update
func callbackQHelpFilterSettingsWidget_Update(ptr unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "update"); signal != nil {
		(*(*func())(signal))()
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).UpdateDefault()
	}
}

func (ptr *QHelpFilterSettingsWidget) UpdateDefault() {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_UpdateDefault(ptr.Pointer())
	}
}

//export callbackQHelpFilterSettingsWidget_UpdateMicroFocus
func callbackQHelpFilterSettingsWidget_UpdateMicroFocus(ptr unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "updateMicroFocus"); signal != nil {
		(*(*func())(signal))()
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).UpdateMicroFocusDefault()
	}
}

func (ptr *QHelpFilterSettingsWidget) UpdateMicroFocusDefault() {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_UpdateMicroFocusDefault(ptr.Pointer())
	}
}

//export callbackQHelpFilterSettingsWidget_WheelEvent
func callbackQHelpFilterSettingsWidget_WheelEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "wheelEvent"); signal != nil {
		(*(*func(*gui.QWheelEvent))(signal))(gui.NewQWheelEventFromPointer(event))
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).WheelEventDefault(gui.NewQWheelEventFromPointer(event))
	}
}

func (ptr *QHelpFilterSettingsWidget) WheelEventDefault(event gui.QWheelEvent_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_WheelEventDefault(ptr.Pointer(), gui.PointerFromQWheelEvent(event))
	}
}

//export callbackQHelpFilterSettingsWidget_WindowIconChanged
func callbackQHelpFilterSettingsWidget_WindowIconChanged(ptr unsafe.Pointer, icon unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "windowIconChanged"); signal != nil {
		(*(*func(*gui.QIcon))(signal))(gui.NewQIconFromPointer(icon))
	}
...
//export callbackQHelpFilterSettingsWidget_WindowTitleChanged
func callbackQHelpFilterSettingsWidget_WindowTitleChanged(ptr unsafe.Pointer, title C.struct_QtHelp_PackedString) {
	if signal := qt.GetSignal(ptr, "windowTitleChanged"); signal != nil {
		(*(*func(string))(signal))(cGoUnpackString(title))
	}
...
//export callbackQHelpFilterSettingsWidget_ChildEvent
func callbackQHelpFilterSettingsWidget_ChildEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "childEvent"); signal != nil {
		(*(*func(*core.QChildEvent))(signal))(core.NewQChildEventFromPointer(event))
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).ChildEventDefault(core.NewQChildEventFromPointer(event))
	}
}

func (ptr *QHelpFilterSettingsWidget) ChildEventDefault(event core.QChildEvent_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_ChildEventDefault(ptr.Pointer(), core.PointerFromQChildEvent(event))
	}
}

//export callbackQHelpFilterSettingsWidget_ConnectNotify
func callbackQHelpFilterSettingsWidget_ConnectNotify(ptr unsafe.Pointer, sign unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "connectNotify"); signal != nil {
		(*(*func(*core.QMetaMethod))(signal))(core.NewQMetaMethodFromPointer(sign))
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).ConnectNotifyDefault(core.NewQMetaMethodFromPointer(sign))
	}
}

func (ptr *QHelpFilterSettingsWidget) ConnectNotifyDefault(sign core.QMetaMethod_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_ConnectNotifyDefault(ptr.Pointer(), core.PointerFromQMetaMethod(sign))
	}
}

//export callbackQHelpFilterSettingsWidget_CustomEvent
func callbackQHelpFilterSettingsWidget_CustomEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "customEvent"); signal != nil {
		(*(*func(*core.QEvent))(signal))(core.NewQEventFromPointer(event))
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).CustomEventDefault(core.NewQEventFromPointer(event))
	}
}

func (ptr *QHelpFilterSettingsWidget) CustomEventDefault(event core.QEvent_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_CustomEventDefault(ptr.Pointer(), core.PointerFromQEvent(event))
	}
}

//export callbackQHelpFilterSettingsWidget_DeleteLater
func callbackQHelpFilterSettingsWidget_DeleteLater(ptr unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "deleteLater"); signal != nil {
		(*(*func())(signal))()
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).DeleteLaterDefault()
	}
}

func (ptr *QHelpFilterSettingsWidget) DeleteLaterDefault() {
	if ptr.Pointer() != nil {

		qt.SetFinalizer(ptr, nil)
		C.QHelpFilterSettingsWidget_DeleteLaterDefault(ptr.Pointer())
	}
}

//export callbackQHelpFilterSettingsWidget_Destroyed
func callbackQHelpFilterSettingsWidget_Destroyed(ptr unsafe.Pointer, obj unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "destroyed"); signal != nil {
		(*(*func(*core.QObject))(signal))(core.NewQObjectFromPointer(obj))
	}
...
//export callbackQHelpFilterSettingsWidget_DisconnectNotify
func callbackQHelpFilterSettingsWidget_DisconnectNotify(ptr unsafe.Pointer, sign unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "disconnectNotify"); signal != nil {
		(*(*func(*core.QMetaMethod))(signal))(core.NewQMetaMethodFromPointer(sign))
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).DisconnectNotifyDefault(core.NewQMetaMethodFromPointer(sign))
	}
}

func (ptr *QHelpFilterSettingsWidget) DisconnectNotifyDefault(sign core.QMetaMethod_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_DisconnectNotifyDefault(ptr.Pointer(), core.PointerFromQMetaMethod(sign))
	}
}

//export callbackQHelpFilterSettingsWidget_EventFilter
func callbackQHelpFilterSettingsWidget_EventFilter(ptr unsafe.Pointer, watched unsafe.Pointer, event unsafe.Pointer) C.char {
	if signal := qt.GetSignal(ptr, "eventFilter"); signal != nil {
		return C.char(int8(qt.GoBoolToInt((*(*func(*core.QObject, *core.QEvent) bool)(signal))(core.NewQObjectFromPointer(watched), core.NewQEventFromPointer(event)))))
	}

	return C.char(int8(qt.GoBoolToInt(NewQHelpFilterSettingsWidgetFromPointer(ptr).EventFilterDefault(core.NewQObjectFromPointer(watched), core.NewQEventFromPointer(event)))))
}

func (ptr *QHelpFilterSettingsWidget) EventFilterDefault(watched core.QObject_ITF, event core.QEvent_ITF) bool {
	if ptr.Pointer() != nil {
		return int8(C.QHelpFilterSettingsWidget_EventFilterDefault(ptr.Pointer(), core.PointerFromQObject(watched), core.PointerFromQEvent(event))) != 0
	}
	return false
}

//export callbackQHelpFilterSettingsWidget_MetaObject
func callbackQHelpFilterSettingsWidget_MetaObject(ptr unsafe.Pointer) unsafe.Pointer {
	if signal := qt.GetSignal(ptr, "metaObject"); signal != nil {
		return core.PointerFromQMetaObject((*(*func() *core.QMetaObject)(signal))())
	}

	return core.PointerFromQMetaObject(NewQHelpFilterSettingsWidgetFromPointer(ptr).MetaObjectDefault())
}

func (ptr *QHelpFilterSettingsWidget) MetaObjectDefault() *core.QMetaObject {
	if ptr.Pointer() != nil {
		return core.NewQMetaObjectFromPointer(C.QHelpFilterSettingsWidget_MetaObjectDefault(ptr.Pointer()))
	}
	return nil
}

//export callbackQHelpFilterSettingsWidget_ObjectNameChanged
func callbackQHelpFilterSettingsWidget_ObjectNameChanged(ptr unsafe.Pointer, objectName C.struct_QtHelp_PackedString) {
	if signal := qt.GetSignal(ptr, "objectNameChanged"); signal != nil {
		(*(*func(string))(signal))(cGoUnpackString(objectName))
	}
...
//export callbackQHelpFilterSettingsWidget_TimerEvent
func callbackQHelpFilterSettingsWidget_TimerEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "timerEvent"); signal != nil {
		(*(*func(*core.QTimerEvent))(signal))(core.NewQTimerEventFromPointer(event))
	} else {
		NewQHelpFilterSettingsWidgetFromPointer(ptr).TimerEventDefault(core.NewQTimerEventFromPointer(event))
	}
}

func (ptr *QHelpFilterSettingsWidget) TimerEventDefault(event core.QTimerEvent_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpFilterSettingsWidget_TimerEventDefault(ptr.Pointer(), core.PointerFromQTimerEvent(event))
	}
}
...
func (ptr *QHelpIndexModel) HelpEngine() *QHelpEngineCore {
	if ptr.Pointer() != nil {
		tmpValue := NewQHelpEngineCoreFromPointer(C.QHelpIndexModel_HelpEngine(ptr.Pointer()))
		if !qt.ExistsSignal(tmpValue.Pointer(), "destroyed") {
			tmpValue.ConnectDestroyed(func(*core.QObject) { tmpValue.SetPointer(nil) })
		}
		return tmpValue
...
//export callbackQHelpIndexWidget_DocumentActivated
func callbackQHelpIndexWidget_DocumentActivated(ptr unsafe.Pointer, document unsafe.Pointer, keyword C.struct_QtHelp_PackedString) {
	if signal := qt.GetSignal(ptr, "documentActivated"); signal != nil {
		(*(*func(*QHelpLink, string))(signal))(NewQHelpLinkFromPointer(document), cGoUnpackString(keyword))
	}

}

func (ptr *QHelpIndexWidget) ConnectDocumentActivated(f func(document *QHelpLink, keyword string)) {
	if ptr.Pointer() != nil {

		if !qt.ExistsSignal(ptr.Pointer(), "documentActivated") {
			C.QHelpIndexWidget_ConnectDocumentActivated(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "documentActivated")))
		}

		if signal := qt.LendSignal(ptr.Pointer(), "documentActivated"); signal != nil {
			f := func(document *QHelpLink, keyword string) {
				(*(*func(*QHelpLink, string))(signal))(document, keyword)
				f(document, keyword)
			}
			qt.ConnectSignal(ptr.Pointer(), "documentActivated", unsafe.Pointer(&f))
		} else {
			qt.ConnectSignal(ptr.Pointer(), "documentActivated", unsafe.Pointer(&f))
		}
	}
...
func (ptr *QHelpIndexWidget) DisconnectDocumentActivated() {
	if ptr.Pointer() != nil {
		C.QHelpIndexWidget_DisconnectDocumentActivated(ptr.Pointer())
		qt.DisconnectSignal(ptr.Pointer(), "documentActivated")
	}
}

func (ptr *QHelpIndexWidget) DocumentActivated(document QHelpLink_ITF, keyword string) {
	if ptr.Pointer() != nil {
		var keywordC *C.char
		if keyword != "" {
		...
		C.QHelpIndexWidget_DocumentActivated(ptr.Pointer(), PointerFromQHelpLink(document), C.struct_QtHelp_PackedString{data: keywordC, len: C.longlong(len(keyword))})
	}
}
...
func (ptr *QHelpIndexWidget) __documentsActivated_documents_setList(i QHelpLink_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpIndexWidget___documentsActivated_documents_setList(ptr.Pointer(), PointerFromQHelpLink(i))
	}
}

func (ptr *QHelpIndexWidget) __documentsActivated_documents_newList() unsafe.Pointer {
	return C.QHelpIndexWidget___documentsActivated_documents_newList(ptr.Pointer())
}
...
func callbackQHelpIndexWidget_DropEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "dropEvent"); signal != nil {
		(*(*func(*gui.QDropEvent))(signal))(gui.NewQDropEventFromPointer(event))
	} else {
		NewQHelpIndexWidgetFromPointer(ptr).DropEventDefault(gui.NewQDropEventFromPointer(event))
	}
}

func (ptr *QHelpIndexWidget) DropEventDefault(event gui.QDropEvent_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpIndexWidget_DropEventDefault(ptr.Pointer(), gui.PointerFromQDropEvent(event))
	}
}
...
type QHelpLink struct {
	ptr unsafe.Pointer
}

type QHelpLink_ITF interface {
	QHelpLink_PTR() *QHelpLink
}

func (ptr *QHelpLink) QHelpLink_PTR() *QHelpLink {
	return ptr
}

func (ptr *QHelpLink) Pointer() unsafe.Pointer {
	if ptr != nil {
		return ptr.ptr
	}
	return nil
...
func (ptr *QHelpLink) SetPointer(p unsafe.Pointer) {
	if ptr != nil {
		ptr.ptr = p
	}
}

func PointerFromQHelpLink(ptr QHelpLink_ITF) unsafe.Pointer {
	if ptr != nil {
		return ptr.QHelpLink_PTR().Pointer()
	}
	return nil
}

func NewQHelpLinkFromPointer(ptr unsafe.Pointer) (n *QHelpLink) {
	n = new(QHelpLink)
	n.SetPointer(ptr)
	return
}
func (ptr *QHelpLink) DestroyQHelpLink() {
	if ptr != nil {
		qt.SetFinalizer(ptr, nil)
...
func (ptr *QHelpLink) Title() string {
	if ptr.Pointer() != nil {
		return cGoUnpackString(C.QHelpLink_Title(ptr.Pointer()))
	}
	return ""
}

func (ptr *QHelpLink) SetTitle(vqs string) {
	if ptr.Pointer() != nil {
		var vqsC *C.char
		if vqs != "" {
			vqsC = C.CString(vqs)
		...
		C.QHelpLink_SetTitle(ptr.Pointer(), C.struct_QtHelp_PackedString{data: vqsC, len: C.longlong(len(vqs))})
	}
}

func (ptr *QHelpLink) Url() *core.QUrl {
	if ptr.Pointer() != nil {
		tmpValue := core.NewQUrlFromPointer(C.QHelpLink_Url(ptr.Pointer()))
		qt.SetFinalizer(tmpValue, (*core.QUrl).DestroyQUrl)
		return tmpValue
	}
	return nil
...
func (ptr *QHelpLink) SetUrl(vqu core.QUrl_ITF) {
	if ptr.Pointer() != nil {
		C.QHelpLink_SetUrl(ptr.Pointer(), core.PointerFromQUrl(vqu))
	}
}
...
func init() {
	...
	qt.ItfMap["help.QHelpFilterSettingsWidget_ITF"] = QHelpFilterSettingsWidget{}
	qt.FuncMap["help.NewQHelpFilterSettingsWidget"] = NewQHelpFilterSettingsWidget
	qt.ItfMap["help.QHelpIndexModel_ITF"] = QHelpIndexModel{}
	qt.ItfMap["help.QHelpIndexWidget_ITF"] = QHelpIndexWidget{}
	qt.ItfMap["help.QHelpLink_ITF"] = QHelpLink{}
