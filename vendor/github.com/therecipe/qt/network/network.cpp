...
public:
	...
	void Signal_ErrorOccurred(QAbstractSocket::SocketError socketError) { callbackQAbstractSocket_ErrorOccurred(this, socketError); };
...
void QAbstractSocket_ConnectErrorOccurred(void* ptr, long long t)
{
	...
	QObject::connect(static_cast<QAbstractSocket*>(ptr), static_cast<void (QAbstractSocket::*)(QAbstractSocket::SocketError)>(&QAbstractSocket::errorOccurred), static_cast<MyQAbstractSocket*>(ptr), static_cast<void (MyQAbstractSocket::*)(QAbstractSocket::SocketError)>(&MyQAbstractSocket::Signal_ErrorOccurred), static_cast<Qt::ConnectionType>(t));
}

void QAbstractSocket_DisconnectErrorOccurred(void* ptr)
{
	QObject::disconnect(static_cast<QAbstractSocket*>(ptr), static_cast<void (QAbstractSocket::*)(QAbstractSocket::SocketError)>(&QAbstractSocket::errorOccurred), static_cast<MyQAbstractSocket*>(ptr), static_cast<void (MyQAbstractSocket::*)(QAbstractSocket::SocketError)>(&MyQAbstractSocket::Signal_ErrorOccurred));
}

void QAbstractSocket_ErrorOccurred(void* ptr, long long socketError)
{
	static_cast<QAbstractSocket*>(ptr)->errorOccurred(static_cast<QAbstractSocket::SocketError>(socketError));
}
...
Q_DECLARE_METATYPE(QHttp2Configuration)
Q_DECLARE_METATYPE(QHttp2Configuration*)
...
{
	return new QHttp2Configuration(*static_cast<QHttp2Configuration*>(other));
}
...
{
	return static_cast<QHttp2Configuration*>(ptr)->huffmanCompressionEnabled();
}

unsigned int QHttp2Configuration_MaxFrameSize(void* ptr)
{
	return static_cast<QHttp2Configuration*>(ptr)->maxFrameSize();
}

char QHttp2Configuration_ServerPushEnabled(void* ptr)
{
	return static_cast<QHttp2Configuration*>(ptr)->serverPushEnabled();
}

unsigned int QHttp2Configuration_SessionReceiveWindowSize(void* ptr)
{
	return static_cast<QHttp2Configuration*>(ptr)->sessionReceiveWindowSize();
}

void QHttp2Configuration_SetHuffmanCompressionEnabled(void* ptr, char enable)
{
	static_cast<QHttp2Configuration*>(ptr)->setHuffmanCompressionEnabled(enable != 0);
}

char QHttp2Configuration_SetMaxFrameSize(void* ptr, unsigned int size)
{
	return static_cast<QHttp2Configuration*>(ptr)->setMaxFrameSize(size);
}

void QHttp2Configuration_SetServerPushEnabled(void* ptr, char enable)
{
	static_cast<QHttp2Configuration*>(ptr)->setServerPushEnabled(enable != 0);
}

char QHttp2Configuration_SetSessionReceiveWindowSize(void* ptr, unsigned int size)
{
	return static_cast<QHttp2Configuration*>(ptr)->setSessionReceiveWindowSize(size);
}

char QHttp2Configuration_SetStreamReceiveWindowSize(void* ptr, unsigned int size)
{
	return static_cast<QHttp2Configuration*>(ptr)->setStreamReceiveWindowSize(size);
}

unsigned int QHttp2Configuration_StreamReceiveWindowSize(void* ptr)
{
	return static_cast<QHttp2Configuration*>(ptr)->streamReceiveWindowSize();
}

void QHttp2Configuration_Swap(void* ptr, void* other)
{
	static_cast<QHttp2Configuration*>(ptr)->swap(*static_cast<QHttp2Configuration*>(other));
}

void QHttp2Configuration_DestroyQHttp2Configuration(void* ptr)
{
	static_cast<QHttp2Configuration*>(ptr)->~QHttp2Configuration();
}
...
public:
	...
	void Signal_ErrorOccurred(QLocalSocket::LocalSocketError socketError) { callbackQLocalSocket_ErrorOccurred(this, socketError); };
...
{
	QObject::connect(static_cast<QLocalSocket*>(ptr), static_cast<void (QLocalSocket::*)(QLocalSocket::LocalSocketError)>(&QLocalSocket::errorOccurred), static_cast<MyQLocalSocket*>(ptr), static_cast<void (MyQLocalSocket::*)(QLocalSocket::LocalSocketError)>(&MyQLocalSocket::Signal_ErrorOccurred), static_cast<Qt::ConnectionType>(t));
}

void QLocalSocket_DisconnectErrorOccurred(void* ptr)
{
	QObject::disconnect(static_cast<QLocalSocket*>(ptr), static_cast<void (QLocalSocket::*)(QLocalSocket::LocalSocketError)>(&QLocalSocket::errorOccurred), static_cast<MyQLocalSocket*>(ptr), static_cast<void (MyQLocalSocket::*)(QLocalSocket::LocalSocketError)>(&MyQLocalSocket::Signal_ErrorOccurred));
}

void QLocalSocket_ErrorOccurred(void* ptr, long long socketError)
{
	static_cast<QLocalSocket*>(ptr)->errorOccurred(static_cast<QLocalSocket::LocalSocketError>(socketError));
}
...
{
	return static_cast<QNetworkAccessManager*>(ptr)->autoDeleteReplies();
}
...
{
	static_cast<QNetworkAccessManager*>(ptr)->setAutoDeleteReplies(shouldAutoDelete != 0);
}
...
{
	static_cast<QNetworkAccessManager*>(ptr)->setTransferTimeout(timeout);
}
...
{
	return static_cast<QNetworkAccessManager*>(ptr)->transferTimeout();
}
...
public:
	...
	void Signal_ErrorOccurred(QNetworkReply::NetworkError code) { callbackQNetworkReply_ErrorOccurred(this, code); };
...
void QNetworkReply_ConnectErrorOccurred(void* ptr, long long t)
{
	...
	QObject::connect(static_cast<QNetworkReply*>(ptr), static_cast<void (QNetworkReply::*)(QNetworkReply::NetworkError)>(&QNetworkReply::errorOccurred), static_cast<MyQNetworkReply*>(ptr), static_cast<void (MyQNetworkReply::*)(QNetworkReply::NetworkError)>(&MyQNetworkReply::Signal_ErrorOccurred), static_cast<Qt::ConnectionType>(t));
}

void QNetworkReply_DisconnectErrorOccurred(void* ptr)
{
	QObject::disconnect(static_cast<QNetworkReply*>(ptr), static_cast<void (QNetworkReply::*)(QNetworkReply::NetworkError)>(&QNetworkReply::errorOccurred), static_cast<MyQNetworkReply*>(ptr), static_cast<void (MyQNetworkReply::*)(QNetworkReply::NetworkError)>(&MyQNetworkReply::Signal_ErrorOccurred));
}

void QNetworkReply_ErrorOccurred(void* ptr, long long code)
{
	static_cast<QNetworkReply*>(ptr)->errorOccurred(static_cast<QNetworkReply::NetworkError>(code));
}
...
{
	return QNetworkRequest::EmitAllUploadProgressSignalsAttribute;
}
...
{
	return new QHttp2Configuration(static_cast<QNetworkRequest*>(ptr)->http2Configuration());
}
...
{
	static_cast<QNetworkRequest*>(ptr)->setHttp2Configuration(*static_cast<QHttp2Configuration*>(configuration));
}
...
{
	static_cast<QNetworkRequest*>(ptr)->setTransferTimeout(timeout);
}
...
{
	return static_cast<QNetworkRequest*>(ptr)->transferTimeout();
}
...
{
	return ({ QList<QSslCertificate>* tmpValuee8eaff = new QList<QSslCertificate>(QSslCertificate::fromPath(QString::fromUtf8(path.data, path.len), static_cast<QSsl::EncodingFormat>(format), static_cast<QSslCertificate::PatternSyntax>(syntax))); QtNetwork_PackedList { tmpValuee8eaff, tmpValuee8eaff->size() }; });
}
...
{
	static_cast<QSslConfiguration*>(ptr)->addCaCertificate(*static_cast<QSslCertificate*>(certificate));
}

char QSslConfiguration_AddCaCertificates(void* ptr, struct QtNetwork_PackedString path, long long format, long long syntax)
{
	return static_cast<QSslConfiguration*>(ptr)->addCaCertificates(QString::fromUtf8(path.data, path.len), static_cast<QSsl::EncodingFormat>(format), static_cast<QSslCertificate::PatternSyntax>(syntax));
}

void QSslConfiguration_AddCaCertificates2(void* ptr, void* certificates)
{
	static_cast<QSslConfiguration*>(ptr)->addCaCertificates(*static_cast<QList<QSslCertificate>*>(certificates));
}
...
public:
	...
	void Signal_NewSessionTicketReceived() { callbackQSslSocket_NewSessionTicketReceived(this); };
...
{
	QObject::connect(static_cast<QSslSocket*>(ptr), static_cast<void (QSslSocket::*)()>(&QSslSocket::newSessionTicketReceived), static_cast<MyQSslSocket*>(ptr), static_cast<void (MyQSslSocket::*)()>(&MyQSslSocket::Signal_NewSessionTicketReceived), static_cast<Qt::ConnectionType>(t));
}

void QSslSocket_DisconnectNewSessionTicketReceived(void* ptr)
{
	QObject::disconnect(static_cast<QSslSocket*>(ptr), static_cast<void (QSslSocket::*)()>(&QSslSocket::newSessionTicketReceived), static_cast<MyQSslSocket*>(ptr), static_cast<void (MyQSslSocket::*)()>(&MyQSslSocket::Signal_NewSessionTicketReceived));
}

void QSslSocket_NewSessionTicketReceived(void* ptr)
{
	static_cast<QSslSocket*>(ptr)->newSessionTicketReceived();
}
...
{
	return ({ QList<QSslError>* tmpValue62fdc0 = new QList<QSslError>(static_cast<QSslSocket*>(ptr)->sslHandshakeErrors()); QtNetwork_PackedList { tmpValue62fdc0, tmpValue62fdc0->size() }; });
}
