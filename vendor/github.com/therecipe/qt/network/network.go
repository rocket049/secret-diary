...
//export callbackQAbstractSocket_ErrorOccurred
func callbackQAbstractSocket_ErrorOccurred(ptr unsafe.Pointer, socketError C.longlong) {
...
func (ptr *QAbstractSocket) ConnectErrorOccurred(f func(socketError QAbstractSocket__SocketError)) {
	if ptr.Pointer() != nil {

		if !qt.ExistsSignal(ptr.Pointer(), "errorOccurred") {
			C.QAbstractSocket_ConnectErrorOccurred(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "errorOccurred")))
		}
...
func (ptr *QAbstractSocket) DisconnectErrorOccurred() {
	if ptr.Pointer() != nil {
		C.QAbstractSocket_DisconnectErrorOccurred(ptr.Pointer())
		qt.DisconnectSignal(ptr.Pointer(), "errorOccurred")
	}
}

func (ptr *QAbstractSocket) ErrorOccurred(socketError QAbstractSocket__SocketError) {
	if ptr.Pointer() != nil {
		C.QAbstractSocket_ErrorOccurred(ptr.Pointer(), C.longlong(socketError))
	}
}
...
func NewQHostInfo3(other QHostInfo_ITF) *QHostInfo {
	tmpValue := NewQHostInfoFromPointer(C.QHostInfo_NewQHostInfo3(PointerFromQHostInfo(other)))
	qt.SetFinalizer(tmpValue, (*QHostInfo).DestroyQHostInfo)
	return tmpValue
}
...
type QHttp2Configuration_ITF interface {
	QHttp2Configuration_PTR() *QHttp2Configuration
}

func (ptr *QHttp2Configuration) QHttp2Configuration_PTR() *QHttp2Configuration {
	return ptr
}

func (ptr *QHttp2Configuration) Pointer() unsafe.Pointer {
	if ptr != nil {
		return ptr.ptr
	}
	return nil
...
func (ptr *QHttp2Configuration) SetPointer(p unsafe.Pointer) {
	if ptr != nil {
		ptr.ptr = p
	}
}

func PointerFromQHttp2Configuration(ptr QHttp2Configuration_ITF) unsafe.Pointer {
	if ptr != nil {
		return ptr.QHttp2Configuration_PTR().Pointer()
	}
	return nil
}

func NewQHttp2ConfigurationFromPointer(ptr unsafe.Pointer) (n *QHttp2Configuration) {
	n = new(QHttp2Configuration)
	n.SetPointer(ptr)
	return
}
func NewQHttp2Configuration() *QHttp2Configuration {
	tmpValue := NewQHttp2ConfigurationFromPointer(C.QHttp2Configuration_NewQHttp2Configuration())
	qt.SetFinalizer(tmpValue, (*QHttp2Configuration).DestroyQHttp2Configuration)
	return tmpValue
}

func NewQHttp2Configuration2(other QHttp2Configuration_ITF) *QHttp2Configuration {
	tmpValue := NewQHttp2ConfigurationFromPointer(C.QHttp2Configuration_NewQHttp2Configuration2(PointerFromQHttp2Configuration(other)))
	qt.SetFinalizer(tmpValue, (*QHttp2Configuration).DestroyQHttp2Configuration)
	return tmpValue
}

func NewQHttp2Configuration3(other QHttp2Configuration_ITF) *QHttp2Configuration {
	tmpValue := NewQHttp2ConfigurationFromPointer(C.QHttp2Configuration_NewQHttp2Configuration3(PointerFromQHttp2Configuration(other)))
	qt.SetFinalizer(tmpValue, (*QHttp2Configuration).DestroyQHttp2Configuration)
	return tmpValue
}

func (ptr *QHttp2Configuration) HuffmanCompressionEnabled() bool {
	if ptr.Pointer() != nil {
		return int8(C.QHttp2Configuration_HuffmanCompressionEnabled(ptr.Pointer())) != 0
	}
	return false
}

func (ptr *QHttp2Configuration) MaxFrameSize() uint {
	if ptr.Pointer() != nil {
		return uint(uint32(C.QHttp2Configuration_MaxFrameSize(ptr.Pointer())))
	}
	return 0
}

func (ptr *QHttp2Configuration) ServerPushEnabled() bool {
	if ptr.Pointer() != nil {
		return int8(C.QHttp2Configuration_ServerPushEnabled(ptr.Pointer())) != 0
	}
	return false
}

func (ptr *QHttp2Configuration) SessionReceiveWindowSize() uint {
	if ptr.Pointer() != nil {
		return uint(uint32(C.QHttp2Configuration_SessionReceiveWindowSize(ptr.Pointer())))
	}
	return 0
}

func (ptr *QHttp2Configuration) SetHuffmanCompressionEnabled(enable bool) {
	if ptr.Pointer() != nil {
		C.QHttp2Configuration_SetHuffmanCompressionEnabled(ptr.Pointer(), C.char(int8(qt.GoBoolToInt(enable))))
	}
}

func (ptr *QHttp2Configuration) SetMaxFrameSize(size uint) bool {
	if ptr.Pointer() != nil {
		return int8(C.QHttp2Configuration_SetMaxFrameSize(ptr.Pointer(), C.uint(uint32(size)))) != 0
	}
	return false
}

func (ptr *QHttp2Configuration) SetServerPushEnabled(enable bool) {
	if ptr.Pointer() != nil {
		C.QHttp2Configuration_SetServerPushEnabled(ptr.Pointer(), C.char(int8(qt.GoBoolToInt(enable))))
	}
}

func (ptr *QHttp2Configuration) SetSessionReceiveWindowSize(size uint) bool {
	if ptr.Pointer() != nil {
		return int8(C.QHttp2Configuration_SetSessionReceiveWindowSize(ptr.Pointer(), C.uint(uint32(size)))) != 0
	}
	return false
}

func (ptr *QHttp2Configuration) SetStreamReceiveWindowSize(size uint) bool {
	if ptr.Pointer() != nil {
		return int8(C.QHttp2Configuration_SetStreamReceiveWindowSize(ptr.Pointer(), C.uint(uint32(size)))) != 0
	}
	return false
}

func (ptr *QHttp2Configuration) StreamReceiveWindowSize() uint {
	if ptr.Pointer() != nil {
		return uint(uint32(C.QHttp2Configuration_StreamReceiveWindowSize(ptr.Pointer())))
	}
	return 0
}

func (ptr *QHttp2Configuration) Swap(other QHttp2Configuration_ITF) {
	if ptr.Pointer() != nil {
		C.QHttp2Configuration_Swap(ptr.Pointer(), PointerFromQHttp2Configuration(other))
	}
}

func (ptr *QHttp2Configuration) DestroyQHttp2Configuration() {
	if ptr.Pointer() != nil {

		qt.SetFinalizer(ptr, nil)
		C.QHttp2Configuration_DestroyQHttp2Configuration(ptr.Pointer())
		C.free(ptr.Pointer())
		ptr.SetPointer(nil)
	}
}
...
//export callbackQLocalSocket_ErrorOccurred
func callbackQLocalSocket_ErrorOccurred(ptr unsafe.Pointer, socketError C.longlong) {
	if signal := qt.GetSignal(ptr, "errorOccurred"); signal != nil {
...
func (ptr *QLocalSocket) ConnectErrorOccurred(f func(socketError QLocalSocket__LocalSocketError)) {
	if ptr.Pointer() != nil {

		if !qt.ExistsSignal(ptr.Pointer(), "errorOccurred") {
			C.QLocalSocket_ConnectErrorOccurred(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "errorOccurred")))
		}
...
func (ptr *QLocalSocket) DisconnectErrorOccurred() {
	if ptr.Pointer() != nil {
		C.QLocalSocket_DisconnectErrorOccurred(ptr.Pointer())
		qt.DisconnectSignal(ptr.Pointer(), "errorOccurred")
	}
}

func (ptr *QLocalSocket) ErrorOccurred(socketError QLocalSocket__LocalSocketError) {
	if ptr.Pointer() != nil {
		C.QLocalSocket_ErrorOccurred(ptr.Pointer(), C.longlong(socketError))
	}
}
...
func (ptr *QNetworkAccessManager) AutoDeleteReplies() bool {
	if ptr.Pointer() != nil {
		return int8(C.QNetworkAccessManager_AutoDeleteReplies(ptr.Pointer())) != 0
	}
	return false
}
...
func (ptr *QNetworkAccessManager) SetAutoDeleteReplies(shouldAutoDelete bool) {
	if ptr.Pointer() != nil {
		C.QNetworkAccessManager_SetAutoDeleteReplies(ptr.Pointer(), C.char(int8(qt.GoBoolToInt(shouldAutoDelete))))
	}
}
...
func (ptr *QNetworkAccessManager) SetTransferTimeout(timeout int) {
	if ptr.Pointer() != nil {
		C.QNetworkAccessManager_SetTransferTimeout(ptr.Pointer(), C.int(int32(timeout)))
	}
}
...
func (ptr *QNetworkAccessManager) TransferTimeout() int {
	if ptr.Pointer() != nil {
		return int(int32(C.QNetworkAccessManager_TransferTimeout(ptr.Pointer())))
	}
	return 0
}
...
//export callbackQNetworkReply_ErrorOccurred
func callbackQNetworkReply_ErrorOccurred(ptr unsafe.Pointer, code C.longlong) {
	if signal := qt.GetSignal(ptr, "errorOccurred"); signal != nil {
...
func (ptr *QNetworkReply) ConnectErrorOccurred(f func(code QNetworkReply__NetworkError)) {
	if ptr.Pointer() != nil {

		if !qt.ExistsSignal(ptr.Pointer(), "errorOccurred") {
			C.QNetworkReply_ConnectErrorOccurred(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "errorOccurred")))
		}
...
func (ptr *QNetworkReply) DisconnectErrorOccurred() {
	if ptr.Pointer() != nil {
		C.QNetworkReply_DisconnectErrorOccurred(ptr.Pointer())
		qt.DisconnectSignal(ptr.Pointer(), "errorOccurred")
	}
}

func (ptr *QNetworkReply) ErrorOccurred(code QNetworkReply__NetworkError) {
	if ptr.Pointer() != nil {
		C.QNetworkReply_ErrorOccurred(ptr.Pointer(), C.longlong(code))
	}
}
...
var (
	...
	QNetworkRequest__EmitAllUploadProgressSignalsAttribute QNetworkRequest__Attribute = QNetworkRequest__Attribute(C.QNetworkRequest_EmitAllUploadProgressSignalsAttribute_Type())
	...
	QNetworkRequest__HTTP2AllowedAttribute                 QNetworkRequest__Attribute = QNetworkRequest__Attribute(QNetworkRequest__Http2AllowedAttribute)
	QNetworkRequest__HTTP2WasUsedAttribute                 QNetworkRequest__Attribute = QNetworkRequest__Attribute(23)
	...
	QNetworkRequest__AutoDeleteReplyOnFinishAttribute      QNetworkRequest__Attribute = QNetworkRequest__Attribute(28)
...
//go:generate stringer -type=QNetworkRequest__TransferTimeoutConstant
//QNetworkRequest::TransferTimeoutConstant
type QNetworkRequest__TransferTimeoutConstant int64

const (
	QNetworkRequest__DefaultTransferTimeoutConstant QNetworkRequest__TransferTimeoutConstant = QNetworkRequest__TransferTimeoutConstant(30000)
)

func NewQNetworkRequest() *QNetworkRequest {
	tmpValue := NewQNetworkRequestFromPointer(C.QNetworkRequest_NewQNetworkRequest())
	qt.SetFinalizer(tmpValue, (*QNetworkRequest).DestroyQNetworkRequest)
	return tmpValue
}

func NewQNetworkRequest2(url core.QUrl_ITF) *QNetworkRequest {
	tmpValue := NewQNetworkRequestFromPointer(C.QNetworkRequest_NewQNetworkRequest2(core.PointerFromQUrl(url)))
	qt.SetFinalizer(tmpValue, (*QNetworkRequest).DestroyQNetworkRequest)
	return tmpValue
}

func NewQNetworkRequest3(other QNetworkRequest_ITF) *QNetworkRequest {
	tmpValue := NewQNetworkRequestFromPointer(C.QNetworkRequest_NewQNetworkRequest3(PointerFromQNetworkRequest(other)))
	qt.SetFinalizer(tmpValue, (*QNetworkRequest).DestroyQNetworkRequest)
	return tmpValue
}
...
func (ptr *QNetworkRequest) Http2Configuration() *QHttp2Configuration {
	if ptr.Pointer() != nil {
		tmpValue := NewQHttp2ConfigurationFromPointer(C.QNetworkRequest_Http2Configuration(ptr.Pointer()))
		qt.SetFinalizer(tmpValue, (*QHttp2Configuration).DestroyQHttp2Configuration)
		return tmpValue
	}
	return nil
...
func (ptr *QNetworkRequest) SetHttp2Configuration(configuration QHttp2Configuration_ITF) {
	if ptr.Pointer() != nil {
		C.QNetworkRequest_SetHttp2Configuration(ptr.Pointer(), PointerFromQHttp2Configuration(configuration))
	}
}
...
func (ptr *QNetworkRequest) SetTransferTimeout(timeout int) {
	if ptr.Pointer() != nil {
		C.QNetworkRequest_SetTransferTimeout(ptr.Pointer(), C.int(int32(timeout)))
	}
}
...
func (ptr *QNetworkRequest) TransferTimeout() int {
	if ptr.Pointer() != nil {
		return int(int32(C.QNetworkRequest_TransferTimeout(ptr.Pointer())))
	}
	return 0
}
...
//go:generate stringer -type=QSslCertificate__PatternSyntax
//QSslCertificate::PatternSyntax
type QSslCertificate__PatternSyntax int64

const (
	QSslCertificate__RegularExpression QSslCertificate__PatternSyntax = QSslCertificate__PatternSyntax(0)
	QSslCertificate__Wildcard          QSslCertificate__PatternSyntax = QSslCertificate__PatternSyntax(1)
	QSslCertificate__FixedString       QSslCertificate__PatternSyntax = QSslCertificate__PatternSyntax(2)
)
...
func QSslCertificate_FromPath2(path string, format QSsl__EncodingFormat, syntax QSslCertificate__PatternSyntax) []*QSslCertificate {
	var pathC *C.char
	if path != "" {
		pathC = C.CString(path)
		defer C.free(unsafe.Pointer(pathC))
	...
	return func(l C.struct_QtNetwork_PackedList) []*QSslCertificate {
		...
		tmpList := NewQSslCertificateFromPointer(l.data)
		for i := 0; i < len(out); i++ {
			out[i] = tmpList.__fromPath_atList2(i)
		}
		return out
	}(C.QSslCertificate_QSslCertificate_FromPath2(C.struct_QtNetwork_PackedString{data: pathC, len: C.longlong(len(path))}, C.longlong(format), C.longlong(syntax)))
}

func (ptr *QSslCertificate) FromPath2(path string, format QSsl__EncodingFormat, syntax QSslCertificate__PatternSyntax) []*QSslCertificate {
	var pathC *C.char
	if path != "" {
		pathC = C.CString(path)
		defer C.free(unsafe.Pointer(pathC))
...
func (ptr *QSslCertificate) __fromPath_atList2(i int) *QSslCertificate {
	if ptr.Pointer() != nil {
		tmpValue := NewQSslCertificateFromPointer(C.QSslCertificate___fromPath_atList2(ptr.Pointer(), C.int(int32(i))))
		qt.SetFinalizer(tmpValue, (*QSslCertificate).DestroyQSslCertificate)
		return tmpValue
	}
	return nil
...
func (ptr *QSslCertificate) __fromPath_setList2(i QSslCertificate_ITF) {
	if ptr.Pointer() != nil {
		C.QSslCertificate___fromPath_setList2(ptr.Pointer(), PointerFromQSslCertificate(i))
	}
}

func (ptr *QSslCertificate) __fromPath_newList2() unsafe.Pointer {
	return C.QSslCertificate___fromPath_newList2(ptr.Pointer())
}
...
func (ptr *QSslConfiguration) AddCaCertificate(certificate QSslCertificate_ITF) {
	if ptr.Pointer() != nil {
		C.QSslConfiguration_AddCaCertificate(ptr.Pointer(), PointerFromQSslCertificate(certificate))
	}
}

func (ptr *QSslConfiguration) AddCaCertificates(path string, format QSsl__EncodingFormat, syntax QSslCertificate__PatternSyntax) bool {
	if ptr.Pointer() != nil {
		var pathC *C.char
		if path != "" {
			pathC = C.CString(path)
		...
		return int8(C.QSslConfiguration_AddCaCertificates(ptr.Pointer(), C.struct_QtNetwork_PackedString{data: pathC, len: C.longlong(len(path))}, C.longlong(format), C.longlong(syntax))) != 0
	}
	return false
}

func (ptr *QSslConfiguration) AddCaCertificates2(certificates []*QSslCertificate) {
	if ptr.Pointer() != nil {
		C.QSslConfiguration_AddCaCertificates2(ptr.Pointer(), func() unsafe.Pointer {
			tmpList := NewQSslConfigurationFromPointer(NewQSslConfigurationFromPointer(nil).__addCaCertificates_certificates_newList2())
...
func (ptr *QSslConfiguration) __addCaCertificates_certificates_atList2(i int) *QSslCertificate {
	if ptr.Pointer() != nil {
		tmpValue := NewQSslCertificateFromPointer(C.QSslConfiguration___addCaCertificates_certificates_atList2(ptr.Pointer(), C.int(int32(i))))
		qt.SetFinalizer(tmpValue, (*QSslCertificate).DestroyQSslCertificate)
		return tmpValue
	}
	return nil
...
func (ptr *QSslConfiguration) __addCaCertificates_certificates_setList2(i QSslCertificate_ITF) {
	if ptr.Pointer() != nil {
		C.QSslConfiguration___addCaCertificates_certificates_setList2(ptr.Pointer(), PointerFromQSslCertificate(i))
	}
}

func (ptr *QSslConfiguration) __addCaCertificates_certificates_newList2() unsafe.Pointer {
	return C.QSslConfiguration___addCaCertificates_certificates_newList2(ptr.Pointer())
}
...
//export callbackQSslSocket_NewSessionTicketReceived
func callbackQSslSocket_NewSessionTicketReceived(ptr unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "newSessionTicketReceived"); signal != nil {
		(*(*func())(signal))()
	}

}

func (ptr *QSslSocket) ConnectNewSessionTicketReceived(f func()) {
	if ptr.Pointer() != nil {

		if !qt.ExistsSignal(ptr.Pointer(), "newSessionTicketReceived") {
			C.QSslSocket_ConnectNewSessionTicketReceived(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "newSessionTicketReceived")))
		}

		if signal := qt.LendSignal(ptr.Pointer(), "newSessionTicketReceived"); signal != nil {
			f := func() {
				(*(*func())(signal))()
				f()
			}
			qt.ConnectSignal(ptr.Pointer(), "newSessionTicketReceived", unsafe.Pointer(&f))
		} else {
			qt.ConnectSignal(ptr.Pointer(), "newSessionTicketReceived", unsafe.Pointer(&f))
		}
	}
...
func (ptr *QSslSocket) DisconnectNewSessionTicketReceived() {
	if ptr.Pointer() != nil {
		C.QSslSocket_DisconnectNewSessionTicketReceived(ptr.Pointer())
		qt.DisconnectSignal(ptr.Pointer(), "newSessionTicketReceived")
	}
}

func (ptr *QSslSocket) NewSessionTicketReceived() {
	if ptr.Pointer() != nil {
		C.QSslSocket_NewSessionTicketReceived(ptr.Pointer())
	}
}
...
func (ptr *QSslSocket) SslHandshakeErrors() []*QSslError {
	if ptr.Pointer() != nil {
		return func(l C.struct_QtNetwork_PackedList) []*QSslError {
			out := make([]*QSslError, int(l.len))
			tmpList := NewQSslSocketFromPointer(l.data)
			for i := 0; i < len(out); i++ {
				out[i] = tmpList.__sslHandshakeErrors_atList(i)
			}
			return out
		}(C.QSslSocket_SslHandshakeErrors(ptr.Pointer()))
	}
...
func (ptr *QSslSocket) __sslHandshakeErrors_atList(i int) *QSslError {
	if ptr.Pointer() != nil {
		tmpValue := NewQSslErrorFromPointer(C.QSslSocket___sslHandshakeErrors_atList(ptr.Pointer(), C.int(int32(i))))
		qt.SetFinalizer(tmpValue, (*QSslError).DestroyQSslError)
		return tmpValue
	}
	return nil
...
func (ptr *QSslSocket) __sslHandshakeErrors_setList(i QSslError_ITF) {
	if ptr.Pointer() != nil {
		C.QSslSocket___sslHandshakeErrors_setList(ptr.Pointer(), PointerFromQSslError(i))
	}
}

func (ptr *QSslSocket) __sslHandshakeErrors_newList() unsafe.Pointer {
	return C.QSslSocket___sslHandshakeErrors_newList(ptr.Pointer())
}
...
func init() {
	...
	qt.FuncMap["network.NewQHostInfo3"] = NewQHostInfo3
	...
	qt.ItfMap["network.QHttp2Configuration_ITF"] = QHttp2Configuration{}
	qt.FuncMap["network.NewQHttp2Configuration"] = NewQHttp2Configuration
	qt.FuncMap["network.NewQHttp2Configuration2"] = NewQHttp2Configuration2
	qt.FuncMap["network.NewQHttp2Configuration3"] = NewQHttp2Configuration3
	...
	qt.FuncMap["network.NewQNetworkRequest3"] = NewQNetworkRequest3
	...
	qt.EnumMap["network.QNetworkRequest__AutoDeleteReplyOnFinishAttribute"] = int64(QNetworkRequest__AutoDeleteReplyOnFinishAttribute)
	...
	qt.EnumMap["network.QNetworkRequest__DefaultTransferTimeoutConstant"] = int64(QNetworkRequest__DefaultTransferTimeoutConstant)
	...
	qt.FuncMap["network.QSslCertificate_FromPath2"] = QSslCertificate_FromPath2
	...
	qt.EnumMap["network.QSslCertificate__RegularExpression"] = int64(QSslCertificate__RegularExpression)
	qt.EnumMap["network.QSslCertificate__Wildcard"] = int64(QSslCertificate__Wildcard)
	qt.EnumMap["network.QSslCertificate__FixedString"] = int64(QSslCertificate__FixedString)
