...
func (ptr *QGeoPositionInfoSource) BackendProperty(name string) *core.QVariant {
	if ptr.Pointer() != nil {
		var nameC *C.char
		if name != "" {
			nameC = C.CString(name)
		...
		tmpValue := core.NewQVariantFromPointer(C.QGeoPositionInfoSource_BackendProperty(ptr.Pointer(), C.struct_QtPositioning_PackedString{data: nameC, len: C.longlong(len(name))}))
		qt.SetFinalizer(tmpValue, (*core.QVariant).DestroyQVariant)
		return tmpValue
	}
	return nil
...
func QGeoPositionInfoSource_CreateDefaultSource2(parameters map[string]*core.QVariant, parent core.QObject_ITF) *QGeoPositionInfoSource {
	tmpValue := NewQGeoPositionInfoSourceFromPointer(C.QGeoPositionInfoSource_QGeoPositionInfoSource_CreateDefaultSource2(func() unsafe.Pointer {
		tmpList := NewQGeoPositionInfoSourceFromPointer(NewQGeoPositionInfoSourceFromPointer(nil).__createDefaultSource_parameters_newList2())
		for k, v := range parameters {
			tmpList.__createDefaultSource_parameters_setList2(k, v)
		}
		return tmpList.Pointer()
...
func (ptr *QGeoPositionInfoSource) CreateDefaultSource2(parameters map[string]*core.QVariant, parent core.QObject_ITF) *QGeoPositionInfoSource {
	tmpValue := NewQGeoPositionInfoSourceFromPointer(C.QGeoPositionInfoSource_QGeoPositionInfoSource_CreateDefaultSource2(func() unsafe.Pointer {
		tmpList := NewQGeoPositionInfoSourceFromPointer(NewQGeoPositionInfoSourceFromPointer(nil).__createDefaultSource_parameters_newList2())
		for k, v := range parameters {
			tmpList.__createDefaultSource_parameters_setList2(k, v)
...
func QGeoPositionInfoSource_CreateSource2(sourceName string, parameters map[string]*core.QVariant, parent core.QObject_ITF) *QGeoPositionInfoSource {
	var sourceNameC *C.char
	if sourceName != "" {
		sourceNameC = C.CString(sourceName)
		defer C.free(unsafe.Pointer(sourceNameC))
	}
	tmpValue := NewQGeoPositionInfoSourceFromPointer(C.QGeoPositionInfoSource_QGeoPositionInfoSource_CreateSource2(C.struct_QtPositioning_PackedString{data: sourceNameC, len: C.longlong(len(sourceName))}, func() unsafe.Pointer {
		tmpList := NewQGeoPositionInfoSourceFromPointer(NewQGeoPositionInfoSourceFromPointer(nil).__createSource_parameters_newList2())
		for k, v := range parameters {
			tmpList.__createSource_parameters_setList2(k, v)
		}
		return tmpList.Pointer()
	}(), core.PointerFromQObject(parent)))
	if !qt.ExistsSignal(tmpValue.Pointer(), "destroyed") {
...
func (ptr *QGeoPositionInfoSource) CreateSource2(sourceName string, parameters map[string]*core.QVariant, parent core.QObject_ITF) *QGeoPositionInfoSource {
	var sourceNameC *C.char
	if sourceName != "" {
		sourceNameC = C.CString(sourceName)
		defer C.free(unsafe.Pointer(sourceNameC))
...
func (ptr *QGeoPositionInfoSource) SetBackendProperty(name string, value core.QVariant_ITF) bool {
	if ptr.Pointer() != nil {
		var nameC *C.char
		if name != "" {
			nameC = C.CString(name)
		...
		return int8(C.QGeoPositionInfoSource_SetBackendProperty(ptr.Pointer(), C.struct_QtPositioning_PackedString{data: nameC, len: C.longlong(len(name))}, core.PointerFromQVariant(value))) != 0
	}
	return false
}
...
func (ptr *QGeoPositionInfoSource) __createDefaultSource_parameters_atList2(v string, i int) *core.QVariant {
	if ptr.Pointer() != nil {
		var vC *C.char
		if v != "" {
			vC = C.CString(v)
		...
		tmpValue := core.NewQVariantFromPointer(C.QGeoPositionInfoSource___createDefaultSource_parameters_atList2(ptr.Pointer(), C.struct_QtPositioning_PackedString{data: vC, len: C.longlong(len(v))}, C.int(int32(i))))
		qt.SetFinalizer(tmpValue, (*core.QVariant).DestroyQVariant)
		return tmpValue
	}
	return nil
...
func (ptr *QGeoPositionInfoSource) __createDefaultSource_parameters_setList2(key string, i core.QVariant_ITF) {
	if ptr.Pointer() != nil {
		var keyC *C.char
		if key != "" {
			keyC = C.CString(key)
		...
		C.QGeoPositionInfoSource___createDefaultSource_parameters_setList2(ptr.Pointer(), C.struct_QtPositioning_PackedString{data: keyC, len: C.longlong(len(key))}, core.PointerFromQVariant(i))
	}
}

func (ptr *QGeoPositionInfoSource) __createDefaultSource_parameters_newList2() unsafe.Pointer {
	return C.QGeoPositionInfoSource___createDefaultSource_parameters_newList2(ptr.Pointer())
}

func (ptr *QGeoPositionInfoSource) __createDefaultSource_parameters_keyList2() []string {
	if ptr.Pointer() != nil {
		return func(l C.struct_QtPositioning_PackedList) []string {
			out := make([]string, int(l.len))
			tmpList := NewQGeoPositionInfoSourceFromPointer(l.data)
			for i := 0; i < len(out); i++ {
				out[i] = tmpList.____createDefaultSource_parameters_keyList_atList2(i)
			}
			return out
		}(C.QGeoPositionInfoSource___createDefaultSource_parameters_keyList2(ptr.Pointer()))
	}
	return make([]string, 0)
}

func (ptr *QGeoPositionInfoSource) __createSource_parameters_atList2(v string, i int) *core.QVariant {
	if ptr.Pointer() != nil {
		var vC *C.char
		if v != "" {
			vC = C.CString(v)
		...
		tmpValue := core.NewQVariantFromPointer(C.QGeoPositionInfoSource___createSource_parameters_atList2(ptr.Pointer(), C.struct_QtPositioning_PackedString{data: vC, len: C.longlong(len(v))}, C.int(int32(i))))
		qt.SetFinalizer(tmpValue, (*core.QVariant).DestroyQVariant)
		return tmpValue
	}
	return nil
...
func (ptr *QGeoPositionInfoSource) __createSource_parameters_setList2(key string, i core.QVariant_ITF) {
	if ptr.Pointer() != nil {
		var keyC *C.char
		if key != "" {
			keyC = C.CString(key)
		...
		C.QGeoPositionInfoSource___createSource_parameters_setList2(ptr.Pointer(), C.struct_QtPositioning_PackedString{data: keyC, len: C.longlong(len(key))}, core.PointerFromQVariant(i))
	}
}

func (ptr *QGeoPositionInfoSource) __createSource_parameters_newList2() unsafe.Pointer {
	return C.QGeoPositionInfoSource___createSource_parameters_newList2(ptr.Pointer())
}

func (ptr *QGeoPositionInfoSource) __createSource_parameters_keyList2() []string {
	if ptr.Pointer() != nil {
		return func(l C.struct_QtPositioning_PackedList) []string {
			out := make([]string, int(l.len))
			tmpList := NewQGeoPositionInfoSourceFromPointer(l.data)
			for i := 0; i < len(out); i++ {
				out[i] = tmpList.____createSource_parameters_keyList_atList2(i)
			}
			return out
		}(C.QGeoPositionInfoSource___createSource_parameters_keyList2(ptr.Pointer()))
	}
	return make([]string, 0)
}

func (ptr *QGeoPositionInfoSource) ____createDefaultSource_parameters_keyList_atList2(i int) string {
	if ptr.Pointer() != nil {
		return cGoUnpackString(C.QGeoPositionInfoSource_____createDefaultSource_parameters_keyList_atList2(ptr.Pointer(), C.int(int32(i))))
	}
	return ""
}

func (ptr *QGeoPositionInfoSource) ____createDefaultSource_parameters_keyList_setList2(i string) {
	if ptr.Pointer() != nil {
		var iC *C.char
		if i != "" {
			iC = C.CString(i)
		...
		C.QGeoPositionInfoSource_____createDefaultSource_parameters_keyList_setList2(ptr.Pointer(), C.struct_QtPositioning_PackedString{data: iC, len: C.longlong(len(i))})
	}
}

func (ptr *QGeoPositionInfoSource) ____createDefaultSource_parameters_keyList_newList2() unsafe.Pointer {
	return C.QGeoPositionInfoSource_____createDefaultSource_parameters_keyList_newList2(ptr.Pointer())
}

func (ptr *QGeoPositionInfoSource) ____createSource_parameters_keyList_atList2(i int) string {
	if ptr.Pointer() != nil {
		return cGoUnpackString(C.QGeoPositionInfoSource_____createSource_parameters_keyList_atList2(ptr.Pointer(), C.int(int32(i))))
	}
	return ""
}

func (ptr *QGeoPositionInfoSource) ____createSource_parameters_keyList_setList2(i string) {
	if ptr.Pointer() != nil {
		var iC *C.char
		if i != "" {
			iC = C.CString(i)
		...
		C.QGeoPositionInfoSource_____createSource_parameters_keyList_setList2(ptr.Pointer(), C.struct_QtPositioning_PackedString{data: iC, len: C.longlong(len(i))})
	}
}

func (ptr *QGeoPositionInfoSource) ____createSource_parameters_keyList_newList2() unsafe.Pointer {
	return C.QGeoPositionInfoSource_____createSource_parameters_keyList_newList2(ptr.Pointer())
}
...
type QGeoPositionInfoSourceFactoryV2_ITF interface {
	QGeoPositionInfoSourceFactory_ITF
	QGeoPositionInfoSourceFactoryV2_PTR() *QGeoPositionInfoSourceFactoryV2
}

func (ptr *QGeoPositionInfoSourceFactoryV2) QGeoPositionInfoSourceFactoryV2_PTR() *QGeoPositionInfoSourceFactoryV2 {
	return ptr
}

func (ptr *QGeoPositionInfoSourceFactoryV2) Pointer() unsafe.Pointer {
	if ptr != nil {
		return ptr.QGeoPositionInfoSourceFactory_PTR().Pointer()
	}
	return nil
...
func (ptr *QGeoPositionInfoSourceFactoryV2) SetPointer(p unsafe.Pointer) {
	if ptr != nil {
		ptr.QGeoPositionInfoSourceFactory_PTR().SetPointer(p)
	}
}

func PointerFromQGeoPositionInfoSourceFactoryV2(ptr QGeoPositionInfoSourceFactoryV2_ITF) unsafe.Pointer {
	if ptr != nil {
		return ptr.QGeoPositionInfoSourceFactoryV2_PTR().Pointer()
	}
	return nil
}

func NewQGeoPositionInfoSourceFactoryV2FromPointer(ptr unsafe.Pointer) (n *QGeoPositionInfoSourceFactoryV2) {
	n = new(QGeoPositionInfoSourceFactoryV2)
	n.SetPointer(ptr)
	return
}
func (ptr *QGeoPositionInfoSourceFactoryV2) DestroyQGeoPositionInfoSourceFactoryV2() {
	if ptr != nil {
		qt.SetFinalizer(ptr, nil)
...
func QGeoSatelliteInfoSource_CreateDefaultSource2(parameters map[string]*core.QVariant, parent core.QObject_ITF) *QGeoSatelliteInfoSource {
	tmpValue := NewQGeoSatelliteInfoSourceFromPointer(C.QGeoSatelliteInfoSource_QGeoSatelliteInfoSource_CreateDefaultSource2(func() unsafe.Pointer {
		tmpList := NewQGeoSatelliteInfoSourceFromPointer(NewQGeoSatelliteInfoSourceFromPointer(nil).__createDefaultSource_parameters_newList2())
		for k, v := range parameters {
			tmpList.__createDefaultSource_parameters_setList2(k, v)
		}
		return tmpList.Pointer()
...
func (ptr *QGeoSatelliteInfoSource) CreateDefaultSource2(parameters map[string]*core.QVariant, parent core.QObject_ITF) *QGeoSatelliteInfoSource {
	tmpValue := NewQGeoSatelliteInfoSourceFromPointer(C.QGeoSatelliteInfoSource_QGeoSatelliteInfoSource_CreateDefaultSource2(func() unsafe.Pointer {
		tmpList := NewQGeoSatelliteInfoSourceFromPointer(NewQGeoSatelliteInfoSourceFromPointer(nil).__createDefaultSource_parameters_newList2())
		for k, v := range parameters {
			tmpList.__createDefaultSource_parameters_setList2(k, v)
...
func QGeoSatelliteInfoSource_CreateSource2(sourceName string, parameters map[string]*core.QVariant, parent core.QObject_ITF) *QGeoSatelliteInfoSource {
	var sourceNameC *C.char
	if sourceName != "" {
		sourceNameC = C.CString(sourceName)
		defer C.free(unsafe.Pointer(sourceNameC))
	}
	tmpValue := NewQGeoSatelliteInfoSourceFromPointer(C.QGeoSatelliteInfoSource_QGeoSatelliteInfoSource_CreateSource2(C.struct_QtPositioning_PackedString{data: sourceNameC, len: C.longlong(len(sourceName))}, func() unsafe.Pointer {
		tmpList := NewQGeoSatelliteInfoSourceFromPointer(NewQGeoSatelliteInfoSourceFromPointer(nil).__createSource_parameters_newList2())
		for k, v := range parameters {
			tmpList.__createSource_parameters_setList2(k, v)
		}
		return tmpList.Pointer()
...
func (ptr *QGeoSatelliteInfoSource) CreateSource2(sourceName string, parameters map[string]*core.QVariant, parent core.QObject_ITF) *QGeoSatelliteInfoSource {
	var sourceNameC *C.char
	if sourceName != "" {
		sourceNameC = C.CString(sourceName)
		defer C.free(unsafe.Pointer(sourceNameC))
...
func (ptr *QGeoSatelliteInfoSource) __createDefaultSource_parameters_atList2(v string, i int) *core.QVariant {
	if ptr.Pointer() != nil {
		var vC *C.char
		if v != "" {
			vC = C.CString(v)
		...
		tmpValue := core.NewQVariantFromPointer(C.QGeoSatelliteInfoSource___createDefaultSource_parameters_atList2(ptr.Pointer(), C.struct_QtPositioning_PackedString{data: vC, len: C.longlong(len(v))}, C.int(int32(i))))
		qt.SetFinalizer(tmpValue, (*core.QVariant).DestroyQVariant)
		return tmpValue
	}
	return nil
...
func (ptr *QGeoSatelliteInfoSource) __createDefaultSource_parameters_setList2(key string, i core.QVariant_ITF) {
	if ptr.Pointer() != nil {
		var keyC *C.char
		if key != "" {
			keyC = C.CString(key)
		...
		C.QGeoSatelliteInfoSource___createDefaultSource_parameters_setList2(ptr.Pointer(), C.struct_QtPositioning_PackedString{data: keyC, len: C.longlong(len(key))}, core.PointerFromQVariant(i))
	}
}

func (ptr *QGeoSatelliteInfoSource) __createDefaultSource_parameters_newList2() unsafe.Pointer {
	return C.QGeoSatelliteInfoSource___createDefaultSource_parameters_newList2(ptr.Pointer())
}

func (ptr *QGeoSatelliteInfoSource) __createDefaultSource_parameters_keyList2() []string {
	if ptr.Pointer() != nil {
		return func(l C.struct_QtPositioning_PackedList) []string {
			out := make([]string, int(l.len))
			tmpList := NewQGeoSatelliteInfoSourceFromPointer(l.data)
			...
			return out
		}(C.QGeoSatelliteInfoSource___createDefaultSource_parameters_keyList2(ptr.Pointer()))
	}
	return make([]string, 0)
}

func (ptr *QGeoSatelliteInfoSource) __createSource_parameters_atList2(v string, i int) *core.QVariant {
	if ptr.Pointer() != nil {
		var vC *C.char
		if v != "" {
			vC = C.CString(v)
		...
		tmpValue := core.NewQVariantFromPointer(C.QGeoSatelliteInfoSource___createSource_parameters_atList2(ptr.Pointer(), C.struct_QtPositioning_PackedString{data: vC, len: C.longlong(len(v))}, C.int(int32(i))))
		qt.SetFinalizer(tmpValue, (*core.QVariant).DestroyQVariant)
		return tmpValue
	}
	return nil
...
func (ptr *QGeoSatelliteInfoSource) __createSource_parameters_setList2(key string, i core.QVariant_ITF) {
	if ptr.Pointer() != nil {
		var keyC *C.char
		if key != "" {
			keyC = C.CString(key)
		...
		C.QGeoSatelliteInfoSource___createSource_parameters_setList2(ptr.Pointer(), C.struct_QtPositioning_PackedString{data: keyC, len: C.longlong(len(key))}, core.PointerFromQVariant(i))
	}
}

func (ptr *QGeoSatelliteInfoSource) __createSource_parameters_newList2() unsafe.Pointer {
	return C.QGeoSatelliteInfoSource___createSource_parameters_newList2(ptr.Pointer())
}

func (ptr *QGeoSatelliteInfoSource) __createSource_parameters_keyList2() []string {
	if ptr.Pointer() != nil {
		return func(l C.struct_QtPositioning_PackedList) []string {
			out := make([]string, int(l.len))
			tmpList := NewQGeoSatelliteInfoSourceFromPointer(l.data)
			...
			return out
		}(C.QGeoSatelliteInfoSource___createSource_parameters_keyList2(ptr.Pointer()))
	}
	return make([]string, 0)
}
...
func (ptr *QGeoSatelliteInfoSource) ____createDefaultSource_parameters_keyList_atList2(i int) string {
	if ptr.Pointer() != nil {
		return cGoUnpackString(C.QGeoSatelliteInfoSource_____createDefaultSource_parameters_keyList_atList2(ptr.Pointer(), C.int(int32(i))))
	}
	return ""
}

func (ptr *QGeoSatelliteInfoSource) ____createDefaultSource_parameters_keyList_setList2(i string) {
	if ptr.Pointer() != nil {
		var iC *C.char
		if i != "" {
			iC = C.CString(i)
		...
		C.QGeoSatelliteInfoSource_____createDefaultSource_parameters_keyList_setList2(ptr.Pointer(), C.struct_QtPositioning_PackedString{data: iC, len: C.longlong(len(i))})
	}
}

func (ptr *QGeoSatelliteInfoSource) ____createDefaultSource_parameters_keyList_newList2() unsafe.Pointer {
	return C.QGeoSatelliteInfoSource_____createDefaultSource_parameters_keyList_newList2(ptr.Pointer())
}

func (ptr *QGeoSatelliteInfoSource) ____createSource_parameters_keyList_atList2(i int) string {
	if ptr.Pointer() != nil {
		return cGoUnpackString(C.QGeoSatelliteInfoSource_____createSource_parameters_keyList_atList2(ptr.Pointer(), C.int(int32(i))))
	}
	return ""
}

func (ptr *QGeoSatelliteInfoSource) ____createSource_parameters_keyList_setList2(i string) {
	if ptr.Pointer() != nil {
		var iC *C.char
		if i != "" {
			iC = C.CString(i)
		...
		C.QGeoSatelliteInfoSource_____createSource_parameters_keyList_setList2(ptr.Pointer(), C.struct_QtPositioning_PackedString{data: iC, len: C.longlong(len(i))})
	}
}

func (ptr *QGeoSatelliteInfoSource) ____createSource_parameters_keyList_newList2() unsafe.Pointer {
	return C.QGeoSatelliteInfoSource_____createSource_parameters_keyList_newList2(ptr.Pointer())
}
...
func init() {
	...
	qt.FuncMap["positioning.QGeoPositionInfoSource_CreateDefaultSource2"] = QGeoPositionInfoSource_CreateDefaultSource2
	qt.FuncMap["positioning.QGeoPositionInfoSource_CreateSource"] = QGeoPositionInfoSource_CreateSource
	qt.FuncMap["positioning.QGeoPositionInfoSource_CreateSource2"] = QGeoPositionInfoSource_CreateSource2
	...
	qt.ItfMap["positioning.QGeoPositionInfoSourceFactoryV2_ITF"] = QGeoPositionInfoSourceFactoryV2{}
	...
	qt.FuncMap["positioning.QGeoSatelliteInfoSource_CreateDefaultSource2"] = QGeoSatelliteInfoSource_CreateDefaultSource2
	qt.FuncMap["positioning.QGeoSatelliteInfoSource_CreateSource"] = QGeoSatelliteInfoSource_CreateSource
	qt.FuncMap["positioning.QGeoSatelliteInfoSource_CreateSource2"] = QGeoSatelliteInfoSource_CreateSource2
