...
func callbackQAbstractPrintDialog_Exec(ptr unsafe.Pointer) C.int {
	...
	return C.int(int32(NewQAbstractPrintDialogFromPointer(ptr).ExecDefault()))
}

func (ptr *QAbstractPrintDialog) ExecDefault() int {
	if ptr.Pointer() != nil {
		return int(int32(C.QAbstractPrintDialog_ExecDefault(ptr.Pointer())))
	}
	return 0
}
