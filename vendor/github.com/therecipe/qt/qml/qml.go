...
func (ptr *QJSEngine) IsInterrupted() bool {
	if ptr.Pointer() != nil {
		return int8(C.QJSEngine_IsInterrupted(ptr.Pointer())) != 0
	}
	return false
}
...
func (ptr *QJSEngine) SetInterrupted(interrupted bool) {
	if ptr.Pointer() != nil {
		C.QJSEngine_SetInterrupted(ptr.Pointer(), C.char(int8(qt.GoBoolToInt(interrupted))))
	}
}

func (ptr *QJSEngine) SetUiLanguage(language string) {
	if ptr.Pointer() != nil {
		...
		C.QJSEngine_SetUiLanguage(ptr.Pointer(), C.struct_QtQml_PackedString{data: languageC, len: C.longlong(len(language))})
	}
}
...
func (ptr *QJSEngine) UiLanguage() string {
	if ptr.Pointer() != nil {
		return cGoUnpackString(C.QJSEngine_UiLanguage(ptr.Pointer()))
	}
	return ""
}

//export callbackQJSEngine_UiLanguageChanged
func callbackQJSEngine_UiLanguageChanged(ptr unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "uiLanguageChanged"); signal != nil {
		(*(*func())(signal))()
	}

}

func (ptr *QJSEngine) ConnectUiLanguageChanged(f func()) {
	if ptr.Pointer() != nil {

		if !qt.ExistsSignal(ptr.Pointer(), "uiLanguageChanged") {
			C.QJSEngine_ConnectUiLanguageChanged(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "uiLanguageChanged")))
		}

		if signal := qt.LendSignal(ptr.Pointer(), "uiLanguageChanged"); signal != nil {
			f := func() {
				(*(*func())(signal))()
				f()
			}
			qt.ConnectSignal(ptr.Pointer(), "uiLanguageChanged", unsafe.Pointer(&f))
		} else {
			qt.ConnectSignal(ptr.Pointer(), "uiLanguageChanged", unsafe.Pointer(&f))
		}
	}
...
func (ptr *QJSEngine) DisconnectUiLanguageChanged() {
	if ptr.Pointer() != nil {
		C.QJSEngine_DisconnectUiLanguageChanged(ptr.Pointer())
		qt.DisconnectSignal(ptr.Pointer(), "uiLanguageChanged")
	}
}

func (ptr *QJSEngine) UiLanguageChanged() {
	if ptr.Pointer() != nil {
		C.QJSEngine_UiLanguageChanged(ptr.Pointer())
	}
}
...
func (ptr *QQmlApplicationEngine) __setInitialProperties_initialProperties_atList(v string, i int) *core.QVariant {
	if ptr.Pointer() != nil {
		var vC *C.char
		if v != "" {
			vC = C.CString(v)
		...
		tmpValue := core.NewQVariantFromPointer(C.QQmlApplicationEngine___setInitialProperties_initialProperties_atList(ptr.Pointer(), C.struct_QtQml_PackedString{data: vC, len: C.longlong(len(v))}, C.int(int32(i))))
		qt.SetFinalizer(tmpValue, (*core.QVariant).DestroyQVariant)
		return tmpValue
	}
	return nil
...
func (ptr *QQmlApplicationEngine) __setInitialProperties_initialProperties_setList(key string, i core.QVariant_ITF) {
	if ptr.Pointer() != nil {
		var keyC *C.char
		if key != "" {
			keyC = C.CString(key)
		...
		C.QQmlApplicationEngine___setInitialProperties_initialProperties_setList(ptr.Pointer(), C.struct_QtQml_PackedString{data: keyC, len: C.longlong(len(key))}, core.PointerFromQVariant(i))
	}
}

func (ptr *QQmlApplicationEngine) __setInitialProperties_initialProperties_newList() unsafe.Pointer {
	return C.QQmlApplicationEngine___setInitialProperties_initialProperties_newList(ptr.Pointer())
}

func (ptr *QQmlApplicationEngine) __setInitialProperties_initialProperties_keyList() []string {
	if ptr.Pointer() != nil {
		return func(l C.struct_QtQml_PackedList) []string {
			out := make([]string, int(l.len))
			tmpList := NewQQmlApplicationEngineFromPointer(l.data)
			for i := 0; i < len(out); i++ {
				out[i] = tmpList.____setInitialProperties_initialProperties_keyList_atList(i)
			}
			return out
		}(C.QQmlApplicationEngine___setInitialProperties_initialProperties_keyList(ptr.Pointer()))
	}
	return make([]string, 0)
}

func (ptr *QQmlApplicationEngine) ____setInitialProperties_initialProperties_keyList_atList(i int) string {
	if ptr.Pointer() != nil {
		return cGoUnpackString(C.QQmlApplicationEngine_____setInitialProperties_initialProperties_keyList_atList(ptr.Pointer(), C.int(int32(i))))
	}
	return ""
}

func (ptr *QQmlApplicationEngine) ____setInitialProperties_initialProperties_keyList_setList(i string) {
	if ptr.Pointer() != nil {
		var iC *C.char
		if i != "" {
			iC = C.CString(i)
		...
		C.QQmlApplicationEngine_____setInitialProperties_initialProperties_keyList_setList(ptr.Pointer(), C.struct_QtQml_PackedString{data: iC, len: C.longlong(len(i))})
	}
}

func (ptr *QQmlApplicationEngine) ____setInitialProperties_initialProperties_keyList_newList() unsafe.Pointer {
	return C.QQmlApplicationEngine_____setInitialProperties_initialProperties_keyList_newList(ptr.Pointer())
}
...
func (ptr *QQmlComponent) CreateWithInitialProperties(initialProperties map[string]*core.QVariant, context QQmlContext_ITF) *core.QObject {
	if ptr.Pointer() != nil {
		tmpValue := core.NewQObjectFromPointer(C.QQmlComponent_CreateWithInitialProperties(ptr.Pointer(), func() unsafe.Pointer {
			tmpList := NewQQmlComponentFromPointer(NewQQmlComponentFromPointer(nil).__createWithInitialProperties_initialProperties_newList())
			for k, v := range initialProperties {
				tmpList.__createWithInitialProperties_initialProperties_setList(k, v)
			}
			return tmpList.Pointer()
		}(), PointerFromQQmlContext(context)))
		if !qt.ExistsSignal(tmpValue.Pointer(), "destroyed") {
			tmpValue.ConnectDestroyed(func(*core.QObject) { tmpValue.SetPointer(nil) })
		}
		return tmpValue
...
func (ptr *QQmlComponent) __createWithInitialProperties_initialProperties_atList(v string, i int) *core.QVariant {
	if ptr.Pointer() != nil {
		var vC *C.char
		if v != "" {
			vC = C.CString(v)
		...
		tmpValue := core.NewQVariantFromPointer(C.QQmlComponent___createWithInitialProperties_initialProperties_atList(ptr.Pointer(), C.struct_QtQml_PackedString{data: vC, len: C.longlong(len(v))}, C.int(int32(i))))
		qt.SetFinalizer(tmpValue, (*core.QVariant).DestroyQVariant)
		return tmpValue
	}
	return nil
...
func (ptr *QQmlComponent) __createWithInitialProperties_initialProperties_setList(key string, i core.QVariant_ITF) {
	if ptr.Pointer() != nil {
		var keyC *C.char
		if key != "" {
			keyC = C.CString(key)
		...
		C.QQmlComponent___createWithInitialProperties_initialProperties_setList(ptr.Pointer(), C.struct_QtQml_PackedString{data: keyC, len: C.longlong(len(key))}, core.PointerFromQVariant(i))
	}
}

func (ptr *QQmlComponent) __createWithInitialProperties_initialProperties_newList() unsafe.Pointer {
	return C.QQmlComponent___createWithInitialProperties_initialProperties_newList(ptr.Pointer())
}

func (ptr *QQmlComponent) __createWithInitialProperties_initialProperties_keyList() []string {
	if ptr.Pointer() != nil {
		return func(l C.struct_QtQml_PackedList) []string {
			out := make([]string, int(l.len))
			tmpList := NewQQmlComponentFromPointer(l.data)
			for i := 0; i < len(out); i++ {
				out[i] = tmpList.____createWithInitialProperties_initialProperties_keyList_atList(i)
			}
			return out
		}(C.QQmlComponent___createWithInitialProperties_initialProperties_keyList(ptr.Pointer()))
	}
	return make([]string, 0)
}
...
func (ptr *QQmlComponent) __setInitialProperties_properties_atList(v string, i int) *core.QVariant {
	if ptr.Pointer() != nil {
		var vC *C.char
		if v != "" {
			vC = C.CString(v)
		...
		tmpValue := core.NewQVariantFromPointer(C.QQmlComponent___setInitialProperties_properties_atList(ptr.Pointer(), C.struct_QtQml_PackedString{data: vC, len: C.longlong(len(v))}, C.int(int32(i))))
		qt.SetFinalizer(tmpValue, (*core.QVariant).DestroyQVariant)
		return tmpValue
	}
	return nil
...
func (ptr *QQmlComponent) __setInitialProperties_properties_setList(key string, i core.QVariant_ITF) {
	if ptr.Pointer() != nil {
		var keyC *C.char
		if key != "" {
			keyC = C.CString(key)
		...
		C.QQmlComponent___setInitialProperties_properties_setList(ptr.Pointer(), C.struct_QtQml_PackedString{data: keyC, len: C.longlong(len(key))}, core.PointerFromQVariant(i))
	}
}

func (ptr *QQmlComponent) __setInitialProperties_properties_newList() unsafe.Pointer {
	return C.QQmlComponent___setInitialProperties_properties_newList(ptr.Pointer())
}

func (ptr *QQmlComponent) __setInitialProperties_properties_keyList() []string {
	if ptr.Pointer() != nil {
		return func(l C.struct_QtQml_PackedList) []string {
			out := make([]string, int(l.len))
			tmpList := NewQQmlComponentFromPointer(l.data)
			for i := 0; i < len(out); i++ {
				out[i] = tmpList.____setInitialProperties_properties_keyList_atList(i)
			}
			return out
		}(C.QQmlComponent___setInitialProperties_properties_keyList(ptr.Pointer()))
	}
	return make([]string, 0)
}

func (ptr *QQmlComponent) ____createWithInitialProperties_initialProperties_keyList_atList(i int) string {
	if ptr.Pointer() != nil {
		return cGoUnpackString(C.QQmlComponent_____createWithInitialProperties_initialProperties_keyList_atList(ptr.Pointer(), C.int(int32(i))))
	}
	return ""
}

func (ptr *QQmlComponent) ____createWithInitialProperties_initialProperties_keyList_setList(i string) {
	if ptr.Pointer() != nil {
		var iC *C.char
		if i != "" {
			iC = C.CString(i)
		...
		C.QQmlComponent_____createWithInitialProperties_initialProperties_keyList_setList(ptr.Pointer(), C.struct_QtQml_PackedString{data: iC, len: C.longlong(len(i))})
	}
}

func (ptr *QQmlComponent) ____createWithInitialProperties_initialProperties_keyList_newList() unsafe.Pointer {
	return C.QQmlComponent_____createWithInitialProperties_initialProperties_keyList_newList(ptr.Pointer())
}

func (ptr *QQmlComponent) ____setInitialProperties_properties_keyList_atList(i int) string {
	if ptr.Pointer() != nil {
		return cGoUnpackString(C.QQmlComponent_____setInitialProperties_properties_keyList_atList(ptr.Pointer(), C.int(int32(i))))
	}
	return ""
}

func (ptr *QQmlComponent) ____setInitialProperties_properties_keyList_setList(i string) {
	if ptr.Pointer() != nil {
		var iC *C.char
		if i != "" {
			iC = C.CString(i)
		...
		C.QQmlComponent_____setInitialProperties_properties_keyList_setList(ptr.Pointer(), C.struct_QtQml_PackedString{data: iC, len: C.longlong(len(i))})
	}
}

func (ptr *QQmlComponent) ____setInitialProperties_properties_keyList_newList() unsafe.Pointer {
	return C.QQmlComponent_____setInitialProperties_properties_keyList_newList(ptr.Pointer())
}
...
func QQmlEngine_QmlRegisterSingletonInstance(uri string, versionMajor int, versionMinor int, typeName string, cppObject core.QObject_ITF) int {
	var uriC *C.char
	if uri != "" {
		uriC = C.CString(uri)
		defer C.free(unsafe.Pointer(uriC))
	...
	return int(int32(C.QQmlEngine_QQmlEngine_QmlRegisterSingletonInstance(uriC, C.int(int32(versionMajor)), C.int(int32(versionMinor)), typeNameC, core.PointerFromQObject(cppObject))))
}

func (ptr *QQmlEngine) QmlRegisterSingletonInstance(uri string, versionMajor int, versionMinor int, typeName string, cppObject core.QObject_ITF) int {
	var uriC *C.char
	if uri != "" {
		uriC = C.CString(uri)
		defer C.free(unsafe.Pointer(uriC))
...
type QQmlEngineExtensionPlugin_ITF interface {
	core.QObject_ITF
	QQmlEngineExtensionPlugin_PTR() *QQmlEngineExtensionPlugin
}

func (ptr *QQmlEngineExtensionPlugin) QQmlEngineExtensionPlugin_PTR() *QQmlEngineExtensionPlugin {
	return ptr
}

func (ptr *QQmlEngineExtensionPlugin) Pointer() unsafe.Pointer {
	if ptr != nil {
		return ptr.QObject_PTR().Pointer()
	}
	return nil
...
func (ptr *QQmlEngineExtensionPlugin) SetPointer(p unsafe.Pointer) {
	if ptr != nil {
		ptr.QObject_PTR().SetPointer(p)
	}
}

func PointerFromQQmlEngineExtensionPlugin(ptr QQmlEngineExtensionPlugin_ITF) unsafe.Pointer {
	if ptr != nil {
		return ptr.QQmlEngineExtensionPlugin_PTR().Pointer()
	}
	return nil
}

func NewQQmlEngineExtensionPluginFromPointer(ptr unsafe.Pointer) (n *QQmlEngineExtensionPlugin) {
	n = new(QQmlEngineExtensionPlugin)
	n.SetPointer(ptr)
	return
}
func NewQQmlEngineExtensionPlugin3(parent core.QObject_ITF) *QQmlEngineExtensionPlugin {
	tmpValue := NewQQmlEngineExtensionPluginFromPointer(C.QQmlEngineExtensionPlugin_NewQQmlEngineExtensionPlugin3(core.PointerFromQObject(parent)))
	if !qt.ExistsSignal(tmpValue.Pointer(), "destroyed") {
		tmpValue.ConnectDestroyed(func(*core.QObject) { tmpValue.SetPointer(nil) })
	}
	return tmpValue
...
//export callbackQQmlEngineExtensionPlugin_InitializeEngine
func callbackQQmlEngineExtensionPlugin_InitializeEngine(ptr unsafe.Pointer, engine unsafe.Pointer, uri C.struct_QtQml_PackedString) {
	if signal := qt.GetSignal(ptr, "initializeEngine"); signal != nil {
		...
		NewQQmlEngineExtensionPluginFromPointer(ptr).InitializeEngineDefault(NewQQmlEngineFromPointer(engine), cGoUnpackString(uri))
	}
}

func (ptr *QQmlEngineExtensionPlugin) ConnectInitializeEngine(f func(engine *QQmlEngine, uri string)) {
	if ptr.Pointer() != nil {
...
func (ptr *QQmlEngineExtensionPlugin) DisconnectInitializeEngine() {
	if ptr.Pointer() != nil {
...
func (ptr *QQmlEngineExtensionPlugin) InitializeEngine(engine QQmlEngine_ITF, uri string) {
	if ptr.Pointer() != nil {
		var uriC *C.char
		if uri != "" {
			uriC = C.CString(uri)
		...
		C.QQmlEngineExtensionPlugin_InitializeEngine(ptr.Pointer(), PointerFromQQmlEngine(engine), uriC)
	}
}

func (ptr *QQmlEngineExtensionPlugin) InitializeEngineDefault(engine QQmlEngine_ITF, uri string) {
	if ptr.Pointer() != nil {
		var uriC *C.char
		if uri != "" {
			uriC = C.CString(uri)
		...
		C.QQmlEngineExtensionPlugin_InitializeEngineDefault(ptr.Pointer(), PointerFromQQmlEngine(engine), uriC)
	}
}

func (ptr *QQmlEngineExtensionPlugin) __children_atList(i int) *core.QObject {
	if ptr.Pointer() != nil {
		tmpValue := core.NewQObjectFromPointer(C.QQmlEngineExtensionPlugin___children_atList(ptr.Pointer(), C.int(int32(i))))
		if !qt.ExistsSignal(tmpValue.Pointer(), "destroyed") {
			tmpValue.ConnectDestroyed(func(*core.QObject) { tmpValue.SetPointer(nil) })
		}
		return tmpValue
...
func (ptr *QQmlEngineExtensionPlugin) __children_setList(i core.QObject_ITF) {
	if ptr.Pointer() != nil {
		C.QQmlEngineExtensionPlugin___children_setList(ptr.Pointer(), core.PointerFromQObject(i))
	}
}

func (ptr *QQmlEngineExtensionPlugin) __children_newList() unsafe.Pointer {
	return C.QQmlEngineExtensionPlugin___children_newList(ptr.Pointer())
}

func (ptr *QQmlEngineExtensionPlugin) __dynamicPropertyNames_atList(i int) *core.QByteArray {
	if ptr.Pointer() != nil {
		tmpValue := core.NewQByteArrayFromPointer(C.QQmlEngineExtensionPlugin___dynamicPropertyNames_atList(ptr.Pointer(), C.int(int32(i))))
		qt.SetFinalizer(tmpValue, (*core.QByteArray).DestroyQByteArray)
		return tmpValue
	}
	return nil
...
func (ptr *QQmlEngineExtensionPlugin) __dynamicPropertyNames_setList(i core.QByteArray_ITF) {
	if ptr.Pointer() != nil {
		C.QQmlEngineExtensionPlugin___dynamicPropertyNames_setList(ptr.Pointer(), core.PointerFromQByteArray(i))
	}
}

func (ptr *QQmlEngineExtensionPlugin) __dynamicPropertyNames_newList() unsafe.Pointer {
	return C.QQmlEngineExtensionPlugin___dynamicPropertyNames_newList(ptr.Pointer())
}

func (ptr *QQmlEngineExtensionPlugin) __findChildren_atList(i int) *core.QObject {
	if ptr.Pointer() != nil {
		tmpValue := core.NewQObjectFromPointer(C.QQmlEngineExtensionPlugin___findChildren_atList(ptr.Pointer(), C.int(int32(i))))
		if !qt.ExistsSignal(tmpValue.Pointer(), "destroyed") {
			tmpValue.ConnectDestroyed(func(*core.QObject) { tmpValue.SetPointer(nil) })
		}
		return tmpValue
...
func (ptr *QQmlEngineExtensionPlugin) __findChildren_setList(i core.QObject_ITF) {
	if ptr.Pointer() != nil {
		C.QQmlEngineExtensionPlugin___findChildren_setList(ptr.Pointer(), core.PointerFromQObject(i))
	}
}

func (ptr *QQmlEngineExtensionPlugin) __findChildren_newList() unsafe.Pointer {
	return C.QQmlEngineExtensionPlugin___findChildren_newList(ptr.Pointer())
}

func (ptr *QQmlEngineExtensionPlugin) __findChildren_atList3(i int) *core.QObject {
	if ptr.Pointer() != nil {
		tmpValue := core.NewQObjectFromPointer(C.QQmlEngineExtensionPlugin___findChildren_atList3(ptr.Pointer(), C.int(int32(i))))
		if !qt.ExistsSignal(tmpValue.Pointer(), "destroyed") {
			tmpValue.ConnectDestroyed(func(*core.QObject) { tmpValue.SetPointer(nil) })
		}
		return tmpValue
...
func (ptr *QQmlEngineExtensionPlugin) __findChildren_setList3(i core.QObject_ITF) {
	if ptr.Pointer() != nil {
		C.QQmlEngineExtensionPlugin___findChildren_setList3(ptr.Pointer(), core.PointerFromQObject(i))
	}
}

func (ptr *QQmlEngineExtensionPlugin) __findChildren_newList3() unsafe.Pointer {
	return C.QQmlEngineExtensionPlugin___findChildren_newList3(ptr.Pointer())
}

//export callbackQQmlEngineExtensionPlugin_ChildEvent
func callbackQQmlEngineExtensionPlugin_ChildEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "childEvent"); signal != nil {
		(*(*func(*core.QChildEvent))(signal))(core.NewQChildEventFromPointer(event))
	} else {
		NewQQmlEngineExtensionPluginFromPointer(ptr).ChildEventDefault(core.NewQChildEventFromPointer(event))
	}
}

func (ptr *QQmlEngineExtensionPlugin) ChildEventDefault(event core.QChildEvent_ITF) {
	if ptr.Pointer() != nil {
		C.QQmlEngineExtensionPlugin_ChildEventDefault(ptr.Pointer(), core.PointerFromQChildEvent(event))
	}
}

//export callbackQQmlEngineExtensionPlugin_ConnectNotify
func callbackQQmlEngineExtensionPlugin_ConnectNotify(ptr unsafe.Pointer, sign unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "connectNotify"); signal != nil {
		(*(*func(*core.QMetaMethod))(signal))(core.NewQMetaMethodFromPointer(sign))
	} else {
		NewQQmlEngineExtensionPluginFromPointer(ptr).ConnectNotifyDefault(core.NewQMetaMethodFromPointer(sign))
	}
}

func (ptr *QQmlEngineExtensionPlugin) ConnectNotifyDefault(sign core.QMetaMethod_ITF) {
	if ptr.Pointer() != nil {
		C.QQmlEngineExtensionPlugin_ConnectNotifyDefault(ptr.Pointer(), core.PointerFromQMetaMethod(sign))
	}
}

//export callbackQQmlEngineExtensionPlugin_CustomEvent
func callbackQQmlEngineExtensionPlugin_CustomEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "customEvent"); signal != nil {
		(*(*func(*core.QEvent))(signal))(core.NewQEventFromPointer(event))
	} else {
		NewQQmlEngineExtensionPluginFromPointer(ptr).CustomEventDefault(core.NewQEventFromPointer(event))
	}
}

func (ptr *QQmlEngineExtensionPlugin) CustomEventDefault(event core.QEvent_ITF) {
	if ptr.Pointer() != nil {
		C.QQmlEngineExtensionPlugin_CustomEventDefault(ptr.Pointer(), core.PointerFromQEvent(event))
	}
}

//export callbackQQmlEngineExtensionPlugin_DeleteLater
func callbackQQmlEngineExtensionPlugin_DeleteLater(ptr unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "deleteLater"); signal != nil {
		(*(*func())(signal))()
	} else {
		NewQQmlEngineExtensionPluginFromPointer(ptr).DeleteLaterDefault()
	}
}

func (ptr *QQmlEngineExtensionPlugin) DeleteLaterDefault() {
	if ptr.Pointer() != nil {

		qt.SetFinalizer(ptr, nil)
		C.QQmlEngineExtensionPlugin_DeleteLaterDefault(ptr.Pointer())
	}
}

//export callbackQQmlEngineExtensionPlugin_Destroyed
func callbackQQmlEngineExtensionPlugin_Destroyed(ptr unsafe.Pointer, obj unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "destroyed"); signal != nil {
		(*(*func(*core.QObject))(signal))(core.NewQObjectFromPointer(obj))
	}
...
//export callbackQQmlEngineExtensionPlugin_DisconnectNotify
func callbackQQmlEngineExtensionPlugin_DisconnectNotify(ptr unsafe.Pointer, sign unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "disconnectNotify"); signal != nil {
		(*(*func(*core.QMetaMethod))(signal))(core.NewQMetaMethodFromPointer(sign))
	} else {
		NewQQmlEngineExtensionPluginFromPointer(ptr).DisconnectNotifyDefault(core.NewQMetaMethodFromPointer(sign))
	}
}

func (ptr *QQmlEngineExtensionPlugin) DisconnectNotifyDefault(sign core.QMetaMethod_ITF) {
	if ptr.Pointer() != nil {
		C.QQmlEngineExtensionPlugin_DisconnectNotifyDefault(ptr.Pointer(), core.PointerFromQMetaMethod(sign))
	}
}

//export callbackQQmlEngineExtensionPlugin_Event
func callbackQQmlEngineExtensionPlugin_Event(ptr unsafe.Pointer, e unsafe.Pointer) C.char {
	if signal := qt.GetSignal(ptr, "event"); signal != nil {
		return C.char(int8(qt.GoBoolToInt((*(*func(*core.QEvent) bool)(signal))(core.NewQEventFromPointer(e)))))
	}

	return C.char(int8(qt.GoBoolToInt(NewQQmlEngineExtensionPluginFromPointer(ptr).EventDefault(core.NewQEventFromPointer(e)))))
}

func (ptr *QQmlEngineExtensionPlugin) EventDefault(e core.QEvent_ITF) bool {
	if ptr.Pointer() != nil {
		return int8(C.QQmlEngineExtensionPlugin_EventDefault(ptr.Pointer(), core.PointerFromQEvent(e))) != 0
	}
	return false
}

//export callbackQQmlEngineExtensionPlugin_EventFilter
func callbackQQmlEngineExtensionPlugin_EventFilter(ptr unsafe.Pointer, watched unsafe.Pointer, event unsafe.Pointer) C.char {
	if signal := qt.GetSignal(ptr, "eventFilter"); signal != nil {
		return C.char(int8(qt.GoBoolToInt((*(*func(*core.QObject, *core.QEvent) bool)(signal))(core.NewQObjectFromPointer(watched), core.NewQEventFromPointer(event)))))
	}

	return C.char(int8(qt.GoBoolToInt(NewQQmlEngineExtensionPluginFromPointer(ptr).EventFilterDefault(core.NewQObjectFromPointer(watched), core.NewQEventFromPointer(event)))))
}

func (ptr *QQmlEngineExtensionPlugin) EventFilterDefault(watched core.QObject_ITF, event core.QEvent_ITF) bool {
	if ptr.Pointer() != nil {
		return int8(C.QQmlEngineExtensionPlugin_EventFilterDefault(ptr.Pointer(), core.PointerFromQObject(watched), core.PointerFromQEvent(event))) != 0
	}
	return false
}

//export callbackQQmlEngineExtensionPlugin_MetaObject
func callbackQQmlEngineExtensionPlugin_MetaObject(ptr unsafe.Pointer) unsafe.Pointer {
	if signal := qt.GetSignal(ptr, "metaObject"); signal != nil {
		return core.PointerFromQMetaObject((*(*func() *core.QMetaObject)(signal))())
	}

	return core.PointerFromQMetaObject(NewQQmlEngineExtensionPluginFromPointer(ptr).MetaObjectDefault())
}

func (ptr *QQmlEngineExtensionPlugin) MetaObjectDefault() *core.QMetaObject {
	if ptr.Pointer() != nil {
		return core.NewQMetaObjectFromPointer(C.QQmlEngineExtensionPlugin_MetaObjectDefault(ptr.Pointer()))
	}
	return nil
}

//export callbackQQmlEngineExtensionPlugin_ObjectNameChanged
func callbackQQmlEngineExtensionPlugin_ObjectNameChanged(ptr unsafe.Pointer, objectName C.struct_QtQml_PackedString) {
	if signal := qt.GetSignal(ptr, "objectNameChanged"); signal != nil {
		(*(*func(string))(signal))(cGoUnpackString(objectName))
	}
...
//export callbackQQmlEngineExtensionPlugin_TimerEvent
func callbackQQmlEngineExtensionPlugin_TimerEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "timerEvent"); signal != nil {
		(*(*func(*core.QTimerEvent))(signal))(core.NewQTimerEventFromPointer(event))
	} else {
		NewQQmlEngineExtensionPluginFromPointer(ptr).TimerEventDefault(core.NewQTimerEventFromPointer(event))
	}
}

func (ptr *QQmlEngineExtensionPlugin) TimerEventDefault(event core.QTimerEvent_ITF) {
	if ptr.Pointer() != nil {
		C.QQmlEngineExtensionPlugin_TimerEventDefault(ptr.Pointer(), core.PointerFromQTimerEvent(event))
	}
}
...
func (ptr *QQmlIncubator) __setInitialProperties_initialProperties_atList(v string, i int) *core.QVariant {
	if ptr.Pointer() != nil {
		var vC *C.char
		if v != "" {
			vC = C.CString(v)
		...
		tmpValue := core.NewQVariantFromPointer(C.QQmlIncubator___setInitialProperties_initialProperties_atList(ptr.Pointer(), C.struct_QtQml_PackedString{data: vC, len: C.longlong(len(v))}, C.int(int32(i))))
		qt.SetFinalizer(tmpValue, (*core.QVariant).DestroyQVariant)
		return tmpValue
	}
	return nil
...
func (ptr *QQmlIncubator) __setInitialProperties_initialProperties_setList(key string, i core.QVariant_ITF) {
	if ptr.Pointer() != nil {
		var keyC *C.char
		if key != "" {
			keyC = C.CString(key)
		...
		C.QQmlIncubator___setInitialProperties_initialProperties_setList(ptr.Pointer(), C.struct_QtQml_PackedString{data: keyC, len: C.longlong(len(key))}, core.PointerFromQVariant(i))
	}
}

func (ptr *QQmlIncubator) __setInitialProperties_initialProperties_newList() unsafe.Pointer {
	return C.QQmlIncubator___setInitialProperties_initialProperties_newList(ptr.Pointer())
}

func (ptr *QQmlIncubator) __setInitialProperties_initialProperties_keyList() []string {
	if ptr.Pointer() != nil {
		return func(l C.struct_QtQml_PackedList) []string {
			out := make([]string, int(l.len))
			tmpList := NewQQmlIncubatorFromPointer(l.data)
			...
			return out
		}(C.QQmlIncubator___setInitialProperties_initialProperties_keyList(ptr.Pointer()))
	}
	return make([]string, 0)
}

func (ptr *QQmlIncubator) ____setInitialProperties_initialProperties_keyList_atList(i int) string {
	if ptr.Pointer() != nil {
		return cGoUnpackString(C.QQmlIncubator_____setInitialProperties_initialProperties_keyList_atList(ptr.Pointer(), C.int(int32(i))))
	}
	return ""
}

func (ptr *QQmlIncubator) ____setInitialProperties_initialProperties_keyList_setList(i string) {
	if ptr.Pointer() != nil {
		var iC *C.char
		if i != "" {
			iC = C.CString(i)
		...
		C.QQmlIncubator_____setInitialProperties_initialProperties_keyList_setList(ptr.Pointer(), C.struct_QtQml_PackedString{data: iC, len: C.longlong(len(i))})
	}
}

func (ptr *QQmlIncubator) ____setInitialProperties_initialProperties_keyList_newList() unsafe.Pointer {
	return C.QQmlIncubator_____setInitialProperties_initialProperties_keyList_newList(ptr.Pointer())
}
...
func (ptr *QQmlListReference) CanRemoveLast() bool {
	if ptr.Pointer() != nil {
		return int8(C.QQmlListReference_CanRemoveLast(ptr.Pointer())) != 0
	}
	return false
}

func (ptr *QQmlListReference) CanReplace() bool {
	if ptr.Pointer() != nil {
		return int8(C.QQmlListReference_CanReplace(ptr.Pointer())) != 0
	}
	return false
}
...
func (ptr *QQmlListReference) RemoveLast() bool {
	if ptr.Pointer() != nil {
		return int8(C.QQmlListReference_RemoveLast(ptr.Pointer())) != 0
	}
	return false
}

func (ptr *QQmlListReference) Replace(index int, object core.QObject_ITF) bool {
	if ptr.Pointer() != nil {
		return int8(C.QQmlListReference_Replace(ptr.Pointer(), C.int(int32(index)), core.PointerFromQObject(object))) != 0
	}
	return false
}
...
func init() {
	...
	qt.FuncMap["qml.QQmlEngine_QmlRegisterSingletonInstance"] = QQmlEngine_QmlRegisterSingletonInstance
	...
	qt.ItfMap["qml.QQmlEngineExtensionPlugin_ITF"] = QQmlEngineExtensionPlugin{}
	qt.FuncMap["qml.NewQQmlEngineExtensionPlugin3"] = NewQQmlEngineExtensionPlugin3
