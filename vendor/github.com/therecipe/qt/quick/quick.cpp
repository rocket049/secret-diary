...
public:
	...
	void Signal_AfterRenderPassRecording() { callbackQQuickWindow_AfterRenderPassRecording(this); };
	...
	void Signal_BeforeRenderPassRecording() { callbackQQuickWindow_BeforeRenderPassRecording(this); };
	...
	void tabletEvent(QTabletEvent * event) { callbackQQuickWindow_TabletEvent(this, event); };
	...
	bool startSystemMove() { return callbackQQuickWindow_StartSystemMove(this) != 0; };
	bool startSystemResize(Qt::Edges edges) { return callbackQQuickWindow_StartSystemResize(this, edges) != 0; };
...
void* QQuickView___setInitialProperties_initialProperties_atList(void* ptr, struct QtQuick_PackedString v, int i)
{
...
void QQuickView___setInitialProperties_initialProperties_setList(void* ptr, struct QtQuick_PackedString key, void* i)
{
	static_cast<QMap<QString, QVariant>*>(ptr)->insert(QString::fromUtf8(key.data, key.len), *static_cast<QVariant*>(i));
}

void* QQuickView___setInitialProperties_initialProperties_newList(void* ptr)
{
	Q_UNUSED(ptr);
	return new QMap<QString, QVariant>();
}

struct QtQuick_PackedList QQuickView___setInitialProperties_initialProperties_keyList(void* ptr)
{
	return ({ QList<QString>* tmpValue1ab909 = new QList<QString>(static_cast<QMap<QString, QVariant>*>(ptr)->keys()); QtQuick_PackedList { tmpValue1ab909, tmpValue1ab909->size() }; });
}

struct QtQuick_PackedString QQuickView_____setInitialProperties_initialProperties_keyList_atList(void* ptr, int i)
{
	return ({ QByteArray* t94aa5e = new QByteArray(({QString tmp = static_cast<QList<QString>*>(ptr)->at(i); if (i == static_cast<QList<QString>*>(ptr)->size()-1) { static_cast<QList<QString>*>(ptr)->~QList(); free(ptr); }; tmp; }).toUtf8()); QtQuick_PackedString { const_cast<char*>(t94aa5e->prepend("WHITESPACE").constData()+10), t94aa5e->size()-10, t94aa5e }; });
}

void QQuickView_____setInitialProperties_initialProperties_keyList_setList(void* ptr, struct QtQuick_PackedString i)
{
	static_cast<QList<QString>*>(ptr)->append(QString::fromUtf8(i.data, i.len));
}

void* QQuickView_____setInitialProperties_initialProperties_keyList_newList(void* ptr)
{
	Q_UNUSED(ptr);
...
void QQuickWindow_ConnectAfterRenderPassRecording(void* ptr, long long t)
{
	QObject::connect(static_cast<QQuickWindow*>(ptr), static_cast<void (QQuickWindow::*)()>(&QQuickWindow::afterRenderPassRecording), static_cast<MyQQuickWindow*>(ptr), static_cast<void (MyQQuickWindow::*)()>(&MyQQuickWindow::Signal_AfterRenderPassRecording), static_cast<Qt::ConnectionType>(t));
}

void QQuickWindow_DisconnectAfterRenderPassRecording(void* ptr)
{
	QObject::disconnect(static_cast<QQuickWindow*>(ptr), static_cast<void (QQuickWindow::*)()>(&QQuickWindow::afterRenderPassRecording), static_cast<MyQQuickWindow*>(ptr), static_cast<void (MyQQuickWindow::*)()>(&MyQQuickWindow::Signal_AfterRenderPassRecording));
}

void QQuickWindow_AfterRenderPassRecording(void* ptr)
{
	static_cast<QQuickWindow*>(ptr)->afterRenderPassRecording();
}
...
void QQuickWindow_ConnectBeforeRenderPassRecording(void* ptr, long long t)
{
	QObject::connect(static_cast<QQuickWindow*>(ptr), static_cast<void (QQuickWindow::*)()>(&QQuickWindow::beforeRenderPassRecording), static_cast<MyQQuickWindow*>(ptr), static_cast<void (MyQQuickWindow::*)()>(&MyQQuickWindow::Signal_BeforeRenderPassRecording), static_cast<Qt::ConnectionType>(t));
}

void QQuickWindow_DisconnectBeforeRenderPassRecording(void* ptr)
{
	QObject::disconnect(static_cast<QQuickWindow*>(ptr), static_cast<void (QQuickWindow::*)()>(&QQuickWindow::beforeRenderPassRecording), static_cast<MyQQuickWindow*>(ptr), static_cast<void (MyQQuickWindow::*)()>(&MyQQuickWindow::Signal_BeforeRenderPassRecording));
}

void QQuickWindow_BeforeRenderPassRecording(void* ptr)
{
	static_cast<QQuickWindow*>(ptr)->beforeRenderPassRecording();
}
...
void QQuickWindow_BeginExternalCommands(void* ptr)
{
	static_cast<QQuickWindow*>(ptr)->beginExternalCommands();
}
...
void* QQuickWindow_CreateTextureFromNativeObject(void* ptr, long long ty, void* nativeObjectPtr, int nativeLayout, void* size, long long options)
{
	return static_cast<QQuickWindow*>(ptr)->createTextureFromNativeObject(static_cast<QQuickWindow::NativeObjectType>(ty), nativeObjectPtr, nativeLayout, *static_cast<QSize*>(size), static_cast<QQuickWindow::CreateTextureOption>(options));
}
...
void QQuickWindow_EndExternalCommands(void* ptr)
{
	static_cast<QQuickWindow*>(ptr)->endExternalCommands();
}
...
void QQuickWindow_TabletEventDefault(void* ptr, void* event)
{
	if (dynamic_cast<QQuickView*>(static_cast<QObject*>(ptr))) {
		static_cast<QQuickView*>(ptr)->QQuickView::tabletEvent(static_cast<QTabletEvent*>(event));
	} else {
		static_cast<QQuickWindow*>(ptr)->QQuickWindow::tabletEvent(static_cast<QTabletEvent*>(event));
	}
}
...
char QQuickWindow_StartSystemMoveDefault(void* ptr)
{
	if (dynamic_cast<QQuickView*>(static_cast<QObject*>(ptr))) {
		return static_cast<QQuickView*>(ptr)->QQuickView::startSystemMove();
	} else {
		return static_cast<QQuickWindow*>(ptr)->QQuickWindow::startSystemMove();
	}
}

char QQuickWindow_StartSystemResizeDefault(void* ptr, long long edges)
{
	if (dynamic_cast<QQuickView*>(static_cast<QObject*>(ptr))) {
		return static_cast<QQuickView*>(ptr)->QQuickView::startSystemResize(static_cast<Qt::Edge>(edges));
	} else {
		return static_cast<QQuickWindow*>(ptr)->QQuickWindow::startSystemResize(static_cast<Qt::Edge>(edges));
	}
}
...
void QSGAbstractRenderer_SetProjectionMatrixToRect2(void* ptr, void* rect, long long flags)
{
	static_cast<QSGAbstractRenderer*>(ptr)->setProjectionMatrixToRect(*static_cast<QRectF*>(rect), static_cast<QSGAbstractRenderer::MatrixTransformFlag>(flags));
}
...
class MyQSGMaterialRhiShader: public QSGMaterialRhiShader
{
public:
	MyQSGMaterialRhiShader() : QSGMaterialRhiShader() {QSGMaterialRhiShader_QSGMaterialRhiShader_QRegisterMetaType();};
...
Q_DECLARE_METATYPE(QSGMaterialRhiShader*)
Q_DECLARE_METATYPE(MyQSGMaterialRhiShader*)

int QSGMaterialRhiShader_QSGMaterialRhiShader_QRegisterMetaType(){qRegisterMetaType<QSGMaterialRhiShader*>(); return qRegisterMetaType<MyQSGMaterialRhiShader*>();}

void* QSGMaterialRhiShader_NewQSGMaterialRhiShader()
{
	return new MyQSGMaterialRhiShader();
}

long long QSGMaterialRhiShader_Flags(void* ptr)
{
	return static_cast<QSGMaterialRhiShader*>(ptr)->flags();
}

void QSGMaterialRhiShader_SetFlag(void* ptr, long long flags, char on)
{
	static_cast<QSGMaterialRhiShader*>(ptr)->setFlag(static_cast<QSGMaterialRhiShader::Flag>(flags), on != 0);
}
...
{
	if (dynamic_cast<QSGMaterialRhiShader*>(static_cast<QSGMaterialShader*>(ptr))) {
		static_cast<QSGMaterialRhiShader*>(ptr)->QSGMaterialRhiShader::activate();
	} else {
...
{
	if (dynamic_cast<QSGMaterialRhiShader*>(static_cast<QSGMaterialShader*>(ptr))) {
		static_cast<QSGMaterialRhiShader*>(ptr)->QSGMaterialRhiShader::compile();
	} else {
...
{
	if (dynamic_cast<QSGMaterialRhiShader*>(static_cast<QSGMaterialShader*>(ptr))) {
		static_cast<QSGMaterialRhiShader*>(ptr)->QSGMaterialRhiShader::deactivate();
	} else {
...
{
	if (dynamic_cast<QSGMaterialRhiShader*>(static_cast<QSGMaterialShader*>(ptr))) {
		return QtQuick_PackedString { const_cast<char*>(static_cast<QSGMaterialRhiShader*>(ptr)->QSGMaterialRhiShader::fragmentShader()), -1, NULL };
	} else {
...
{
	if (dynamic_cast<QSGMaterialRhiShader*>(static_cast<QSGMaterialShader*>(ptr))) {
		static_cast<QSGMaterialRhiShader*>(ptr)->QSGMaterialRhiShader::initialize();
	} else {
...
{
	if (dynamic_cast<QSGMaterialRhiShader*>(static_cast<QSGMaterialShader*>(ptr))) {
		return QtQuick_PackedString { const_cast<char*>(static_cast<QSGMaterialRhiShader*>(ptr)->QSGMaterialRhiShader::vertexShader()), -1, NULL };
	} else {
...
char QSGRendererInterface_QSGRendererInterface_IsApiRhiBased(long long api)
{
...
int QSGTexture_ComparisonKey(void* ptr)
{
	return static_cast<QSGTexture*>(ptr)->comparisonKey();
}
