...
func (ptr *QQuickView) __setInitialProperties_initialProperties_atList(v string, i int) *core.QVariant {
	if ptr.Pointer() != nil {
		var vC *C.char
		if v != "" {
			vC = C.CString(v)
		...
		tmpValue := core.NewQVariantFromPointer(C.QQuickView___setInitialProperties_initialProperties_atList(ptr.Pointer(), C.struct_QtQuick_PackedString{data: vC, len: C.longlong(len(v))}, C.int(int32(i))))
		qt.SetFinalizer(tmpValue, (*core.QVariant).DestroyQVariant)
		return tmpValue
	}
	return nil
...
func (ptr *QQuickView) __setInitialProperties_initialProperties_setList(key string, i core.QVariant_ITF) {
	if ptr.Pointer() != nil {
		var keyC *C.char
		if key != "" {
			keyC = C.CString(key)
		...
		C.QQuickView___setInitialProperties_initialProperties_setList(ptr.Pointer(), C.struct_QtQuick_PackedString{data: keyC, len: C.longlong(len(key))}, core.PointerFromQVariant(i))
	}
}

func (ptr *QQuickView) __setInitialProperties_initialProperties_newList() unsafe.Pointer {
	return C.QQuickView___setInitialProperties_initialProperties_newList(ptr.Pointer())
}

func (ptr *QQuickView) __setInitialProperties_initialProperties_keyList() []string {
	if ptr.Pointer() != nil {
		return func(l C.struct_QtQuick_PackedList) []string {
			...
			return out
		}(C.QQuickView___setInitialProperties_initialProperties_keyList(ptr.Pointer()))
	}
	return make([]string, 0)
}

func (ptr *QQuickView) ____setInitialProperties_initialProperties_keyList_atList(i int) string {
	if ptr.Pointer() != nil {
		return cGoUnpackString(C.QQuickView_____setInitialProperties_initialProperties_keyList_atList(ptr.Pointer(), C.int(int32(i))))
	}
	return ""
}

func (ptr *QQuickView) ____setInitialProperties_initialProperties_keyList_setList(i string) {
	if ptr.Pointer() != nil {
		var iC *C.char
		if i != "" {
			iC = C.CString(i)
		...
		C.QQuickView_____setInitialProperties_initialProperties_keyList_setList(ptr.Pointer(), C.struct_QtQuick_PackedString{data: iC, len: C.longlong(len(i))})
	}
}

func (ptr *QQuickView) ____setInitialProperties_initialProperties_keyList_newList() unsafe.Pointer {
	return C.QQuickView_____setInitialProperties_initialProperties_keyList_newList(ptr.Pointer())
}
...
//go:generate stringer -type=QQuickWindow__NativeObjectType
//QQuickWindow::NativeObjectType
type QQuickWindow__NativeObjectType int64

const (
	QQuickWindow__NativeObjectTexture QQuickWindow__NativeObjectType = QQuickWindow__NativeObjectType(0)
)
...
//export callbackQQuickWindow_AfterRenderPassRecording
func callbackQQuickWindow_AfterRenderPassRecording(ptr unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "afterRenderPassRecording"); signal != nil {
		(*(*func())(signal))()
	}

}

func (ptr *QQuickWindow) ConnectAfterRenderPassRecording(f func()) {
	if ptr.Pointer() != nil {

		if !qt.ExistsSignal(ptr.Pointer(), "afterRenderPassRecording") {
			C.QQuickWindow_ConnectAfterRenderPassRecording(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "afterRenderPassRecording")))
		}

		if signal := qt.LendSignal(ptr.Pointer(), "afterRenderPassRecording"); signal != nil {
			f := func() {
				(*(*func())(signal))()
				f()
			}
			qt.ConnectSignal(ptr.Pointer(), "afterRenderPassRecording", unsafe.Pointer(&f))
		} else {
			qt.ConnectSignal(ptr.Pointer(), "afterRenderPassRecording", unsafe.Pointer(&f))
		}
	}
...
func (ptr *QQuickWindow) DisconnectAfterRenderPassRecording() {
	if ptr.Pointer() != nil {
		C.QQuickWindow_DisconnectAfterRenderPassRecording(ptr.Pointer())
		qt.DisconnectSignal(ptr.Pointer(), "afterRenderPassRecording")
	}
}

func (ptr *QQuickWindow) AfterRenderPassRecording() {
	if ptr.Pointer() != nil {
		C.QQuickWindow_AfterRenderPassRecording(ptr.Pointer())
	}
}
...
//export callbackQQuickWindow_BeforeRenderPassRecording
func callbackQQuickWindow_BeforeRenderPassRecording(ptr unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "beforeRenderPassRecording"); signal != nil {
		(*(*func())(signal))()
	}

}

func (ptr *QQuickWindow) ConnectBeforeRenderPassRecording(f func()) {
	if ptr.Pointer() != nil {

		if !qt.ExistsSignal(ptr.Pointer(), "beforeRenderPassRecording") {
			C.QQuickWindow_ConnectBeforeRenderPassRecording(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "beforeRenderPassRecording")))
		}

		if signal := qt.LendSignal(ptr.Pointer(), "beforeRenderPassRecording"); signal != nil {
			f := func() {
				(*(*func())(signal))()
				f()
			}
			qt.ConnectSignal(ptr.Pointer(), "beforeRenderPassRecording", unsafe.Pointer(&f))
		} else {
			qt.ConnectSignal(ptr.Pointer(), "beforeRenderPassRecording", unsafe.Pointer(&f))
		}
	}
...
func (ptr *QQuickWindow) DisconnectBeforeRenderPassRecording() {
	if ptr.Pointer() != nil {
		C.QQuickWindow_DisconnectBeforeRenderPassRecording(ptr.Pointer())
		qt.DisconnectSignal(ptr.Pointer(), "beforeRenderPassRecording")
	}
}

func (ptr *QQuickWindow) BeforeRenderPassRecording() {
	if ptr.Pointer() != nil {
		C.QQuickWindow_BeforeRenderPassRecording(ptr.Pointer())
	}
}
...
func (ptr *QQuickWindow) BeginExternalCommands() {
	if ptr.Pointer() != nil {
		C.QQuickWindow_BeginExternalCommands(ptr.Pointer())
	}
}
...
func (ptr *QQuickWindow) CreateTextureFromNativeObject(ty QQuickWindow__NativeObjectType, nativeObjectPtr unsafe.Pointer, nativeLayout int, size core.QSize_ITF, options QQuickWindow__CreateTextureOption) *QSGTexture {
	if ptr.Pointer() != nil {
		tmpValue := NewQSGTextureFromPointer(C.QQuickWindow_CreateTextureFromNativeObject(ptr.Pointer(), C.longlong(ty), nativeObjectPtr, C.int(int32(nativeLayout)), core.PointerFromQSize(size), C.longlong(options)))
		if !qt.ExistsSignal(tmpValue.Pointer(), "destroyed") {
			tmpValue.ConnectDestroyed(func(*core.QObject) { tmpValue.SetPointer(nil) })
		}
		return tmpValue
...
func (ptr *QQuickWindow) EndExternalCommands() {
	if ptr.Pointer() != nil {
		C.QQuickWindow_EndExternalCommands(ptr.Pointer())
	}
}
...
func callbackQQuickWindow_TabletEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "tabletEvent"); signal != nil {
		(*(*func(*gui.QTabletEvent))(signal))(gui.NewQTabletEventFromPointer(event))
	} else {
		NewQQuickWindowFromPointer(ptr).TabletEventDefault(gui.NewQTabletEventFromPointer(event))
	}
}

func (ptr *QQuickWindow) TabletEventDefault(event gui.QTabletEvent_ITF) {
	if ptr.Pointer() != nil {
		C.QQuickWindow_TabletEventDefault(ptr.Pointer(), gui.PointerFromQTabletEvent(event))
	}
}
...
//export callbackQQuickWindow_StartSystemMove
func callbackQQuickWindow_StartSystemMove(ptr unsafe.Pointer) C.char {
	if signal := qt.GetSignal(ptr, "startSystemMove"); signal != nil {
		return C.char(int8(qt.GoBoolToInt((*(*func() bool)(signal))())))
	}

	return C.char(int8(qt.GoBoolToInt(NewQQuickWindowFromPointer(ptr).StartSystemMoveDefault())))
}

func (ptr *QQuickWindow) StartSystemMoveDefault() bool {
	if ptr.Pointer() != nil {
		return int8(C.QQuickWindow_StartSystemMoveDefault(ptr.Pointer())) != 0
	}
	return false
}

//export callbackQQuickWindow_StartSystemResize
func callbackQQuickWindow_StartSystemResize(ptr unsafe.Pointer, edges C.longlong) C.char {
	if signal := qt.GetSignal(ptr, "startSystemResize"); signal != nil {
		return C.char(int8(qt.GoBoolToInt((*(*func(core.Qt__Edge) bool)(signal))(core.Qt__Edge(edges)))))
	}

	return C.char(int8(qt.GoBoolToInt(NewQQuickWindowFromPointer(ptr).StartSystemResizeDefault(core.Qt__Edge(edges)))))
}

func (ptr *QQuickWindow) StartSystemResizeDefault(edges core.Qt__Edge) bool {
	if ptr.Pointer() != nil {
		return int8(C.QQuickWindow_StartSystemResizeDefault(ptr.Pointer(), C.longlong(edges))) != 0
	}
	return false
}
...
//go:generate stringer -type=QSGAbstractRenderer__MatrixTransformFlag
//QSGAbstractRenderer::MatrixTransformFlag
type QSGAbstractRenderer__MatrixTransformFlag int64

const (
	QSGAbstractRenderer__MatrixTransformFlipY QSGAbstractRenderer__MatrixTransformFlag = QSGAbstractRenderer__MatrixTransformFlag(0x01)
)
...
func (ptr *QSGAbstractRenderer) SetProjectionMatrixToRect2(rect core.QRectF_ITF, flags QSGAbstractRenderer__MatrixTransformFlag) {
	if ptr.Pointer() != nil {
		C.QSGAbstractRenderer_SetProjectionMatrixToRect2(ptr.Pointer(), core.PointerFromQRectF(rect), C.longlong(flags))
	}
}
...
const (
	...
	QSGGeometry__Bytes2Type        QSGGeometry__Type = QSGGeometry__Type(0x1407)
	QSGGeometry__Bytes3Type        QSGGeometry__Type = QSGGeometry__Type(0x1408)
	QSGGeometry__Bytes4Type        QSGGeometry__Type = QSGGeometry__Type(0x1409)
	QSGGeometry__DoubleType        QSGGeometry__Type = QSGGeometry__Type(0x140A)
)
...
const (
	...
	QSGMaterial__SupportsRhiShader                 QSGMaterial__Flag = QSGMaterial__Flag(0x0020)
	QSGMaterial__RhiShaderWanted                   QSGMaterial__Flag = QSGMaterial__Flag(0x1000)
)
...
type QSGMaterialRhiShader_ITF interface {
	QSGMaterialShader_ITF
	QSGMaterialRhiShader_PTR() *QSGMaterialRhiShader
}

func (ptr *QSGMaterialRhiShader) QSGMaterialRhiShader_PTR() *QSGMaterialRhiShader {
	return ptr
}

func (ptr *QSGMaterialRhiShader) Pointer() unsafe.Pointer {
	if ptr != nil {
...
func (ptr *QSGMaterialRhiShader) SetPointer(p unsafe.Pointer) {
	if ptr != nil {
		ptr.QSGMaterialShader_PTR().SetPointer(p)
	}
}

func PointerFromQSGMaterialRhiShader(ptr QSGMaterialRhiShader_ITF) unsafe.Pointer {
	if ptr != nil {
		return ptr.QSGMaterialRhiShader_PTR().Pointer()
	}
	return nil
}

func NewQSGMaterialRhiShaderFromPointer(ptr unsafe.Pointer) (n *QSGMaterialRhiShader) {
	n = new(QSGMaterialRhiShader)
	n.SetPointer(ptr)
	return
}
func (ptr *QSGMaterialRhiShader) DestroyQSGMaterialRhiShader() {
	if ptr != nil {
		qt.SetFinalizer(ptr, nil)
...
//go:generate stringer -type=QSGMaterialRhiShader__Flag
//QSGMaterialRhiShader::Flag
type QSGMaterialRhiShader__Flag int64

const (
	QSGMaterialRhiShader__UpdatesGraphicsPipelineState QSGMaterialRhiShader__Flag = QSGMaterialRhiShader__Flag(0x0001)
)

func NewQSGMaterialRhiShader() *QSGMaterialRhiShader {
	return NewQSGMaterialRhiShaderFromPointer(C.QSGMaterialRhiShader_NewQSGMaterialRhiShader())
}

func (ptr *QSGMaterialRhiShader) Flags() QSGMaterialRhiShader__Flag {
	if ptr.Pointer() != nil {
		return QSGMaterialRhiShader__Flag(C.QSGMaterialRhiShader_Flags(ptr.Pointer()))
	}
	return 0
}

func (ptr *QSGMaterialRhiShader) SetFlag(flags QSGMaterialRhiShader__Flag, on bool) {
	if ptr.Pointer() != nil {
		C.QSGMaterialRhiShader_SetFlag(ptr.Pointer(), C.longlong(flags), C.char(int8(qt.GoBoolToInt(on))))
	}
}
...
const (
	...
	QSGRendererInterface__OpenGLRhi     QSGRendererInterface__GraphicsApi = QSGRendererInterface__GraphicsApi(5)
	QSGRendererInterface__Direct3D11Rhi QSGRendererInterface__GraphicsApi = QSGRendererInterface__GraphicsApi(6)
	QSGRendererInterface__VulkanRhi     QSGRendererInterface__GraphicsApi = QSGRendererInterface__GraphicsApi(7)
	QSGRendererInterface__MetalRhi      QSGRendererInterface__GraphicsApi = QSGRendererInterface__GraphicsApi(8)
	QSGRendererInterface__NullRhi       QSGRendererInterface__GraphicsApi = QSGRendererInterface__GraphicsApi(9)
)
...
const (
	...
	QSGRendererInterface__RhiResource            QSGRendererInterface__Resource = QSGRendererInterface__Resource(4)
	QSGRendererInterface__PhysicalDeviceResource QSGRendererInterface__Resource = QSGRendererInterface__Resource(5)
	QSGRendererInterface__OpenGLContextResource  QSGRendererInterface__Resource = QSGRendererInterface__Resource(6)
	QSGRendererInterface__DeviceContextResource  QSGRendererInterface__Resource = QSGRendererInterface__Resource(7)
	QSGRendererInterface__CommandEncoderResource QSGRendererInterface__Resource = QSGRendererInterface__Resource(8)
	QSGRendererInterface__VulkanInstanceResource QSGRendererInterface__Resource = QSGRendererInterface__Resource(9)
	QSGRendererInterface__RenderPassResource     QSGRendererInterface__Resource = QSGRendererInterface__Resource(10)
)
...
const (
	...
	QSGRendererInterface__RhiShader              QSGRendererInterface__ShaderType = QSGRendererInterface__ShaderType(3)
)
...
func QSGRendererInterface_IsApiRhiBased(api QSGRendererInterface__GraphicsApi) bool {
	return int8(C.QSGRendererInterface_QSGRendererInterface_IsApiRhiBased(C.longlong(api))) != 0
}

func (ptr *QSGRendererInterface) IsApiRhiBased(api QSGRendererInterface__GraphicsApi) bool {
	return int8(C.QSGRendererInterface_QSGRendererInterface_IsApiRhiBased(C.longlong(api))) != 0
}
...
func (ptr *QSGTexture) ComparisonKey() int {
	if ptr.Pointer() != nil {
		return int(int32(C.QSGTexture_ComparisonKey(ptr.Pointer())))
	}
	return 0
}
...
func init() {
	...
	qt.EnumMap["quick.QQuickWindow__NativeObjectTexture"] = int64(QQuickWindow__NativeObjectTexture)
	...
	qt.EnumMap["quick.QSGAbstractRenderer__MatrixTransformFlipY"] = int64(QSGAbstractRenderer__MatrixTransformFlipY)
	...
	qt.EnumMap["quick.QSGGeometry__Bytes2Type"] = int64(QSGGeometry__Bytes2Type)
	qt.EnumMap["quick.QSGGeometry__Bytes3Type"] = int64(QSGGeometry__Bytes3Type)
	qt.EnumMap["quick.QSGGeometry__Bytes4Type"] = int64(QSGGeometry__Bytes4Type)
	qt.EnumMap["quick.QSGGeometry__DoubleType"] = int64(QSGGeometry__DoubleType)
	...
	qt.EnumMap["quick.QSGMaterial__SupportsRhiShader"] = int64(QSGMaterial__SupportsRhiShader)
	qt.EnumMap["quick.QSGMaterial__RhiShaderWanted"] = int64(QSGMaterial__RhiShaderWanted)
	qt.ItfMap["quick.QSGMaterialRhiShader_ITF"] = QSGMaterialRhiShader{}
	qt.FuncMap["quick.NewQSGMaterialRhiShader"] = NewQSGMaterialRhiShader
	qt.EnumMap["quick.QSGMaterialRhiShader__UpdatesGraphicsPipelineState"] = int64(QSGMaterialRhiShader__UpdatesGraphicsPipelineState)
	...
	qt.FuncMap["quick.QSGRendererInterface_IsApiRhiBased"] = QSGRendererInterface_IsApiRhiBased
	...
	qt.EnumMap["quick.QSGRendererInterface__OpenGLRhi"] = int64(QSGRendererInterface__OpenGLRhi)
	qt.EnumMap["quick.QSGRendererInterface__Direct3D11Rhi"] = int64(QSGRendererInterface__Direct3D11Rhi)
	qt.EnumMap["quick.QSGRendererInterface__VulkanRhi"] = int64(QSGRendererInterface__VulkanRhi)
	qt.EnumMap["quick.QSGRendererInterface__MetalRhi"] = int64(QSGRendererInterface__MetalRhi)
	qt.EnumMap["quick.QSGRendererInterface__NullRhi"] = int64(QSGRendererInterface__NullRhi)
	...
	qt.EnumMap["quick.QSGRendererInterface__RhiResource"] = int64(QSGRendererInterface__RhiResource)
	qt.EnumMap["quick.QSGRendererInterface__PhysicalDeviceResource"] = int64(QSGRendererInterface__PhysicalDeviceResource)
	qt.EnumMap["quick.QSGRendererInterface__OpenGLContextResource"] = int64(QSGRendererInterface__OpenGLContextResource)
	qt.EnumMap["quick.QSGRendererInterface__DeviceContextResource"] = int64(QSGRendererInterface__DeviceContextResource)
	qt.EnumMap["quick.QSGRendererInterface__CommandEncoderResource"] = int64(QSGRendererInterface__CommandEncoderResource)
	qt.EnumMap["quick.QSGRendererInterface__VulkanInstanceResource"] = int64(QSGRendererInterface__VulkanInstanceResource)
	qt.EnumMap["quick.QSGRendererInterface__RenderPassResource"] = int64(QSGRendererInterface__RenderPassResource)
	...
	qt.EnumMap["quick.QSGRendererInterface__RhiShader"] = int64(QSGRendererInterface__RhiShader)
