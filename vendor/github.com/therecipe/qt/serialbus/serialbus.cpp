...
long long QCanBusDevice_BusStatus(void* ptr)
{
	return static_cast<qint64>(static_cast<QCanBusDevice*>(ptr)->busStatus());
}
...
void QCanBusDevice_ClearError(void* ptr)
{
	static_cast<QCanBusDevice*>(ptr)->clearError();
}
...
char QCanBusDevice_HasBusStatus(void* ptr)
{
	return static_cast<QCanBusDevice*>(ptr)->hasBusStatus();
}
...
void QCanBusDevice_ResetController(void* ptr)
{
	static_cast<QCanBusDevice*>(ptr)->resetController();
}
...
void* QModbusDevice_Device(void* ptr)
{
	return static_cast<QModbusDevice*>(ptr)->device();
}
