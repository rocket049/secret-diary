...
const (
	...
	QCanBusDevice__OperationError     QCanBusDevice__CanBusError = QCanBusDevice__CanBusError(6)
	QCanBusDevice__TimeoutError       QCanBusDevice__CanBusError = QCanBusDevice__CanBusError(7)
)

//go:generate stringer -type=QCanBusDevice__CanBusStatus
//QCanBusDevice::CanBusStatus
type QCanBusDevice__CanBusStatus int64

const (
	QCanBusDevice__Unknown QCanBusDevice__CanBusStatus = QCanBusDevice__CanBusStatus(0)
	QCanBusDevice__Good    QCanBusDevice__CanBusStatus = QCanBusDevice__CanBusStatus(1)
	QCanBusDevice__Warning QCanBusDevice__CanBusStatus = QCanBusDevice__CanBusStatus(2)
	QCanBusDevice__Error   QCanBusDevice__CanBusStatus = QCanBusDevice__CanBusStatus(3)
	QCanBusDevice__BusOff  QCanBusDevice__CanBusStatus = QCanBusDevice__CanBusStatus(4)
)
...
const (
	...
	QCanBusDevice__ProtocolKey    QCanBusDevice__ConfigurationKey = QCanBusDevice__ConfigurationKey(7)
...
func (ptr *QCanBusDevice) BusStatus() QCanBusDevice__CanBusStatus {
	if ptr.Pointer() != nil {
		return QCanBusDevice__CanBusStatus(C.QCanBusDevice_BusStatus(ptr.Pointer()))
	}
	return 0
}
...
func (ptr *QCanBusDevice) ClearError() {
	if ptr.Pointer() != nil {
		C.QCanBusDevice_ClearError(ptr.Pointer())
	}
}
...
func (ptr *QCanBusDevice) HasBusStatus() bool {
	if ptr.Pointer() != nil {
		return int8(C.QCanBusDevice_HasBusStatus(ptr.Pointer())) != 0
	}
	return false
}
...
func (ptr *QCanBusDevice) ResetController() {
	if ptr.Pointer() != nil {
		C.QCanBusDevice_ResetController(ptr.Pointer())
	}
}
...
func (ptr *QModbusDevice) Device() *core.QIODevice {
	if ptr.Pointer() != nil {
		tmpValue := core.NewQIODeviceFromPointer(C.QModbusDevice_Device(ptr.Pointer()))
		if !qt.ExistsSignal(tmpValue.Pointer(), "destroyed") {
			tmpValue.ConnectDestroyed(func(*core.QObject) { tmpValue.SetPointer(nil) })
		}
		return tmpValue
...
func init() {
	...
	qt.EnumMap["serialbus.QCanBusDevice__OperationError"] = int64(QCanBusDevice__OperationError)
	qt.EnumMap["serialbus.QCanBusDevice__TimeoutError"] = int64(QCanBusDevice__TimeoutError)
	qt.EnumMap["serialbus.QCanBusDevice__Unknown"] = int64(QCanBusDevice__Unknown)
	qt.EnumMap["serialbus.QCanBusDevice__Good"] = int64(QCanBusDevice__Good)
	qt.EnumMap["serialbus.QCanBusDevice__Warning"] = int64(QCanBusDevice__Warning)
	qt.EnumMap["serialbus.QCanBusDevice__Error"] = int64(QCanBusDevice__Error)
	qt.EnumMap["serialbus.QCanBusDevice__BusOff"] = int64(QCanBusDevice__BusOff)
	...
	qt.EnumMap["serialbus.QCanBusDevice__ProtocolKey"] = int64(QCanBusDevice__ProtocolKey)
