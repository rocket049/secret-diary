...
long long QSvgRenderer_AspectRatioMode(void* ptr)
{
	return static_cast<QSvgRenderer*>(ptr)->aspectRatioMode();
}
...
void QSvgRenderer_SetAspectRatioMode(void* ptr, long long mode)
{
	static_cast<QSvgRenderer*>(ptr)->setAspectRatioMode(static_cast<Qt::AspectRatioMode>(mode));
}
...
void* QSvgRenderer_TransformForElement(void* ptr, struct QtSvg_PackedString id)
{
	return new QTransform(static_cast<QSvgRenderer*>(ptr)->transformForElement(QString::fromUtf8(id.data, id.len)));
}
