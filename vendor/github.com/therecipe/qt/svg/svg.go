...
func (ptr *QSvgRenderer) AspectRatioMode() core.Qt__AspectRatioMode {
	if ptr.Pointer() != nil {
		return core.Qt__AspectRatioMode(C.QSvgRenderer_AspectRatioMode(ptr.Pointer()))
	}
	return 0
}
...
func (ptr *QSvgRenderer) SetAspectRatioMode(mode core.Qt__AspectRatioMode) {
	if ptr.Pointer() != nil {
		C.QSvgRenderer_SetAspectRatioMode(ptr.Pointer(), C.longlong(mode))
	}
}
...
func (ptr *QSvgRenderer) TransformForElement(id string) *gui.QTransform {
	if ptr.Pointer() != nil {
		var idC *C.char
		if id != "" {
			idC = C.CString(id)
		...
		tmpValue := gui.NewQTransformFromPointer(C.QSvgRenderer_TransformForElement(ptr.Pointer(), C.struct_QtSvg_PackedString{data: idC, len: C.longlong(len(id))}))
