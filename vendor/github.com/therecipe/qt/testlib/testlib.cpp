...
public:
	...
	MyQSignalSpy(const QObject *obj, const QMetaMethod &sign) : QSignalSpy(obj, sign) {QSignalSpy_QSignalSpy_QRegisterMetaType();};
...
void* QSignalSpy_NewQSignalSpy3(void* obj, void* sign)
{
	if (dynamic_cast<QCameraImageCapture*>(static_cast<QObject*>(obj))) {
		return new MyQSignalSpy(static_cast<QCameraImageCapture*>(obj), *static_cast<QMetaMethod*>(sign));
	} else if (dynamic_cast<QDBusPendingCallWatcher*>(static_cast<QObject*>(obj))) {
		return new MyQSignalSpy(static_cast<QDBusPendingCallWatcher*>(obj), *static_cast<QMetaMethod*>(sign));
	} else if (dynamic_cast<QExtensionFactory*>(static_cast<QObject*>(obj))) {
		return new MyQSignalSpy(static_cast<QExtensionFactory*>(obj), *static_cast<QMetaMethod*>(sign));
	} else if (dynamic_cast<QExtensionManager*>(static_cast<QObject*>(obj))) {
		return new MyQSignalSpy(static_cast<QExtensionManager*>(obj), *static_cast<QMetaMethod*>(sign));
	} else if (dynamic_cast<QGraphicsObject*>(static_cast<QObject*>(obj))) {
		return new MyQSignalSpy(static_cast<QGraphicsObject*>(obj), *static_cast<QMetaMethod*>(sign));
	} else if (dynamic_cast<QGraphicsWidget*>(static_cast<QObject*>(obj))) {
		return new MyQSignalSpy(static_cast<QGraphicsWidget*>(obj), *static_cast<QMetaMethod*>(sign));
	} else if (dynamic_cast<QLayout*>(static_cast<QObject*>(obj))) {
		return new MyQSignalSpy(static_cast<QLayout*>(obj), *static_cast<QMetaMethod*>(sign));
	} else if (dynamic_cast<QMediaPlaylist*>(static_cast<QObject*>(obj))) {
		return new MyQSignalSpy(static_cast<QMediaPlaylist*>(obj), *static_cast<QMetaMethod*>(sign));
	} else if (dynamic_cast<QMediaRecorder*>(static_cast<QObject*>(obj))) {
		return new MyQSignalSpy(static_cast<QMediaRecorder*>(obj), *static_cast<QMetaMethod*>(sign));
	} else if (dynamic_cast<QOffscreenSurface*>(static_cast<QObject*>(obj))) {
		return new MyQSignalSpy(static_cast<QOffscreenSurface*>(obj), *static_cast<QMetaMethod*>(sign));
	} else if (dynamic_cast<QPaintDeviceWindow*>(static_cast<QObject*>(obj))) {
		return new MyQSignalSpy(static_cast<QPaintDeviceWindow*>(obj), *static_cast<QMetaMethod*>(sign));
	} else if (dynamic_cast<QPdfWriter*>(static_cast<QObject*>(obj))) {
		return new MyQSignalSpy(static_cast<QPdfWriter*>(obj), *static_cast<QMetaMethod*>(sign));
	} else if (dynamic_cast<QQuickItem*>(static_cast<QObject*>(obj))) {
		return new MyQSignalSpy(static_cast<QQuickItem*>(obj), *static_cast<QMetaMethod*>(sign));
	} else if (dynamic_cast<QRadioData*>(static_cast<QObject*>(obj))) {
		return new MyQSignalSpy(static_cast<QRadioData*>(obj), *static_cast<QMetaMethod*>(sign));
	} else if (dynamic_cast<QRemoteObjectPendingCallWatcher*>(static_cast<QObject*>(obj))) {
		return new MyQSignalSpy(static_cast<QRemoteObjectPendingCallWatcher*>(obj), *static_cast<QMetaMethod*>(sign));
	} else if (dynamic_cast<QWidget*>(static_cast<QObject*>(obj))) {
		return new MyQSignalSpy(static_cast<QWidget*>(obj), *static_cast<QMetaMethod*>(sign));
	} else if (dynamic_cast<QWindow*>(static_cast<QObject*>(obj))) {
		return new MyQSignalSpy(static_cast<QWindow*>(obj), *static_cast<QMetaMethod*>(sign));
	} else {
		return new MyQSignalSpy(static_cast<QObject*>(obj), *static_cast<QMetaMethod*>(sign));
	}
}
