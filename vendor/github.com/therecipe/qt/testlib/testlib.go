...
func NewQSignalSpy3(obj core.QObject_ITF, sign core.QMetaMethod_ITF) *QSignalSpy {
	tmpValue := NewQSignalSpyFromPointer(C.QSignalSpy_NewQSignalSpy3(core.PointerFromQObject(obj), core.PointerFromQMetaMethod(sign)))
	if !qt.ExistsSignal(tmpValue.Pointer(), "destroyed") {
		tmpValue.ConnectDestroyed(func(*core.QObject) { tmpValue.SetPointer(nil) })
	}
	return tmpValue
...
func init() {
	...
	qt.FuncMap["testlib.NewQSignalSpy3"] = NewQSignalSpy3
