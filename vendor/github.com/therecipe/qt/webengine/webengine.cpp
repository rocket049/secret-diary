...
char QWebEngineCertificateError_Answered(void* ptr)
{
	return static_cast<QWebEngineCertificateError*>(ptr)->answered();
}

struct QtWebEngine_PackedList QWebEngineCertificateError_CertificateChain(void* ptr)
{
	return ({ QList<QSslCertificate>* tmpValue1e0737 = new QList<QSslCertificate>(static_cast<QWebEngineCertificateError*>(ptr)->certificateChain()); QtWebEngine_PackedList { tmpValue1e0737, tmpValue1e0737->size() }; });
}

void QWebEngineCertificateError_Defer(void* ptr)
{
	static_cast<QWebEngineCertificateError*>(ptr)->defer();
}

char QWebEngineCertificateError_Deferred(void* ptr)
{
	return static_cast<QWebEngineCertificateError*>(ptr)->deferred();
}
...
void QWebEngineCertificateError_IgnoreCertificateError(void* ptr)
{
	static_cast<QWebEngineCertificateError*>(ptr)->ignoreCertificateError();
}
...
void QWebEngineCertificateError_RejectCertificate(void* ptr)
{
	static_cast<QWebEngineCertificateError*>(ptr)->rejectCertificate();
}
...
void* QWebEngineCertificateError___certificateChain_atList(void* ptr, int i)
{
...
void QWebEngineCertificateError___certificateChain_setList(void* ptr, void* i)
{
	static_cast<QList<QSslCertificate>*>(ptr)->append(*static_cast<QSslCertificate*>(i));
}

void* QWebEngineCertificateError___certificateChain_newList(void* ptr)
{
	Q_UNUSED(ptr);
...
void QWebEngineClientCertificateSelection_DestroyQWebEngineClientCertificateSelection(void* ptr)
{
	static_cast<QWebEngineClientCertificateSelection*>(ptr)->~QWebEngineClientCertificateSelection();
}
...
Q_DECLARE_METATYPE(QWebEngineContextMenuData)
Q_DECLARE_METATYPE(QWebEngineContextMenuData*)
...
long long QWebEngineContextMenuData_EditFlags(void* ptr)
{
	return static_cast<QWebEngineContextMenuData*>(ptr)->editFlags();
}
...
{
	return ({ QByteArray* t0eae08 = new QByteArray(static_cast<QWebEngineContextMenuData*>(ptr)->linkText().toUtf8()); QtWebEngine_PackedString { const_cast<char*>(t0eae08->prepend("WHITESPACE").constData()+10), t0eae08->size()-10, t0eae08 }; });
}
...
long long QWebEngineContextMenuData_MediaFlags(void* ptr)
{
	return static_cast<QWebEngineContextMenuData*>(ptr)->mediaFlags();
}
...
{
	return ({ QByteArray* te7ff1f = new QByteArray(static_cast<QWebEngineContextMenuData*>(ptr)->misspelledWord().toUtf8()); QtWebEngine_PackedString { const_cast<char*>(te7ff1f->prepend("WHITESPACE").constData()+10), te7ff1f->size()-10, te7ff1f }; });
}
...
{
	return ({ QByteArray* t9d2c70 = new QByteArray(static_cast<QWebEngineContextMenuData*>(ptr)->selectedText().toUtf8()); QtWebEngine_PackedString { const_cast<char*>(t9d2c70->prepend("WHITESPACE").constData()+10), t9d2c70->size()-10, t9d2c70 }; });
}

struct QtWebEngine_PackedString QWebEngineContextMenuData_SpellCheckerSuggestions(void* ptr)
{
	return ({ QByteArray* tc7c525 = new QByteArray(static_cast<QWebEngineContextMenuData*>(ptr)->spellCheckerSuggestions().join("¡¦!").toUtf8()); QtWebEngine_PackedString { const_cast<char*>(tc7c525->prepend("WHITESPACE").constData()+10), tc7c525->size()-10, tc7c525 }; });
}
...
public:
	...
	void Signal_ObjectNameChanged(const QString & objectName) { QByteArray* taa2c4f = new QByteArray(objectName.toUtf8()); QtWebEngine_PackedString objectNamePacked = { const_cast<char*>(taa2c4f->prepend("WHITESPACE").constData()+10), taa2c4f->size()-10, taa2c4f };callbackQWebEngineDownloadItem_ObjectNameChanged(this, objectNamePacked); };
	void timerEvent(QTimerEvent * event) { callbackQWebEngineDownloadItem_TimerEvent(this, event); };
};

Q_DECLARE_METATYPE(QWebEngineDownloadItem*)
...
struct QtWebEngine_PackedString QWebEngineDownloadItem_DownloadDirectory(void* ptr)
{
	return ({ QByteArray* t75c01d = new QByteArray(static_cast<QWebEngineDownloadItem*>(ptr)->downloadDirectory().toUtf8()); QtWebEngine_PackedString { const_cast<char*>(t75c01d->prepend("WHITESPACE").constData()+10), t75c01d->size()-10, t75c01d }; });
}

struct QtWebEngine_PackedString QWebEngineDownloadItem_DownloadFileName(void* ptr)
{
	return ({ QByteArray* tdd23a5 = new QByteArray(static_cast<QWebEngineDownloadItem*>(ptr)->downloadFileName().toUtf8()); QtWebEngine_PackedString { const_cast<char*>(tdd23a5->prepend("WHITESPACE").constData()+10), tdd23a5->size()-10, tdd23a5 }; });
}

void QWebEngineDownloadItem_ConnectDownloadProgress(void* ptr, long long t)
{
	QObject::connect(static_cast<QWebEngineDownloadItem*>(ptr), static_cast<void (QWebEngineDownloadItem::*)(qint64, qint64)>(&QWebEngineDownloadItem::downloadProgress), static_cast<MyQWebEngineDownloadItem*>(ptr), static_cast<void (MyQWebEngineDownloadItem::*)(qint64, qint64)>(&MyQWebEngineDownloadItem::Signal_DownloadProgress), static_cast<Qt::ConnectionType>(t));
}
...
void QWebEngineDownloadItem_ConnectFinished(void* ptr, long long t)
{
	QObject::connect(static_cast<QWebEngineDownloadItem*>(ptr), static_cast<void (QWebEngineDownloadItem::*)()>(&QWebEngineDownloadItem::finished), static_cast<MyQWebEngineDownloadItem*>(ptr), static_cast<void (MyQWebEngineDownloadItem::*)()>(&MyQWebEngineDownloadItem::Signal_Finished), static_cast<Qt::ConnectionType>(t));
}
...
{
	return ({ QByteArray* t32ab81 = new QByteArray(static_cast<QWebEngineDownloadItem*>(ptr)->interruptReasonString().toUtf8()); QtWebEngine_PackedString { const_cast<char*>(t32ab81->prepend("WHITESPACE").constData()+10), t32ab81->size()-10, t32ab81 }; });
}
...
void QWebEngineDownloadItem_ConnectIsPausedChanged(void* ptr, long long t)
{
	QObject::connect(static_cast<QWebEngineDownloadItem*>(ptr), static_cast<void (QWebEngineDownloadItem::*)(bool)>(&QWebEngineDownloadItem::isPausedChanged), static_cast<MyQWebEngineDownloadItem*>(ptr), static_cast<void (MyQWebEngineDownloadItem::*)(bool)>(&MyQWebEngineDownloadItem::Signal_IsPausedChanged), static_cast<Qt::ConnectionType>(t));
}
...
char QWebEngineDownloadItem_IsSavePageDownload(void* ptr)
{
	return static_cast<QWebEngineDownloadItem*>(ptr)->isSavePageDownload();
}

struct QtWebEngine_PackedString QWebEngineDownloadItem_MimeType(void* ptr)
{
	return ({ QByteArray* t158c86 = new QByteArray(static_cast<QWebEngineDownloadItem*>(ptr)->mimeType().toUtf8()); QtWebEngine_PackedString { const_cast<char*>(t158c86->prepend("WHITESPACE").constData()+10), t158c86->size()-10, t158c86 }; });
}

void* QWebEngineDownloadItem_Page(void* ptr)
{
	return static_cast<QWebEngineDownloadItem*>(ptr)->page();
}
...
void QWebEngineDownloadItem_SetDownloadDirectory(void* ptr, struct QtWebEngine_PackedString directory)
{
	static_cast<QWebEngineDownloadItem*>(ptr)->setDownloadDirectory(QString::fromUtf8(directory.data, directory.len));
}

void QWebEngineDownloadItem_SetDownloadFileName(void* ptr, struct QtWebEngine_PackedString fileName)
{
	static_cast<QWebEngineDownloadItem*>(ptr)->setDownloadFileName(QString::fromUtf8(fileName.data, fileName.len));
}
...
void QWebEngineDownloadItem_ConnectStateChanged(void* ptr, long long t)
{
	qRegisterMetaType<QWebEngineDownloadItem::DownloadState>();
	QObject::connect(static_cast<QWebEngineDownloadItem*>(ptr), static_cast<void (QWebEngineDownloadItem::*)(QWebEngineDownloadItem::DownloadState)>(&QWebEngineDownloadItem::stateChanged), static_cast<MyQWebEngineDownloadItem*>(ptr), static_cast<void (MyQWebEngineDownloadItem::*)(QWebEngineDownloadItem::DownloadState)>(&MyQWebEngineDownloadItem::Signal_StateChanged), static_cast<Qt::ConnectionType>(t));
}
...
struct QtWebEngine_PackedString QWebEngineDownloadItem_SuggestedFileName(void* ptr)
{
	return ({ QByteArray* t31ee7f = new QByteArray(static_cast<QWebEngineDownloadItem*>(ptr)->suggestedFileName().toUtf8()); QtWebEngine_PackedString { const_cast<char*>(t31ee7f->prepend("WHITESPACE").constData()+10), t31ee7f->size()-10, t31ee7f }; });
}
...
int QWebEngineFindTextResult_ActiveMatch(void* ptr)
{
	return static_cast<QWebEngineFindTextResult*>(ptr)->activeMatch();
}

int QWebEngineFindTextResult_NumberOfMatches(void* ptr)
{
	return static_cast<QWebEngineFindTextResult*>(ptr)->numberOfMatches();
}
...
{
	return ({ QList<QWebEngineHistoryItem>* tmpValue4e0541 = new QList<QWebEngineHistoryItem>(static_cast<QWebEngineHistory*>(ptr)->backItems(maxItems)); QtWebEngine_PackedList { tmpValue4e0541, tmpValue4e0541->size() }; });
}
...
{
	return ({ QList<QWebEngineHistoryItem>* tmpValue6b6d0b = new QList<QWebEngineHistoryItem>(static_cast<QWebEngineHistory*>(ptr)->forwardItems(maxItems)); QtWebEngine_PackedList { tmpValue6b6d0b, tmpValue6b6d0b->size() }; });
}
...
{
	return ({ QList<QWebEngineHistoryItem>* tmpValue2e1b36 = new QList<QWebEngineHistoryItem>(static_cast<QWebEngineHistory*>(ptr)->items()); QtWebEngine_PackedList { tmpValue2e1b36, tmpValue2e1b36->size() }; });
}
...
Q_DECLARE_METATYPE(QWebEngineHistoryItem*)
...
{
	return ({ QByteArray* tda127c = new QByteArray(static_cast<QWebEngineHistoryItem*>(ptr)->title().toUtf8()); QtWebEngine_PackedString { const_cast<char*>(tda127c->prepend("WHITESPACE").constData()+10), tda127c->size()-10, tda127c }; });
}
...
public:
	...
	bool acceptNavigationRequest(const QUrl & url, QWebEnginePage::NavigationType ty, bool isMainFrame) { return callbackQWebEnginePage_AcceptNavigationRequest(this, const_cast<QUrl*>(&url), static_cast<qint64>(ty), isMainFrame) != 0; };
	...
	QStringList chooseFiles(QWebEnginePage::FileSelectionMode mode, const QStringList & oldFiles, const QStringList & acceptedMimeTypes) { QByteArray* t76015f = new QByteArray(oldFiles.join("¡¦!").toUtf8()); QtWebEngine_PackedString oldFilesPacked = { const_cast<char*>(t76015f->prepend("WHITESPACE").constData()+10), t76015f->size()-10, t76015f };QByteArray* t541092 = new QByteArray(acceptedMimeTypes.join("¡¦!").toUtf8()); QtWebEngine_PackedString acceptedMimeTypesPacked = { const_cast<char*>(t541092->prepend("WHITESPACE").constData()+10), t541092->size()-10, t541092 };return ({ QtWebEngine_PackedString tempVal = callbackQWebEnginePage_ChooseFiles(this, static_cast<qint64>(mode), oldFilesPacked, acceptedMimeTypesPacked); QStringList ret = QString::fromUtf8(tempVal.data, tempVal.len).split("¡¦!", QString::SkipEmptyParts); free(tempVal.data); ret; }); };
	void Signal_ContentsSizeChanged(const QSizeF & size) { callbackQWebEnginePage_ContentsSizeChanged(this, const_cast<QSizeF*>(&size)); };
	QWebEnginePage * createWindow(QWebEnginePage::WebWindowType ty) { return static_cast<QWebEnginePage*>(callbackQWebEnginePage_CreateWindow(this, static_cast<qint64>(ty))); };
	bool event(QEvent * e) { return callbackQWebEnginePage_Event(this, e) != 0; };
	void Signal_FeaturePermissionRequestCanceled(const QUrl & securityOrigin, QWebEnginePage::Feature feature) { callbackQWebEnginePage_FeaturePermissionRequestCanceled(this, const_cast<QUrl*>(&securityOrigin), static_cast<qint64>(feature)); };
	void Signal_FeaturePermissionRequested(const QUrl & securityOrigin, QWebEnginePage::Feature feature) { callbackQWebEnginePage_FeaturePermissionRequested(this, const_cast<QUrl*>(&securityOrigin), static_cast<qint64>(feature)); };
	void Signal_FindTextFinished(const QWebEngineFindTextResult & result) { callbackQWebEnginePage_FindTextFinished(this, const_cast<QWebEngineFindTextResult*>(&result)); };
	...
	void javaScriptConsoleMessage(QWebEnginePage::JavaScriptConsoleMessageLevel level, const QString & message, int lineNumber, const QString & sourceID) { QByteArray* t6f9b9a = new QByteArray(message.toUtf8()); QtWebEngine_PackedString messagePacked = { const_cast<char*>(t6f9b9a->prepend("WHITESPACE").constData()+10), t6f9b9a->size()-10, t6f9b9a };QByteArray* tf767e3 = new QByteArray(sourceID.toUtf8()); QtWebEngine_PackedString sourceIDPacked = { const_cast<char*>(tf767e3->prepend("WHITESPACE").constData()+10), tf767e3->size()-10, tf767e3 };callbackQWebEnginePage_JavaScriptConsoleMessage(this, static_cast<qint64>(level), messagePacked, lineNumber, sourceIDPacked); };
	...
	void Signal_LifecycleStateChanged(QWebEnginePage::LifecycleState state) { callbackQWebEnginePage_LifecycleStateChanged(this, static_cast<qint64>(state)); };
	...
	void Signal_RecommendedStateChanged(QWebEnginePage::LifecycleState state) { callbackQWebEnginePage_RecommendedStateChanged(this, static_cast<qint64>(state)); };
	void Signal_RenderProcessPidChanged(qint64 pid) { callbackQWebEnginePage_RenderProcessPidChanged(this, pid); };
	void Signal_RenderProcessTerminated(QWebEnginePage::RenderProcessTerminationStatus terminationStatus, int exitCode) { callbackQWebEnginePage_RenderProcessTerminated(this, static_cast<qint64>(terminationStatus), exitCode); };
	...
	void Signal_SelectClientCertificate(QWebEngineClientCertificateSelection clientCertificateSelection) { callbackQWebEnginePage_SelectClientCertificate(this, new QWebEngineClientCertificateSelection(clientCertificateSelection)); };
	...
	void triggerAction(QWebEnginePage::WebAction action, bool checked) { callbackQWebEnginePage_TriggerAction(this, static_cast<qint64>(action), checked); };
	void Signal_UrlChanged(const QUrl & url) { callbackQWebEnginePage_UrlChanged(this, const_cast<QUrl*>(&url)); };
	void Signal_VisibleChanged(bool visible) { callbackQWebEnginePage_VisibleChanged(this, visible); };
...
void QWebEnginePage_ConnectFindTextFinished(void* ptr, long long t)
{
	QObject::connect(static_cast<QWebEnginePage*>(ptr), static_cast<void (QWebEnginePage::*)(const QWebEngineFindTextResult &)>(&QWebEnginePage::findTextFinished), static_cast<MyQWebEnginePage*>(ptr), static_cast<void (MyQWebEnginePage::*)(const QWebEngineFindTextResult &)>(&MyQWebEnginePage::Signal_FindTextFinished), static_cast<Qt::ConnectionType>(t));
}

void QWebEnginePage_DisconnectFindTextFinished(void* ptr)
{
	QObject::disconnect(static_cast<QWebEnginePage*>(ptr), static_cast<void (QWebEnginePage::*)(const QWebEngineFindTextResult &)>(&QWebEnginePage::findTextFinished), static_cast<MyQWebEnginePage*>(ptr), static_cast<void (MyQWebEnginePage::*)(const QWebEngineFindTextResult &)>(&MyQWebEnginePage::Signal_FindTextFinished));
}

void QWebEnginePage_FindTextFinished(void* ptr, void* result)
{
	static_cast<QWebEnginePage*>(ptr)->findTextFinished(*static_cast<QWebEngineFindTextResult*>(result));
}
...
char QWebEnginePage_IsVisible(void* ptr)
{
	return static_cast<QWebEnginePage*>(ptr)->isVisible();
}
...
long long QWebEnginePage_LifecycleState(void* ptr)
{
	return static_cast<qint64>(static_cast<QWebEnginePage*>(ptr)->lifecycleState());
}

void QWebEnginePage_ConnectLifecycleStateChanged(void* ptr, long long t)
{
	qRegisterMetaType<QWebEnginePage::LifecycleState>();
	QObject::connect(static_cast<QWebEnginePage*>(ptr), static_cast<void (QWebEnginePage::*)(QWebEnginePage::LifecycleState)>(&QWebEnginePage::lifecycleStateChanged), static_cast<MyQWebEnginePage*>(ptr), static_cast<void (MyQWebEnginePage::*)(QWebEnginePage::LifecycleState)>(&MyQWebEnginePage::Signal_LifecycleStateChanged), static_cast<Qt::ConnectionType>(t));
}

void QWebEnginePage_DisconnectLifecycleStateChanged(void* ptr)
{
	QObject::disconnect(static_cast<QWebEnginePage*>(ptr), static_cast<void (QWebEnginePage::*)(QWebEnginePage::LifecycleState)>(&QWebEnginePage::lifecycleStateChanged), static_cast<MyQWebEnginePage*>(ptr), static_cast<void (MyQWebEnginePage::*)(QWebEnginePage::LifecycleState)>(&MyQWebEnginePage::Signal_LifecycleStateChanged));
}

void QWebEnginePage_LifecycleStateChanged(void* ptr, long long state)
{
	static_cast<QWebEnginePage*>(ptr)->lifecycleStateChanged(static_cast<QWebEnginePage::LifecycleState>(state));
}
...
long long QWebEnginePage_RecommendedState(void* ptr)
{
	return static_cast<qint64>(static_cast<QWebEnginePage*>(ptr)->recommendedState());
}

void QWebEnginePage_ConnectRecommendedStateChanged(void* ptr, long long t)
{
	qRegisterMetaType<QWebEnginePage::LifecycleState>();
	QObject::connect(static_cast<QWebEnginePage*>(ptr), static_cast<void (QWebEnginePage::*)(QWebEnginePage::LifecycleState)>(&QWebEnginePage::recommendedStateChanged), static_cast<MyQWebEnginePage*>(ptr), static_cast<void (MyQWebEnginePage::*)(QWebEnginePage::LifecycleState)>(&MyQWebEnginePage::Signal_RecommendedStateChanged), static_cast<Qt::ConnectionType>(t));
}

void QWebEnginePage_DisconnectRecommendedStateChanged(void* ptr)
{
	QObject::disconnect(static_cast<QWebEnginePage*>(ptr), static_cast<void (QWebEnginePage::*)(QWebEnginePage::LifecycleState)>(&QWebEnginePage::recommendedStateChanged), static_cast<MyQWebEnginePage*>(ptr), static_cast<void (MyQWebEnginePage::*)(QWebEnginePage::LifecycleState)>(&MyQWebEnginePage::Signal_RecommendedStateChanged));
}

void QWebEnginePage_RecommendedStateChanged(void* ptr, long long state)
{
	static_cast<QWebEnginePage*>(ptr)->recommendedStateChanged(static_cast<QWebEnginePage::LifecycleState>(state));
}

long long QWebEnginePage_RenderProcessPid(void* ptr)
{
	return static_cast<QWebEnginePage*>(ptr)->renderProcessPid();
}

void QWebEnginePage_ConnectRenderProcessPidChanged(void* ptr, long long t)
{
	QObject::connect(static_cast<QWebEnginePage*>(ptr), static_cast<void (QWebEnginePage::*)(qint64)>(&QWebEnginePage::renderProcessPidChanged), static_cast<MyQWebEnginePage*>(ptr), static_cast<void (MyQWebEnginePage::*)(qint64)>(&MyQWebEnginePage::Signal_RenderProcessPidChanged), static_cast<Qt::ConnectionType>(t));
}

void QWebEnginePage_DisconnectRenderProcessPidChanged(void* ptr)
{
	QObject::disconnect(static_cast<QWebEnginePage*>(ptr), static_cast<void (QWebEnginePage::*)(qint64)>(&QWebEnginePage::renderProcessPidChanged), static_cast<MyQWebEnginePage*>(ptr), static_cast<void (MyQWebEnginePage::*)(qint64)>(&MyQWebEnginePage::Signal_RenderProcessPidChanged));
}

void QWebEnginePage_RenderProcessPidChanged(void* ptr, long long pid)
{
	static_cast<QWebEnginePage*>(ptr)->renderProcessPidChanged(pid);
}

void QWebEnginePage_ConnectRenderProcessTerminated(void* ptr, long long t)
{
	QObject::connect(static_cast<QWebEnginePage*>(ptr), static_cast<void (QWebEnginePage::*)(QWebEnginePage::RenderProcessTerminationStatus, int)>(&QWebEnginePage::renderProcessTerminated), static_cast<MyQWebEnginePage*>(ptr), static_cast<void (MyQWebEnginePage::*)(QWebEnginePage::RenderProcessTerminationStatus, int)>(&MyQWebEnginePage::Signal_RenderProcessTerminated), static_cast<Qt::ConnectionType>(t));
}
...
void QWebEnginePage_SelectClientCertificate(void* ptr, void* clientCertificateSelection)
{
	static_cast<QWebEnginePage*>(ptr)->selectClientCertificate(*static_cast<QWebEngineClientCertificateSelection*>(clientCertificateSelection));
}
...
void QWebEnginePage_SetDevToolsPage(void* ptr, void* devToolsPage)
{
	static_cast<QWebEnginePage*>(ptr)->setDevToolsPage(static_cast<QWebEnginePage*>(devToolsPage));
}
...
void QWebEnginePage_SetLifecycleState(void* ptr, long long state)
{
	static_cast<QWebEnginePage*>(ptr)->setLifecycleState(static_cast<QWebEnginePage::LifecycleState>(state));
}
...
void QWebEnginePage_SetVisible(void* ptr, char visible)
{
	static_cast<QWebEnginePage*>(ptr)->setVisible(visible != 0);
}
...
void QWebEnginePage_ConnectVisibleChanged(void* ptr, long long t)
{
	QObject::connect(static_cast<QWebEnginePage*>(ptr), static_cast<void (QWebEnginePage::*)(bool)>(&QWebEnginePage::visibleChanged), static_cast<MyQWebEnginePage*>(ptr), static_cast<void (MyQWebEnginePage::*)(bool)>(&MyQWebEnginePage::Signal_VisibleChanged), static_cast<Qt::ConnectionType>(t));
}

void QWebEnginePage_DisconnectVisibleChanged(void* ptr)
{
	QObject::disconnect(static_cast<QWebEnginePage*>(ptr), static_cast<void (QWebEnginePage::*)(bool)>(&QWebEnginePage::visibleChanged), static_cast<MyQWebEnginePage*>(ptr), static_cast<void (MyQWebEnginePage::*)(bool)>(&MyQWebEnginePage::Signal_VisibleChanged));
}

void QWebEnginePage_VisibleChanged(void* ptr, char visible)
{
	static_cast<QWebEnginePage*>(ptr)->visibleChanged(visible != 0);
}
...
void* QWebEngineProfile_NewQWebEngineProfile2(struct QtWebEngine_PackedString storageName, void* parent)
{
	if (dynamic_cast<QCameraImageCapture*>(static_cast<QObject*>(parent))) {
		...
		return new MyQWebEngineProfile(QString::fromUtf8(storageName.data, storageName.len), static_cast<QRemoteObjectPendingCallWatcher*>(parent));
	} else if (dynamic_cast<QWidget*>(static_cast<QObject*>(parent))) {
...
void QWebEngineProfile_ConnectDownloadRequested(void* ptr, long long t)
{
	QObject::connect(static_cast<QWebEngineProfile*>(ptr), static_cast<void (QWebEngineProfile::*)(QWebEngineDownloadItem *)>(&QWebEngineProfile::downloadRequested), static_cast<MyQWebEngineProfile*>(ptr), static_cast<void (MyQWebEngineProfile::*)(QWebEngineDownloadItem *)>(&MyQWebEngineProfile::Signal_DownloadRequested), static_cast<Qt::ConnectionType>(t));
}
...
{
	return ({ QByteArray* te185e9 = new QByteArray(static_cast<QWebEngineScript*>(ptr)->name().toUtf8()); QtWebEngine_PackedString { const_cast<char*>(te185e9->prepend("WHITESPACE").constData()+10), te185e9->size()-10, te185e9 }; });
}
...
{
	return ({ QByteArray* t7bcb57 = new QByteArray(static_cast<QWebEngineScript*>(ptr)->sourceCode().toUtf8()); QtWebEngine_PackedString { const_cast<char*>(t7bcb57->prepend("WHITESPACE").constData()+10), t7bcb57->size()-10, t7bcb57 }; });
}
...
void* QWebEngineUrlRequestInfo_Initiator(void* ptr)
{
	return new QUrl(static_cast<QWebEngineUrlRequestInfo*>(ptr)->initiator());
}
...
{
public:
	MyQWebEngineUrlRequestInterceptor(QObject *p = 0) : QWebEngineUrlRequestInterceptor(p) {QWebEngineUrlRequestInterceptor_QWebEngineUrlRequestInterceptor_QRegisterMetaType();};
