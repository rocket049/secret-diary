...
const (
	...
	QWebEngineCertificateError__CertificateKnownInterceptionBlocked QWebEngineCertificateError__Error = QWebEngineCertificateError__Error(-217)
)

func (ptr *QWebEngineCertificateError) Answered() bool {
	if ptr.Pointer() != nil {
		return int8(C.QWebEngineCertificateError_Answered(ptr.Pointer())) != 0
	}
	return false
}

func (ptr *QWebEngineCertificateError) CertificateChain() []*network.QSslCertificate {
	if ptr.Pointer() != nil {
		return func(l C.struct_QtWebEngine_PackedList) []*network.QSslCertificate {
			out := make([]*network.QSslCertificate, int(l.len))
			tmpList := NewQWebEngineCertificateErrorFromPointer(l.data)
			for i := 0; i < len(out); i++ {
				out[i] = tmpList.__certificateChain_atList(i)
			}
			return out
		}(C.QWebEngineCertificateError_CertificateChain(ptr.Pointer()))
	}
	return make([]*network.QSslCertificate, 0)
}

func (ptr *QWebEngineCertificateError) Defer() {
	if ptr.Pointer() != nil {
		C.QWebEngineCertificateError_Defer(ptr.Pointer())
	}
}

func (ptr *QWebEngineCertificateError) Deferred() bool {
	if ptr.Pointer() != nil {
		return int8(C.QWebEngineCertificateError_Deferred(ptr.Pointer())) != 0
	}
	return false
}
...
func (ptr *QWebEngineCertificateError) IgnoreCertificateError() {
	if ptr.Pointer() != nil {
		C.QWebEngineCertificateError_IgnoreCertificateError(ptr.Pointer())
	}
}
...
func (ptr *QWebEngineCertificateError) RejectCertificate() {
	if ptr.Pointer() != nil {
		C.QWebEngineCertificateError_RejectCertificate(ptr.Pointer())
	}
}
...
func (ptr *QWebEngineCertificateError) __certificateChain_atList(i int) *network.QSslCertificate {
	if ptr.Pointer() != nil {
		tmpValue := network.NewQSslCertificateFromPointer(C.QWebEngineCertificateError___certificateChain_atList(ptr.Pointer(), C.int(int32(i))))
...
func (ptr *QWebEngineCertificateError) __certificateChain_setList(i network.QSslCertificate_ITF) {
	if ptr.Pointer() != nil {
		C.QWebEngineCertificateError___certificateChain_setList(ptr.Pointer(), network.PointerFromQSslCertificate(i))
	}
}

func (ptr *QWebEngineCertificateError) __certificateChain_newList() unsafe.Pointer {
	return C.QWebEngineCertificateError___certificateChain_newList(ptr.Pointer())
}
...
func (ptr *QWebEngineClientCertificateSelection) DestroyQWebEngineClientCertificateSelection() {
	if ptr.Pointer() != nil {
		...
		qt.SetFinalizer(ptr, nil)
		C.QWebEngineClientCertificateSelection_DestroyQWebEngineClientCertificateSelection(ptr.Pointer())
		C.free(ptr.Pointer())
		ptr.SetPointer(nil)
	}
}
...
//go:generate stringer -type=QWebEngineContextMenuData__EditFlag
//QWebEngineContextMenuData::EditFlag
type QWebEngineContextMenuData__EditFlag int64

const (
	QWebEngineContextMenuData__CanUndo       QWebEngineContextMenuData__EditFlag = QWebEngineContextMenuData__EditFlag(0x1)
	QWebEngineContextMenuData__CanRedo       QWebEngineContextMenuData__EditFlag = QWebEngineContextMenuData__EditFlag(0x2)
	QWebEngineContextMenuData__CanCut        QWebEngineContextMenuData__EditFlag = QWebEngineContextMenuData__EditFlag(0x4)
	QWebEngineContextMenuData__CanCopy       QWebEngineContextMenuData__EditFlag = QWebEngineContextMenuData__EditFlag(0x8)
	QWebEngineContextMenuData__CanPaste      QWebEngineContextMenuData__EditFlag = QWebEngineContextMenuData__EditFlag(0x10)
	QWebEngineContextMenuData__CanDelete     QWebEngineContextMenuData__EditFlag = QWebEngineContextMenuData__EditFlag(0x20)
	QWebEngineContextMenuData__CanSelectAll  QWebEngineContextMenuData__EditFlag = QWebEngineContextMenuData__EditFlag(0x40)
	QWebEngineContextMenuData__CanTranslate  QWebEngineContextMenuData__EditFlag = QWebEngineContextMenuData__EditFlag(0x80)
	QWebEngineContextMenuData__CanEditRichly QWebEngineContextMenuData__EditFlag = QWebEngineContextMenuData__EditFlag(0x100)
)

//go:generate stringer -type=QWebEngineContextMenuData__MediaFlag
//QWebEngineContextMenuData::MediaFlag
type QWebEngineContextMenuData__MediaFlag int64

const (
	QWebEngineContextMenuData__MediaInError           QWebEngineContextMenuData__MediaFlag = QWebEngineContextMenuData__MediaFlag(0x1)
	QWebEngineContextMenuData__MediaPaused            QWebEngineContextMenuData__MediaFlag = QWebEngineContextMenuData__MediaFlag(0x2)
	QWebEngineContextMenuData__MediaMuted             QWebEngineContextMenuData__MediaFlag = QWebEngineContextMenuData__MediaFlag(0x4)
	QWebEngineContextMenuData__MediaLoop              QWebEngineContextMenuData__MediaFlag = QWebEngineContextMenuData__MediaFlag(0x8)
	QWebEngineContextMenuData__MediaCanSave           QWebEngineContextMenuData__MediaFlag = QWebEngineContextMenuData__MediaFlag(0x10)
	QWebEngineContextMenuData__MediaHasAudio          QWebEngineContextMenuData__MediaFlag = QWebEngineContextMenuData__MediaFlag(0x20)
	QWebEngineContextMenuData__MediaCanToggleControls QWebEngineContextMenuData__MediaFlag = QWebEngineContextMenuData__MediaFlag(0x40)
	QWebEngineContextMenuData__MediaControls          QWebEngineContextMenuData__MediaFlag = QWebEngineContextMenuData__MediaFlag(0x80)
	QWebEngineContextMenuData__MediaCanPrint          QWebEngineContextMenuData__MediaFlag = QWebEngineContextMenuData__MediaFlag(0x100)
	QWebEngineContextMenuData__MediaCanRotate         QWebEngineContextMenuData__MediaFlag = QWebEngineContextMenuData__MediaFlag(0x200)
)
...
func NewQWebEngineContextMenuData() *QWebEngineContextMenuData {
	...
	qt.SetFinalizer(tmpValue, (*QWebEngineContextMenuData).DestroyQWebEngineContextMenuData)
	return tmpValue
}
...
func (ptr *QWebEngineContextMenuData) EditFlags() QWebEngineContextMenuData__EditFlag {
	if ptr.Pointer() != nil {
		return QWebEngineContextMenuData__EditFlag(C.QWebEngineContextMenuData_EditFlags(ptr.Pointer()))
	}
	return 0
}
...
func (ptr *QWebEngineContextMenuData) IsContentEditable() bool {
	if ptr.Pointer() != nil {
		return int8(C.QWebEngineContextMenuData_IsContentEditable(ptr.Pointer())) != 0
	}
	return false
}
...
func (ptr *QWebEngineContextMenuData) IsValid() bool {
	if ptr.Pointer() != nil {
		return int8(C.QWebEngineContextMenuData_IsValid(ptr.Pointer())) != 0
	}
	return false
}
...
func (ptr *QWebEngineContextMenuData) MediaFlags() QWebEngineContextMenuData__MediaFlag {
	if ptr.Pointer() != nil {
		return QWebEngineContextMenuData__MediaFlag(C.QWebEngineContextMenuData_MediaFlags(ptr.Pointer()))
	}
	return 0
}
...
func (ptr *QWebEngineContextMenuData) SpellCheckerSuggestions() []string {
	if ptr.Pointer() != nil {
		return unpackStringList(cGoUnpackString(C.QWebEngineContextMenuData_SpellCheckerSuggestions(ptr.Pointer())))
	}
	return make([]string, 0)
}
...
func (ptr *QWebEngineDownloadItem) DownloadDirectory() string {
	if ptr.Pointer() != nil {
		return cGoUnpackString(C.QWebEngineDownloadItem_DownloadDirectory(ptr.Pointer()))
	}
	return ""
}

func (ptr *QWebEngineDownloadItem) DownloadFileName() string {
	if ptr.Pointer() != nil {
		return cGoUnpackString(C.QWebEngineDownloadItem_DownloadFileName(ptr.Pointer()))
	}
	return ""
}
...
func (ptr *QWebEngineDownloadItem) ConnectDownloadProgress(f func(bytesReceived int64, bytesTotal int64)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "downloadProgress") {
			C.QWebEngineDownloadItem_ConnectDownloadProgress(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "downloadProgress")))
		}
...
func (ptr *QWebEngineDownloadItem) ConnectFinished(f func()) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "finished") {
			C.QWebEngineDownloadItem_ConnectFinished(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "finished")))
		}
...
func (ptr *QWebEngineDownloadItem) IsFinished() bool {
	if ptr.Pointer() != nil {
		return int8(C.QWebEngineDownloadItem_IsFinished(ptr.Pointer())) != 0
	}
	return false
}
...
func (ptr *QWebEngineDownloadItem) IsPaused() bool {
	if ptr.Pointer() != nil {
		return int8(C.QWebEngineDownloadItem_IsPaused(ptr.Pointer())) != 0
	}
	return false
}
...
func callbackQWebEngineDownloadItem_IsPausedChanged(ptr unsafe.Pointer, isPaused C.char) {
	if signal := qt.GetSignal(ptr, "isPausedChanged"); signal != nil {
		(*(*func(bool))(signal))(int8(isPaused) != 0)
	}
...
func (ptr *QWebEngineDownloadItem) ConnectIsPausedChanged(f func(isPaused bool)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "isPausedChanged") {
			C.QWebEngineDownloadItem_ConnectIsPausedChanged(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "isPausedChanged")))
		}

		if signal := qt.LendSignal(ptr.Pointer(), "isPausedChanged"); signal != nil {
			f := func(isPaused bool) {
				(*(*func(bool))(signal))(isPaused)
				f(isPaused)
			}
			qt.ConnectSignal(ptr.Pointer(), "isPausedChanged", unsafe.Pointer(&f))
		} else {
			qt.ConnectSignal(ptr.Pointer(), "isPausedChanged", unsafe.Pointer(&f))
		}
	}
...
func (ptr *QWebEngineDownloadItem) IsSavePageDownload() bool {
	if ptr.Pointer() != nil {
		return int8(C.QWebEngineDownloadItem_IsSavePageDownload(ptr.Pointer())) != 0
	}
	return false
}
...
func (ptr *QWebEngineDownloadItem) Page() *QWebEnginePage {
	if ptr.Pointer() != nil {
		tmpValue := NewQWebEnginePageFromPointer(C.QWebEngineDownloadItem_Page(ptr.Pointer()))
		if !qt.ExistsSignal(tmpValue.Pointer(), "destroyed") {
			tmpValue.ConnectDestroyed(func(*core.QObject) { tmpValue.SetPointer(nil) })
		}
		return tmpValue
...
func (ptr *QWebEngineDownloadItem) SetDownloadDirectory(directory string) {
	if ptr.Pointer() != nil {
		...
		C.QWebEngineDownloadItem_SetDownloadDirectory(ptr.Pointer(), C.struct_QtWebEngine_PackedString{data: directoryC, len: C.longlong(len(directory))})
	}
}

func (ptr *QWebEngineDownloadItem) SetDownloadFileName(fileName string) {
	if ptr.Pointer() != nil {
		...
		C.QWebEngineDownloadItem_SetDownloadFileName(ptr.Pointer(), C.struct_QtWebEngine_PackedString{data: fileNameC, len: C.longlong(len(fileName))})
	}
}
...
func callbackQWebEngineDownloadItem_StateChanged(ptr unsafe.Pointer, state C.longlong) {
	if signal := qt.GetSignal(ptr, "stateChanged"); signal != nil {
		(*(*func(QWebEngineDownloadItem__DownloadState))(signal))(QWebEngineDownloadItem__DownloadState(state))
	}
...
func (ptr *QWebEngineDownloadItem) ConnectStateChanged(f func(state QWebEngineDownloadItem__DownloadState)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "stateChanged") {
			C.QWebEngineDownloadItem_ConnectStateChanged(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "stateChanged")))
		}

		if signal := qt.LendSignal(ptr.Pointer(), "stateChanged"); signal != nil {
			f := func(state QWebEngineDownloadItem__DownloadState) {
				(*(*func(QWebEngineDownloadItem__DownloadState))(signal))(state)
				f(state)
			}
...
func (ptr *QWebEngineDownloadItem) SuggestedFileName() string {
	if ptr.Pointer() != nil {
		return cGoUnpackString(C.QWebEngineDownloadItem_SuggestedFileName(ptr.Pointer()))
	}
	return ""
}
...
func (ptr *QWebEngineDownloadItem) EventDefault(e core.QEvent_ITF) bool {
	if ptr.Pointer() != nil {
		return int8(C.QWebEngineDownloadItem_EventDefault(ptr.Pointer(), core.PointerFromQEvent(e))) != 0
	}
	return false
}
...
func (ptr *QWebEngineDownloadItem) EventFilterDefault(watched core.QObject_ITF, event core.QEvent_ITF) bool {
	if ptr.Pointer() != nil {
		return int8(C.QWebEngineDownloadItem_EventFilterDefault(ptr.Pointer(), core.PointerFromQObject(watched), core.PointerFromQEvent(event))) != 0
	}
	return false
}
...
type QWebEngineFindTextResult_ITF interface {
	QWebEngineFindTextResult_PTR() *QWebEngineFindTextResult
}

func (ptr *QWebEngineFindTextResult) QWebEngineFindTextResult_PTR() *QWebEngineFindTextResult {
	return ptr
}

func (ptr *QWebEngineFindTextResult) Pointer() unsafe.Pointer {
	if ptr != nil {
		return ptr.ptr
	}
	return nil
...
func (ptr *QWebEngineFindTextResult) SetPointer(p unsafe.Pointer) {
	if ptr != nil {
		ptr.ptr = p
	}
}

func PointerFromQWebEngineFindTextResult(ptr QWebEngineFindTextResult_ITF) unsafe.Pointer {
	if ptr != nil {
		return ptr.QWebEngineFindTextResult_PTR().Pointer()
	}
	return nil
}

func NewQWebEngineFindTextResultFromPointer(ptr unsafe.Pointer) (n *QWebEngineFindTextResult) {
	n = new(QWebEngineFindTextResult)
	n.SetPointer(ptr)
	return
}
func (ptr *QWebEngineFindTextResult) DestroyQWebEngineFindTextResult() {
	if ptr != nil {
		qt.SetFinalizer(ptr, nil)
...
func (ptr *QWebEngineFindTextResult) ActiveMatch() int {
	if ptr.Pointer() != nil {
		return int(int32(C.QWebEngineFindTextResult_ActiveMatch(ptr.Pointer())))
	}
	return 0
}

func (ptr *QWebEngineFindTextResult) NumberOfMatches() int {
	if ptr.Pointer() != nil {
		return int(int32(C.QWebEngineFindTextResult_NumberOfMatches(ptr.Pointer())))
	}
	return 0
}
...
func (ptr *QWebEngineFullScreenRequest) ToggleOn() bool {
	if ptr.Pointer() != nil {
		return int8(C.QWebEngineFullScreenRequest_ToggleOn(ptr.Pointer())) != 0
	}
	return false
}
...
func (ptr *QWebEngineHistory) BackItem() *QWebEngineHistoryItem {
	if ptr.Pointer() != nil {
		...
		qt.SetFinalizer(tmpValue, (*QWebEngineHistoryItem).DestroyQWebEngineHistoryItem)
		return tmpValue
	}
	return nil
}
...
func (ptr *QWebEngineHistory) CanGoBack() bool {
	if ptr.Pointer() != nil {
		return int8(C.QWebEngineHistory_CanGoBack(ptr.Pointer())) != 0
	}
	return false
}
...
func (ptr *QWebEngineHistory) CanGoForward() bool {
	if ptr.Pointer() != nil {
		return int8(C.QWebEngineHistory_CanGoForward(ptr.Pointer())) != 0
	}
	return false
}
...
func (ptr *QWebEngineHistoryItem) IsValid() bool {
	if ptr.Pointer() != nil {
		return int8(C.QWebEngineHistoryItem_IsValid(ptr.Pointer())) != 0
	}
	return false
}
...
//go:generate stringer -type=QWebEnginePage__LifecycleState
//QWebEnginePage::LifecycleState
type QWebEnginePage__LifecycleState int64

const (
	QWebEnginePage__Active    QWebEnginePage__LifecycleState = QWebEnginePage__LifecycleState(0)
	QWebEnginePage__Frozen    QWebEnginePage__LifecycleState = QWebEnginePage__LifecycleState(1)
	QWebEnginePage__Discarded QWebEnginePage__LifecycleState = QWebEnginePage__LifecycleState(2)
)
...
const (
	...
	QWebEnginePage__NavigationTypeRedirect      QWebEnginePage__NavigationType = QWebEnginePage__NavigationType(6)
)
...
//export callbackQWebEnginePage_FindTextFinished
func callbackQWebEnginePage_FindTextFinished(ptr unsafe.Pointer, result unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "findTextFinished"); signal != nil {
		(*(*func(*QWebEngineFindTextResult))(signal))(NewQWebEngineFindTextResultFromPointer(result))
	}

}

func (ptr *QWebEnginePage) ConnectFindTextFinished(f func(result *QWebEngineFindTextResult)) {
	if ptr.Pointer() != nil {

		if !qt.ExistsSignal(ptr.Pointer(), "findTextFinished") {
			C.QWebEnginePage_ConnectFindTextFinished(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "findTextFinished")))
		}

		if signal := qt.LendSignal(ptr.Pointer(), "findTextFinished"); signal != nil {
			f := func(result *QWebEngineFindTextResult) {
				(*(*func(*QWebEngineFindTextResult))(signal))(result)
				f(result)
			}
			qt.ConnectSignal(ptr.Pointer(), "findTextFinished", unsafe.Pointer(&f))
		} else {
			qt.ConnectSignal(ptr.Pointer(), "findTextFinished", unsafe.Pointer(&f))
		}
	}
...
func (ptr *QWebEnginePage) DisconnectFindTextFinished() {
	if ptr.Pointer() != nil {
		C.QWebEnginePage_DisconnectFindTextFinished(ptr.Pointer())
		qt.DisconnectSignal(ptr.Pointer(), "findTextFinished")
	}
}

func (ptr *QWebEnginePage) FindTextFinished(result QWebEngineFindTextResult_ITF) {
	if ptr.Pointer() != nil {
		C.QWebEnginePage_FindTextFinished(ptr.Pointer(), PointerFromQWebEngineFindTextResult(result))
	}
}
...
func (ptr *QWebEnginePage) IsVisible() bool {
	if ptr.Pointer() != nil {
		return int8(C.QWebEnginePage_IsVisible(ptr.Pointer())) != 0
	}
	return false
}
...
func (ptr *QWebEnginePage) LifecycleState() QWebEnginePage__LifecycleState {
	if ptr.Pointer() != nil {
		return QWebEnginePage__LifecycleState(C.QWebEnginePage_LifecycleState(ptr.Pointer()))
	}
	return 0
}

//export callbackQWebEnginePage_LifecycleStateChanged
func callbackQWebEnginePage_LifecycleStateChanged(ptr unsafe.Pointer, state C.longlong) {
	if signal := qt.GetSignal(ptr, "lifecycleStateChanged"); signal != nil {
		(*(*func(QWebEnginePage__LifecycleState))(signal))(QWebEnginePage__LifecycleState(state))
	}

}

func (ptr *QWebEnginePage) ConnectLifecycleStateChanged(f func(state QWebEnginePage__LifecycleState)) {
	if ptr.Pointer() != nil {

		if !qt.ExistsSignal(ptr.Pointer(), "lifecycleStateChanged") {
			C.QWebEnginePage_ConnectLifecycleStateChanged(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "lifecycleStateChanged")))
		}

		if signal := qt.LendSignal(ptr.Pointer(), "lifecycleStateChanged"); signal != nil {
			f := func(state QWebEnginePage__LifecycleState) {
				(*(*func(QWebEnginePage__LifecycleState))(signal))(state)
				f(state)
			}
			qt.ConnectSignal(ptr.Pointer(), "lifecycleStateChanged", unsafe.Pointer(&f))
		} else {
			qt.ConnectSignal(ptr.Pointer(), "lifecycleStateChanged", unsafe.Pointer(&f))
		}
	}
...
func (ptr *QWebEnginePage) DisconnectLifecycleStateChanged() {
	if ptr.Pointer() != nil {
		C.QWebEnginePage_DisconnectLifecycleStateChanged(ptr.Pointer())
		qt.DisconnectSignal(ptr.Pointer(), "lifecycleStateChanged")
	}
}

func (ptr *QWebEnginePage) LifecycleStateChanged(state QWebEnginePage__LifecycleState) {
	if ptr.Pointer() != nil {
		C.QWebEnginePage_LifecycleStateChanged(ptr.Pointer(), C.longlong(state))
	}
}
...
func (ptr *QWebEnginePage) RecommendedState() QWebEnginePage__LifecycleState {
	if ptr.Pointer() != nil {
		return QWebEnginePage__LifecycleState(C.QWebEnginePage_RecommendedState(ptr.Pointer()))
	}
	return 0
}

//export callbackQWebEnginePage_RecommendedStateChanged
func callbackQWebEnginePage_RecommendedStateChanged(ptr unsafe.Pointer, state C.longlong) {
	if signal := qt.GetSignal(ptr, "recommendedStateChanged"); signal != nil {
		(*(*func(QWebEnginePage__LifecycleState))(signal))(QWebEnginePage__LifecycleState(state))
	}

}

func (ptr *QWebEnginePage) ConnectRecommendedStateChanged(f func(state QWebEnginePage__LifecycleState)) {
	if ptr.Pointer() != nil {

		if !qt.ExistsSignal(ptr.Pointer(), "recommendedStateChanged") {
			C.QWebEnginePage_ConnectRecommendedStateChanged(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "recommendedStateChanged")))
		}

		if signal := qt.LendSignal(ptr.Pointer(), "recommendedStateChanged"); signal != nil {
			f := func(state QWebEnginePage__LifecycleState) {
				(*(*func(QWebEnginePage__LifecycleState))(signal))(state)
				f(state)
			}
			qt.ConnectSignal(ptr.Pointer(), "recommendedStateChanged", unsafe.Pointer(&f))
		} else {
			qt.ConnectSignal(ptr.Pointer(), "recommendedStateChanged", unsafe.Pointer(&f))
		}
	}
...
func (ptr *QWebEnginePage) DisconnectRecommendedStateChanged() {
	if ptr.Pointer() != nil {
		C.QWebEnginePage_DisconnectRecommendedStateChanged(ptr.Pointer())
		qt.DisconnectSignal(ptr.Pointer(), "recommendedStateChanged")
	}
}

func (ptr *QWebEnginePage) RecommendedStateChanged(state QWebEnginePage__LifecycleState) {
	if ptr.Pointer() != nil {
		C.QWebEnginePage_RecommendedStateChanged(ptr.Pointer(), C.longlong(state))
	}
}

func (ptr *QWebEnginePage) RenderProcessPid() int64 {
	if ptr.Pointer() != nil {
		return int64(C.QWebEnginePage_RenderProcessPid(ptr.Pointer()))
	}
	return 0
}

//export callbackQWebEnginePage_RenderProcessPidChanged
func callbackQWebEnginePage_RenderProcessPidChanged(ptr unsafe.Pointer, pid C.longlong) {
	if signal := qt.GetSignal(ptr, "renderProcessPidChanged"); signal != nil {
		(*(*func(int64))(signal))(int64(pid))
	}

}

func (ptr *QWebEnginePage) ConnectRenderProcessPidChanged(f func(pid int64)) {
	if ptr.Pointer() != nil {

		if !qt.ExistsSignal(ptr.Pointer(), "renderProcessPidChanged") {
			C.QWebEnginePage_ConnectRenderProcessPidChanged(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "renderProcessPidChanged")))
		}

		if signal := qt.LendSignal(ptr.Pointer(), "renderProcessPidChanged"); signal != nil {
			f := func(pid int64) {
				(*(*func(int64))(signal))(pid)
				f(pid)
			}
			qt.ConnectSignal(ptr.Pointer(), "renderProcessPidChanged", unsafe.Pointer(&f))
		} else {
			qt.ConnectSignal(ptr.Pointer(), "renderProcessPidChanged", unsafe.Pointer(&f))
		}
	}
...
func (ptr *QWebEnginePage) DisconnectRenderProcessPidChanged() {
	if ptr.Pointer() != nil {
		C.QWebEnginePage_DisconnectRenderProcessPidChanged(ptr.Pointer())
		qt.DisconnectSignal(ptr.Pointer(), "renderProcessPidChanged")
	}
}

func (ptr *QWebEnginePage) RenderProcessPidChanged(pid int64) {
	if ptr.Pointer() != nil {
		C.QWebEnginePage_RenderProcessPidChanged(ptr.Pointer(), C.longlong(pid))
	}
}
...
func (ptr *QWebEnginePage) ConnectRenderProcessTerminated(f func(terminationStatus QWebEnginePage__RenderProcessTerminationStatus, exitCode int)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "renderProcessTerminated") {
			C.QWebEnginePage_ConnectRenderProcessTerminated(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "renderProcessTerminated")))
		}
...
func callbackQWebEnginePage_SelectClientCertificate(ptr unsafe.Pointer, clientCertificateSelection unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "selectClientCertificate"); signal != nil {
		(*(*func(*QWebEngineClientCertificateSelection))(signal))(func() *QWebEngineClientCertificateSelection {
			tmpValue := NewQWebEngineClientCertificateSelectionFromPointer(clientCertificateSelection)
			qt.SetFinalizer(tmpValue, (*QWebEngineClientCertificateSelection).DestroyQWebEngineClientCertificateSelection)
			return tmpValue
		}())
	}
...
func (ptr *QWebEnginePage) ConnectSelectClientCertificate(f func(clientCertificateSelection *QWebEngineClientCertificateSelection)) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(ptr.Pointer(), "selectClientCertificate"); signal != nil {
			f := func(clientCertificateSelection *QWebEngineClientCertificateSelection) {
				(*(*func(*QWebEngineClientCertificateSelection))(signal))(clientCertificateSelection)
				f(clientCertificateSelection)
			}
...
func (ptr *QWebEnginePage) SelectClientCertificate(clientCertificateSelection QWebEngineClientCertificateSelection_ITF) {
	if ptr.Pointer() != nil {
		C.QWebEnginePage_SelectClientCertificate(ptr.Pointer(), PointerFromQWebEngineClientCertificateSelection(clientCertificateSelection))
	}
}
...
func (ptr *QWebEnginePage) SetDevToolsPage(devToolsPage QWebEnginePage_ITF) {
	if ptr.Pointer() != nil {
		C.QWebEnginePage_SetDevToolsPage(ptr.Pointer(), PointerFromQWebEnginePage(devToolsPage))
	}
}
...
func (ptr *QWebEnginePage) SetLifecycleState(state QWebEnginePage__LifecycleState) {
	if ptr.Pointer() != nil {
		C.QWebEnginePage_SetLifecycleState(ptr.Pointer(), C.longlong(state))
	}
}
...
func (ptr *QWebEnginePage) SetVisible(visible bool) {
	if ptr.Pointer() != nil {
		C.QWebEnginePage_SetVisible(ptr.Pointer(), C.char(int8(qt.GoBoolToInt(visible))))
	}
}
...
//export callbackQWebEnginePage_VisibleChanged
func callbackQWebEnginePage_VisibleChanged(ptr unsafe.Pointer, visible C.char) {
...
func (ptr *QWebEnginePage) ConnectVisibleChanged(f func(visible bool)) {
	if ptr.Pointer() != nil {

		if !qt.ExistsSignal(ptr.Pointer(), "visibleChanged") {
			C.QWebEnginePage_ConnectVisibleChanged(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "visibleChanged")))
		}
...
func (ptr *QWebEnginePage) DisconnectVisibleChanged() {
	if ptr.Pointer() != nil {
		C.QWebEnginePage_DisconnectVisibleChanged(ptr.Pointer())
		qt.DisconnectSignal(ptr.Pointer(), "visibleChanged")
	}
}

func (ptr *QWebEnginePage) VisibleChanged(visible bool) {
	if ptr.Pointer() != nil {
		C.QWebEnginePage_VisibleChanged(ptr.Pointer(), C.char(int8(qt.GoBoolToInt(visible))))
	}
}
...
func callbackQWebEngineProfile_DownloadRequested(ptr unsafe.Pointer, download unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "downloadRequested"); signal != nil {
		(*(*func(*QWebEngineDownloadItem))(signal))(NewQWebEngineDownloadItemFromPointer(download))
	}
...
func (ptr *QWebEngineProfile) ConnectDownloadRequested(f func(download *QWebEngineDownloadItem)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "downloadRequested") {
			C.QWebEngineProfile_ConnectDownloadRequested(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "downloadRequested")))
		}

		if signal := qt.LendSignal(ptr.Pointer(), "downloadRequested"); signal != nil {
			f := func(download *QWebEngineDownloadItem) {
				(*(*func(*QWebEngineDownloadItem))(signal))(download)
				f(download)
			}
...
func NewQWebEngineScript() *QWebEngineScript {
	...
	qt.SetFinalizer(tmpValue, (*QWebEngineScript).DestroyQWebEngineScript)
	return tmpValue
}
...
func (ptr *QWebEngineSettings) TestAttribute(attribute QWebEngineSettings__WebAttribute) bool {
	if ptr.Pointer() != nil {
		return int8(C.QWebEngineSettings_TestAttribute(ptr.Pointer(), C.longlong(attribute))) != 0
	}
	return false
}
...
const (
	...
	QWebEngineUrlRequestInfo__NavigationTypeRedirect      QWebEngineUrlRequestInfo__NavigationType = QWebEngineUrlRequestInfo__NavigationType(6)
)
...
const (
	...
	QWebEngineUrlRequestInfo__ResourceTypeNavigationPreloadMainFrame QWebEngineUrlRequestInfo__ResourceType = QWebEngineUrlRequestInfo__ResourceType(19)
	QWebEngineUrlRequestInfo__ResourceTypeNavigationPreloadSubFrame  QWebEngineUrlRequestInfo__ResourceType = QWebEngineUrlRequestInfo__ResourceType(20)
...
func (ptr *QWebEngineUrlRequestInfo) Initiator() *core.QUrl {
	if ptr.Pointer() != nil {
		tmpValue := core.NewQUrlFromPointer(C.QWebEngineUrlRequestInfo_Initiator(ptr.Pointer()))
		qt.SetFinalizer(tmpValue, (*core.QUrl).DestroyQUrl)
		return tmpValue
	}
	return nil
...
const (
	...
	QWebEngineUrlScheme__CorsEnabled                  QWebEngineUrlScheme__Flag = QWebEngineUrlScheme__Flag(0x80)
)
...
func (ptr *QWebEngineView) EventDefault(ev core.QEvent_ITF) bool {
	if ptr.Pointer() != nil {
		return int8(C.QWebEngineView_EventDefault(ptr.Pointer(), core.PointerFromQEvent(ev))) != 0
	}
	return false
}
...
func init() {
	...
	qt.EnumMap["webengine.QWebEngineCertificateError__CertificateKnownInterceptionBlocked"] = int64(QWebEngineCertificateError__CertificateKnownInterceptionBlocked)
	...
	qt.FuncMap["webengine.NewQWebEngineContextMenuData"] = NewQWebEngineContextMenuData
	qt.FuncMap["webengine.NewQWebEngineContextMenuData2"] = NewQWebEngineContextMenuData2
	qt.EnumMap["webengine.QWebEngineContextMenuData__CanUndo"] = int64(QWebEngineContextMenuData__CanUndo)
	qt.EnumMap["webengine.QWebEngineContextMenuData__CanRedo"] = int64(QWebEngineContextMenuData__CanRedo)
	qt.EnumMap["webengine.QWebEngineContextMenuData__CanCut"] = int64(QWebEngineContextMenuData__CanCut)
	qt.EnumMap["webengine.QWebEngineContextMenuData__CanCopy"] = int64(QWebEngineContextMenuData__CanCopy)
	qt.EnumMap["webengine.QWebEngineContextMenuData__CanPaste"] = int64(QWebEngineContextMenuData__CanPaste)
	qt.EnumMap["webengine.QWebEngineContextMenuData__CanDelete"] = int64(QWebEngineContextMenuData__CanDelete)
	qt.EnumMap["webengine.QWebEngineContextMenuData__CanSelectAll"] = int64(QWebEngineContextMenuData__CanSelectAll)
	qt.EnumMap["webengine.QWebEngineContextMenuData__CanTranslate"] = int64(QWebEngineContextMenuData__CanTranslate)
	qt.EnumMap["webengine.QWebEngineContextMenuData__CanEditRichly"] = int64(QWebEngineContextMenuData__CanEditRichly)
	qt.EnumMap["webengine.QWebEngineContextMenuData__MediaInError"] = int64(QWebEngineContextMenuData__MediaInError)
	qt.EnumMap["webengine.QWebEngineContextMenuData__MediaPaused"] = int64(QWebEngineContextMenuData__MediaPaused)
	qt.EnumMap["webengine.QWebEngineContextMenuData__MediaMuted"] = int64(QWebEngineContextMenuData__MediaMuted)
	qt.EnumMap["webengine.QWebEngineContextMenuData__MediaLoop"] = int64(QWebEngineContextMenuData__MediaLoop)
	qt.EnumMap["webengine.QWebEngineContextMenuData__MediaCanSave"] = int64(QWebEngineContextMenuData__MediaCanSave)
	qt.EnumMap["webengine.QWebEngineContextMenuData__MediaHasAudio"] = int64(QWebEngineContextMenuData__MediaHasAudio)
	qt.EnumMap["webengine.QWebEngineContextMenuData__MediaCanToggleControls"] = int64(QWebEngineContextMenuData__MediaCanToggleControls)
	qt.EnumMap["webengine.QWebEngineContextMenuData__MediaControls"] = int64(QWebEngineContextMenuData__MediaControls)
	qt.EnumMap["webengine.QWebEngineContextMenuData__MediaCanPrint"] = int64(QWebEngineContextMenuData__MediaCanPrint)
	qt.EnumMap["webengine.QWebEngineContextMenuData__MediaCanRotate"] = int64(QWebEngineContextMenuData__MediaCanRotate)
	qt.EnumMap["webengine.QWebEngineContextMenuData__MediaTypeNone"] = int64(QWebEngineContextMenuData__MediaTypeNone)
	qt.EnumMap["webengine.QWebEngineContextMenuData__MediaTypeImage"] = int64(QWebEngineContextMenuData__MediaTypeImage)
	qt.EnumMap["webengine.QWebEngineContextMenuData__MediaTypeVideo"] = int64(QWebEngineContextMenuData__MediaTypeVideo)
	qt.EnumMap["webengine.QWebEngineContextMenuData__MediaTypeAudio"] = int64(QWebEngineContextMenuData__MediaTypeAudio)
	qt.EnumMap["webengine.QWebEngineContextMenuData__MediaTypeCanvas"] = int64(QWebEngineContextMenuData__MediaTypeCanvas)
	qt.EnumMap["webengine.QWebEngineContextMenuData__MediaTypeFile"] = int64(QWebEngineContextMenuData__MediaTypeFile)
	qt.EnumMap["webengine.QWebEngineContextMenuData__MediaTypePlugin"] = int64(QWebEngineContextMenuData__MediaTypePlugin)
	qt.ItfMap["webengine.QWebEngineCookieStore_ITF"] = QWebEngineCookieStore{}
	qt.ItfMap["webengine.QWebEngineDownloadItem_ITF"] = QWebEngineDownloadItem{}
	qt.EnumMap["webengine.QWebEngineDownloadItem__NoReason"] = int64(QWebEngineDownloadItem__NoReason)
	qt.EnumMap["webengine.QWebEngineDownloadItem__FileFailed"] = int64(QWebEngineDownloadItem__FileFailed)
	qt.EnumMap["webengine.QWebEngineDownloadItem__FileAccessDenied"] = int64(QWebEngineDownloadItem__FileAccessDenied)
	qt.EnumMap["webengine.QWebEngineDownloadItem__FileNoSpace"] = int64(QWebEngineDownloadItem__FileNoSpace)
	qt.EnumMap["webengine.QWebEngineDownloadItem__FileNameTooLong"] = int64(QWebEngineDownloadItem__FileNameTooLong)
	qt.EnumMap["webengine.QWebEngineDownloadItem__FileTooLarge"] = int64(QWebEngineDownloadItem__FileTooLarge)
	qt.EnumMap["webengine.QWebEngineDownloadItem__FileVirusInfected"] = int64(QWebEngineDownloadItem__FileVirusInfected)
	qt.EnumMap["webengine.QWebEngineDownloadItem__FileTransientError"] = int64(QWebEngineDownloadItem__FileTransientError)
	qt.EnumMap["webengine.QWebEngineDownloadItem__FileBlocked"] = int64(QWebEngineDownloadItem__FileBlocked)
	qt.EnumMap["webengine.QWebEngineDownloadItem__FileSecurityCheckFailed"] = int64(QWebEngineDownloadItem__FileSecurityCheckFailed)
	qt.EnumMap["webengine.QWebEngineDownloadItem__FileTooShort"] = int64(QWebEngineDownloadItem__FileTooShort)
	qt.EnumMap["webengine.QWebEngineDownloadItem__FileHashMismatch"] = int64(QWebEngineDownloadItem__FileHashMismatch)
	qt.EnumMap["webengine.QWebEngineDownloadItem__NetworkFailed"] = int64(QWebEngineDownloadItem__NetworkFailed)
	qt.EnumMap["webengine.QWebEngineDownloadItem__NetworkTimeout"] = int64(QWebEngineDownloadItem__NetworkTimeout)
	qt.EnumMap["webengine.QWebEngineDownloadItem__NetworkDisconnected"] = int64(QWebEngineDownloadItem__NetworkDisconnected)
	qt.EnumMap["webengine.QWebEngineDownloadItem__NetworkServerDown"] = int64(QWebEngineDownloadItem__NetworkServerDown)
	qt.EnumMap["webengine.QWebEngineDownloadItem__NetworkInvalidRequest"] = int64(QWebEngineDownloadItem__NetworkInvalidRequest)
	qt.EnumMap["webengine.QWebEngineDownloadItem__ServerFailed"] = int64(QWebEngineDownloadItem__ServerFailed)
	qt.EnumMap["webengine.QWebEngineDownloadItem__ServerBadContent"] = int64(QWebEngineDownloadItem__ServerBadContent)
	qt.EnumMap["webengine.QWebEngineDownloadItem__ServerUnauthorized"] = int64(QWebEngineDownloadItem__ServerUnauthorized)
	qt.EnumMap["webengine.QWebEngineDownloadItem__ServerCertProblem"] = int64(QWebEngineDownloadItem__ServerCertProblem)
	qt.EnumMap["webengine.QWebEngineDownloadItem__ServerForbidden"] = int64(QWebEngineDownloadItem__ServerForbidden)
	qt.EnumMap["webengine.QWebEngineDownloadItem__ServerUnreachable"] = int64(QWebEngineDownloadItem__ServerUnreachable)
	qt.EnumMap["webengine.QWebEngineDownloadItem__UserCanceled"] = int64(QWebEngineDownloadItem__UserCanceled)
	qt.EnumMap["webengine.QWebEngineDownloadItem__DownloadRequested"] = int64(QWebEngineDownloadItem__DownloadRequested)
	qt.EnumMap["webengine.QWebEngineDownloadItem__DownloadInProgress"] = int64(QWebEngineDownloadItem__DownloadInProgress)
	qt.EnumMap["webengine.QWebEngineDownloadItem__DownloadCompleted"] = int64(QWebEngineDownloadItem__DownloadCompleted)
	qt.EnumMap["webengine.QWebEngineDownloadItem__DownloadCancelled"] = int64(QWebEngineDownloadItem__DownloadCancelled)
	qt.EnumMap["webengine.QWebEngineDownloadItem__DownloadInterrupted"] = int64(QWebEngineDownloadItem__DownloadInterrupted)
	qt.EnumMap["webengine.QWebEngineDownloadItem__UnknownSaveFormat"] = int64(QWebEngineDownloadItem__UnknownSaveFormat)
	qt.EnumMap["webengine.QWebEngineDownloadItem__SingleHtmlSaveFormat"] = int64(QWebEngineDownloadItem__SingleHtmlSaveFormat)
	qt.EnumMap["webengine.QWebEngineDownloadItem__CompleteHtmlSaveFormat"] = int64(QWebEngineDownloadItem__CompleteHtmlSaveFormat)
	qt.EnumMap["webengine.QWebEngineDownloadItem__MimeHtmlSaveFormat"] = int64(QWebEngineDownloadItem__MimeHtmlSaveFormat)
	qt.ItfMap["webengine.QWebEngineFindTextResult_ITF"] = QWebEngineFindTextResult{}
	qt.ItfMap["webengine.QWebEngineFullScreenRequest_ITF"] = QWebEngineFullScreenRequest{}
	qt.ItfMap["webengine.QWebEngineHistory_ITF"] = QWebEngineHistory{}
	qt.ItfMap["webengine.QWebEngineHistoryItem_ITF"] = QWebEngineHistoryItem{}
	qt.FuncMap["webengine.NewQWebEngineHistoryItem"] = NewQWebEngineHistoryItem
	...
	qt.EnumMap["webengine.QWebEnginePage__Active"] = int64(QWebEnginePage__Active)
	qt.EnumMap["webengine.QWebEnginePage__Frozen"] = int64(QWebEnginePage__Frozen)
	qt.EnumMap["webengine.QWebEnginePage__Discarded"] = int64(QWebEnginePage__Discarded)
	...
	qt.EnumMap["webengine.QWebEnginePage__NavigationTypeRedirect"] = int64(QWebEnginePage__NavigationTypeRedirect)
	...
	qt.EnumMap["webengine.QWebEnginePage__NormalTerminationStatus"] = int64(QWebEnginePage__NormalTerminationStatus)
	qt.EnumMap["webengine.QWebEnginePage__AbnormalTerminationStatus"] = int64(QWebEnginePage__AbnormalTerminationStatus)
	qt.EnumMap["webengine.QWebEnginePage__CrashedTerminationStatus"] = int64(QWebEnginePage__CrashedTerminationStatus)
	qt.EnumMap["webengine.QWebEnginePage__KilledTerminationStatus"] = int64(QWebEnginePage__KilledTerminationStatus)
	...
	qt.FuncMap["webengine.NewQWebEngineScript"] = NewQWebEngineScript
	qt.FuncMap["webengine.NewQWebEngineScript2"] = NewQWebEngineScript2
	...
	qt.EnumMap["webengine.QWebEngineUrlRequestInfo__NavigationTypeRedirect"] = int64(QWebEngineUrlRequestInfo__NavigationTypeRedirect)
	...
	qt.EnumMap["webengine.QWebEngineUrlRequestInfo__ResourceTypeNavigationPreloadMainFrame"] = int64(QWebEngineUrlRequestInfo__ResourceTypeNavigationPreloadMainFrame)
	qt.EnumMap["webengine.QWebEngineUrlRequestInfo__ResourceTypeNavigationPreloadSubFrame"] = int64(QWebEngineUrlRequestInfo__ResourceTypeNavigationPreloadSubFrame)
	...
	qt.EnumMap["webengine.QWebEngineUrlScheme__CorsEnabled"] = int64(QWebEngineUrlScheme__CorsEnabled)
