...
func (ptr *QWebSocket) MaxAllowedIncomingFrameSize() uint64 {
	if ptr.Pointer() != nil {
		return uint64(C.QWebSocket_MaxAllowedIncomingFrameSize(ptr.Pointer()))
	}
	return 0
}

func (ptr *QWebSocket) MaxAllowedIncomingMessageSize() uint64 {
	if ptr.Pointer() != nil {
		return uint64(C.QWebSocket_MaxAllowedIncomingMessageSize(ptr.Pointer()))
	}
	return 0
}

func QWebSocket_MaxIncomingFrameSize() uint64 {
	return uint64(C.QWebSocket_QWebSocket_MaxIncomingFrameSize())
}

func (ptr *QWebSocket) MaxIncomingFrameSize() uint64 {
	return uint64(C.QWebSocket_QWebSocket_MaxIncomingFrameSize())
}

func QWebSocket_MaxIncomingMessageSize() uint64 {
	return uint64(C.QWebSocket_QWebSocket_MaxIncomingMessageSize())
}

func (ptr *QWebSocket) MaxIncomingMessageSize() uint64 {
	return uint64(C.QWebSocket_QWebSocket_MaxIncomingMessageSize())
}

func QWebSocket_MaxOutgoingFrameSize() uint64 {
	return uint64(C.QWebSocket_QWebSocket_MaxOutgoingFrameSize())
}

func (ptr *QWebSocket) MaxOutgoingFrameSize() uint64 {
	return uint64(C.QWebSocket_QWebSocket_MaxOutgoingFrameSize())
}
...
func (ptr *QWebSocket) OutgoingFrameSize() uint64 {
	if ptr.Pointer() != nil {
		return uint64(C.QWebSocket_OutgoingFrameSize(ptr.Pointer()))
	}
	return 0
}
...
func (ptr *QWebSocket) SetMaxAllowedIncomingFrameSize(maxAllowedIncomingFrameSize uint64) {
	if ptr.Pointer() != nil {
		C.QWebSocket_SetMaxAllowedIncomingFrameSize(ptr.Pointer(), C.ulonglong(maxAllowedIncomingFrameSize))
	}
}

func (ptr *QWebSocket) SetMaxAllowedIncomingMessageSize(maxAllowedIncomingMessageSize uint64) {
	if ptr.Pointer() != nil {
		C.QWebSocket_SetMaxAllowedIncomingMessageSize(ptr.Pointer(), C.ulonglong(maxAllowedIncomingMessageSize))
	}
}

func (ptr *QWebSocket) SetOutgoingFrameSize(outgoingFrameSize uint64) {
	if ptr.Pointer() != nil {
		C.QWebSocket_SetOutgoingFrameSize(ptr.Pointer(), C.ulonglong(outgoingFrameSize))
	}
}
...
func (ptr *QWebSocketServer) HandshakeTimeoutMS() int {
	if ptr.Pointer() != nil {
		return int(int32(C.QWebSocketServer_HandshakeTimeoutMS(ptr.Pointer())))
	}
	return 0
}
...
func (ptr *QWebSocketServer) SetHandshakeTimeout2(msec int) {
	if ptr.Pointer() != nil {
		C.QWebSocketServer_SetHandshakeTimeout2(ptr.Pointer(), C.int(int32(msec)))
	}
}
...
func init() {
	...
	qt.FuncMap["websockets.QWebSocket_MaxIncomingFrameSize"] = QWebSocket_MaxIncomingFrameSize
	qt.FuncMap["websockets.QWebSocket_MaxIncomingMessageSize"] = QWebSocket_MaxIncomingMessageSize
	qt.FuncMap["websockets.QWebSocket_MaxOutgoingFrameSize"] = QWebSocket_MaxOutgoingFrameSize
